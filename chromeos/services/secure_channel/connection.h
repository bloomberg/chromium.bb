...
#ifndef CHROMEOS_SERVICES_SECURE_CHANNEL_CONNECTION_H_
#define CHROMEOS_SERVICES_SECURE_CHANNEL_CONNECTION_H_
...
#endif  // CHROMEOS_SERVICES_SECURE_CHANNEL_CONNECTION_H_
