...
ConnectionPreserver::ConnectionPreserver(
...
void ConnectionPreserver::HandleSuccessfulTetherAvailabilityResponse(
...
std::string ConnectionPreserver::GetPreferredPreservedConnectionDeviceId(
    const std::string& device_id) {
...
void ConnectionPreserver::SetPreservedConnection(const std::string& device_id) {
  DCHECK(preserved_connection_device_id_.empty());
  ...
  preserved_connection_timer_->Start(
      ...
      base::Bind(&ConnectionPreserver::RemovePreservedConnectionIfPresent,
                 weak_ptr_factory_.GetWeakPtr()));
}

void ConnectionPreserver::RemovePreservedConnectionIfPresent() {
  if (preserved_connection_device_id_.empty())
    return;
...
void ConnectionPreserver::SetTimerForTesting(
