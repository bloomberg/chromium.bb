...
#define MAYBE_CheckServicesDataUseRecorded DISABLED_CheckServicesDataUseRecorded
#else
#define MAYBE_CheckServicesDataUseRecorded CheckServicesDataUseRecorded
#endif
IN_PROC_BROWSER_TEST_F(DataUseMeasurementBrowserTestWithDataSaverEnabled,
                       MAYBE_CheckServicesDataUseRecorded) {
