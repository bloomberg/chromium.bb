...
#ifndef CHROME_BROWSER_MEDIA_GALLERY_LINUX_MTP_OPEN_STORAGE_WORKER_H_
#define CHROME_BROWSER_MEDIA_GALLERY_LINUX_MTP_OPEN_STORAGE_WORKER_H_
...
#endif  // CHROME_BROWSER_MEDIA_GALLERY_LINUX_MTP_OPEN_STORAGE_WORKER_H_
