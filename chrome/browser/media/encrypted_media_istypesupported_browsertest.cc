...
#define MAYBE_PepperCDMsNotRegistered DISABLED_PepperCDMsNotRegistered
#else
#define MAYBE_PepperCDMsNotRegistered PepperCDMsNotRegistered
#endif
IN_PROC_BROWSER_TEST_F(EncryptedMediaIsTypeSupportedTest,
                       MAYBE_PepperCDMsNotRegistered) {
