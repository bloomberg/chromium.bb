...
#ifndef CHROME_BROWSER_SYSTEM_MONITOR_REMOVABLE_STORAGE_OBSERVER_H_
#define CHROME_BROWSER_SYSTEM_MONITOR_REMOVABLE_STORAGE_OBSERVER_H_
...
#endif  // CHROME_BROWSER_SYSTEM_MONITOR_REMOVABLE_STORAGE_OBSERVER_H_
