...
#ifndef CHROME_BROWSER_AUTOFILL_AUTOFILL_REGEX_CONSTANTS_H_
#define CHROME_BROWSER_AUTOFILL_AUTOFILL_REGEX_CONSTANTS_H_
...
#endif  // CHROME_BROWSER_AUTOFILL_AUTOFILL_REGEX_CONSTANTS_H_
