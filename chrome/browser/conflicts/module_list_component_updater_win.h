...
#ifndef CHROME_BROWSER_CONFLICTS_MODULE_LIST_COMPONENT_UPDATER_WIN_H_
#define CHROME_BROWSER_CONFLICTS_MODULE_LIST_COMPONENT_UPDATER_WIN_H_
...
#endif  // CHROME_BROWSER_CONFLICTS_MODULE_LIST_COMPONENT_UPDATER_WIN_H_
