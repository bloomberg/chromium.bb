...
bool IsAllowedUkmFeature(blink::mojom::WebFeature feature) {
  static base::NoDestructor<base::flat_set<WebFeature>> opt_in_features({
      ...
      WebFeature::kPaymentRequestShowWithoutGesture, WebFeature::kHTMLImports,
      ...
      WebFeature::kV8AudioContext_Constructor, WebFeature::kElementAttachShadow,
      WebFeature::kElementAttachShadowOpen,
      WebFeature::kElementAttachShadowClosed,
      WebFeature::kCustomElementRegistryDefine, WebFeature::kTextToSpeech_Speak,
