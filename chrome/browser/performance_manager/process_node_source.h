...
#ifndef CHROME_BROWSER_PERFORMANCE_MANAGER_PROCESS_NODE_SOURCE_H_
#define CHROME_BROWSER_PERFORMANCE_MANAGER_PROCESS_NODE_SOURCE_H_
...
#endif  // CHROME_BROWSER_PERFORMANCE_MANAGER_PROCESS_NODE_SOURCE_H_
