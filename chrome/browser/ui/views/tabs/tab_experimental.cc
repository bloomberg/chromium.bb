...
TabExperimental::TabExperimental()
    : views::View(), title_(new views::Label), hover_controller_(this) {
...
void TabExperimental::OnPaint(gfx::Canvas* canvas) {
  PaintTabBackground(canvas, false, 0, 0, nullptr);
}
...
void TabExperimental::PaintTabBackground(gfx::Canvas* canvas,
                                         bool active,
                                         int fill_id,
                                         int y_offset,
                                         gfx::Path* clip) {
...
void TabExperimental::PaintTabBackgroundFill(gfx::Canvas* canvas,
...
void TabExperimental::PaintTabBackgroundStroke(gfx::Canvas* canvas,
                                               const gfx::Path& fill_path,
...
TabExperimental::BackgroundCache::BackgroundCache() = default;
TabExperimental::BackgroundCache::~BackgroundCache() = default;
