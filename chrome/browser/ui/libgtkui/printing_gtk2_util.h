...
#ifndef CHROME_BROWSER_UI_LIBGTKUI_PRINTING_GTK2_UTIL_H_
#define CHROME_BROWSER_UI_LIBGTKUI_PRINTING_GTK2_UTIL_H_
...
#endif  // CHROME_BROWSER_UI_LIBGTKUI_PRINTING_GTK2_UTIL_H_
