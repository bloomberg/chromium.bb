...
class SettingsWindowManager {
 public:
  ...
  // disabled, this behaves like ShowChromePageForProfile(). As settings are
  // ported to the OS settings window, UI entry points should be updated to call
  // this function.
  // TODO(jamescook): Sub-page support.
