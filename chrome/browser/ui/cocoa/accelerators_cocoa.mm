...
const struct AcceleratorListing {
  ...
  ui::KeyboardCode key_code;  // The key used for cross-platform compatibility.
    ...
    {ui::EF_COMMAND_DOWN | ui::EF_ALT_DOWN, ui::VKEY_H},  // Hide others.
    {ui::EF_COMMAND_DOWN | ui::EF_ALT_DOWN, ui::VKEY_W},
    {ui::EF_COMMAND_DOWN | ui::EF_ALT_DOWN | ui::EF_SHIFT_DOWN, ui::VKEY_V},
    {ui::EF_COMMAND_DOWN, ui::VKEY_E},
    {ui::EF_COMMAND_DOWN, ui::VKEY_J},
    {ui::EF_COMMAND_DOWN, ui::VKEY_OEM_1},
    {ui::EF_COMMAND_DOWN | ui::EF_SHIFT_DOWN, ui::VKEY_OEM_1},
    {ui::EF_COMMAND_DOWN, ui::VKEY_OEM_COMMA},  // Preferences
    {ui::EF_COMMAND_DOWN | ui::EF_CONTROL_DOWN,
     ui::VKEY_SPACE},  // Emoji & Symbols
};
