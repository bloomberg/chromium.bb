...
content::WebUIDataSource* CreateMdExtensionsSource(Profile* profile,
  ...
  static constexpr LocalizedString kLocalizedStrings[] = {
    ...
    {"activityLogMoreActionsLabel",
     IDS_MD_EXTENSIONS_ACTIVITY_LOG_MORE_ACTIONS_LABEL},
    {"activityLogExpandAll", IDS_MD_EXTENSIONS_ACTIVITY_LOG_EXPAND_ALL},
    {"activityLogCollapseAll", IDS_MD_EXTENSIONS_ACTIVITY_LOG_COLLAPSE_ALL},
