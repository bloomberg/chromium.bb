...
#ifndef CHROME_BROWSER_UI_WEBUI_OFFLINE_INTERNALS_UI_H_
#define CHROME_BROWSER_UI_WEBUI_OFFLINE_INTERNALS_UI_H_
...
#endif  // CHROME_BROWSER_UI_WEBUI_OFFLINE_INTERNALS_UI_H_
