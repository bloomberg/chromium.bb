...
#ifndef CHROME_BROWSER_UI_WEBUI_OPTIONS_CHROMEOS_WALLPAPER_THUMBNAIL_SOURCE_H_
#define CHROME_BROWSER_UI_WEBUI_OPTIONS_CHROMEOS_WALLPAPER_THUMBNAIL_SOURCE_H_
...
#endif  // CHROME_BROWSER_UI_WEBUI_OPTIONS_CHROMEOS_WALLPAPER_THUMBNAIL_SOURCE_H_
