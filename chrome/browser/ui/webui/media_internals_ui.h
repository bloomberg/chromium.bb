...
#ifndef CHROME_BROWSER_UI_WEBUI_MEDIA_INTERNALS_UI_H_
#define CHROME_BROWSER_UI_WEBUI_MEDIA_INTERNALS_UI_H_
#pragma once
...
#endif  // CHROME_BROWSER_UI_WEBUI_MEDIA_INTERNALS_UI_H_
