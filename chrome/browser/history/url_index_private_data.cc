...
// TODO(mrossetti): Remove the following once the transition is complete.
...
// TODO(mrossetti): All of the following InMemoryURLIndex member functions will
// move into URLIndexPrivateData once the transition is complete.
...
// InMemoryURLIndex::HistoryItemFactorGreater ----------------------------------
