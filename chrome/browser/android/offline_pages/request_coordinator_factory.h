...
#ifndef CHROME_BROWSER_ANDROID_OFFLINE_PAGES_REQUEST_COORDINATOR_FACTORY_H_
#define CHROME_BROWSER_ANDROID_OFFLINE_PAGES_REQUEST_COORDINATOR_FACTORY_H_
...
#endif  // CHROME_BROWSER_ANDROID_OFFLINE_PAGES_REQUEST_COORDINATOR_FACTORY_H_
