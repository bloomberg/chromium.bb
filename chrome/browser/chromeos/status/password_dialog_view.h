...
#ifndef CHROME_BROWSER_CHROMEOS_STATUS_PASSWORD_DIALOG_VIEW_H_
#define CHROME_BROWSER_CHROMEOS_STATUS_PASSWORD_DIALOG_VIEW_H_
...
#endif  // CHROME_BROWSER_CHROMEOS_STATUS_PASSWORD_DIALOG_VIEW_H_
