...
#ifndef CHROME_BROWSER_CHROMEOS_DRIVE_CACHE_OBSERVER_H_
#define CHROME_BROWSER_CHROMEOS_DRIVE_CACHE_OBSERVER_H_
...
#endif  // CHROME_BROWSER_CHROMEOS_DRIVE_CACHE_OBSERVER_H_
