  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        'browser/gtk/throb_controller_gtk.cc',
        ...
        'browser/views/tab_contents/render_view_context_menu.cc',
        'browser/views/tab_contents/render_view_context_menu.h',
          ...
          'conditions': [
            ['OS=="linux" and (toolkit_views==1 or chromeos==1)',{
              'sources/': [
                ...
                ['include', '^browser/views/tab_contents/render_view_context_menu.cc'],
                ['include', '^browser/views/tab_contents/render_view_context_menu.h'],
