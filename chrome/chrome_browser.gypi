  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        'browser/chromeos/webui/login/browser/dom_browser_view.cc',
        'browser/chromeos/webui/login/browser/dom_browser_view.h',
        'browser/chromeos/webui/login/browser/dom_browser_view_layout.cc',
        'browser/chromeos/webui/login/browser/dom_browser_view_layout.h',
