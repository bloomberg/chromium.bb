...

{
  'variables': {
    ...
    'chrome_browser_jni_sources': [
      ...
      'android/java_staging/src/org/chromium/chrome/browser/bookmark/EditBookmarkHelper.java',
      'android/java_staging/src/org/chromium/chrome/browser/compositor/CompositorView.java',
      'android/java_staging/src/org/chromium/chrome/browser/compositor/scene_layer/ContextualSearchSceneLayer.java',
      'android/java_staging/src/org/chromium/chrome/browser/compositor/scene_layer/ReaderModeSceneLayer.java',
      'android/java_staging/src/org/chromium/chrome/browser/compositor/scene_layer/TabListSceneLayer.java',
      'android/java_staging/src/org/chromium/chrome/browser/compositor/scene_layer/TabStripSceneLayer.java',
      'android/java_staging/src/org/chromium/chrome/browser/contextualsearch/ContextualSearchManager.java',
      'android/java_staging/src/org/chromium/chrome/browser/contextualsearch/ContextualSearchTabHelper.java',
      'android/java_staging/src/org/chromium/chrome/browser/document/DocumentWebContentsDelegate.java',
      'android/java_staging/src/org/chromium/chrome/browser/rlz/RevenueStats.java',
      'android/java_staging/src/org/chromium/chrome/browser/tab/ThumbnailTabHelper.java',
    ],
