...

{
  'variables': {
    ...
    'chrome_browser_non_ios_sources': [
      ...
      'browser/android/net/network_quality_provider.cc',
      'browser/android/net/network_quality_provider.h',
    ...
    'chrome_browser_jni_sources': [
      ...
      'android/java/src/org/chromium/chrome/browser/net/qualityprovider/NetworkQualityProvider.java',
