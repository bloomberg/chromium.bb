  ...
  'targets': [
    ...
    },
    {
      ...
      'sources': [
        ...
        'test/live_sync/many_client_passwords_sync_test.cc',
        'test/live_sync/many_client_preferences_sync_test.cc',
        'test/live_sync/migration_errors_test.cc',
        'test/live_sync/multiple_client_bookmarks_sync_test.cc',
        'test/live_sync/multiple_client_passwords_sync_test.cc',
        'test/live_sync/multiple_client_preferences_sync_test.cc',
        'test/live_sync/multiple_client_sessions_sync_test.cc',
        'test/live_sync/multiple_client_typed_urls_sync_test.cc',
        'test/live_sync/passwords_helper.cc',
        'test/live_sync/passwords_helper.h',
        'test/live_sync/preferences_helper.cc',
        'test/live_sync/preferences_helper.h',
        'test/live_sync/sessions_helper.cc',
        'test/live_sync/sessions_helper.h',
        ...
        'test/live_sync/single_client_passwords_sync_test.cc',
        'test/live_sync/single_client_preferences_sync_test.cc',
        'test/live_sync/single_client_sessions_sync_test.cc',
        ...
        'test/live_sync/two_client_passwords_sync_test.cc',
        'test/live_sync/two_client_preferences_sync_test.cc',
        'test/live_sync/two_client_sessions_sync_test.cc',
