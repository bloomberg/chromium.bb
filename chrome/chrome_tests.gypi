  ...
  'targets': [
    ...
    },
    {
      ...
      'sources': [
        ...
        'browser/chromeos/gdata/mock_gdata_cache_observer.cc',
        'browser/chromeos/gdata/mock_gdata_cache_observer.h',
        ...
        'browser/history/in_memory_url_index_unittest_base.cc',
        'browser/history/in_memory_url_index_unittest_base.h',
    ...
    },
    {
      ...
      'sources': [
        ...
        'browser/ui/webui/options2/autofill_options_browsertest.js',
        'browser/ui/webui/options2/browser_options_browsertest.js',
        'browser/ui/webui/options2/certificate_manager_browsertest.js',
        'browser/ui/webui/options2/chromeos/guest_mode_options_ui_browsertest.cc',
        'browser/ui/webui/options2/content_options_browsertest.js',
        'browser/ui/webui/options2/content_settings_exception_area_browsertest.js',
        'browser/ui/webui/options2/cookies_view_browsertest.js',
        'browser/ui/webui/options2/font_settings_browsertest.js',
        'browser/ui/webui/options2/language_options_browsertest.js',
        'browser/ui/webui/options2/options_browsertest.js',
