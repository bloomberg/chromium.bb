...
# found in the LICENSE file.
{
  'variables': {
    'chrome_unit_tests_sources': [
      ...
      'browser/ui/cocoa/passwords/manage_credential_item_view_controller_unittest.mm',
    ...
    'chrome_unit_tests_views_non_mac_sources': [
      ...
      'browser/ui/views/extensions/extension_toolbar_icon_surfacing_bubble_views_unittest.cc',
  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        'browser/signin/fake_account_fetcher_service.cc',
        'browser/signin/fake_account_fetcher_service.h',
