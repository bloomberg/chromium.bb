...
// NaCl based PPAPI tests with WebSocket server
// Some WebSocket tests fail with the NaCl IPC proxy on Linux and ChromeOS.
// http://crbug.com/160093
#if defined(OS_LINUX) || defined(OS_CHROMEOS)
#define MAYBE_WebSocket_InvalidClose DISABLED_WebSocket_InvalidClose
#define MAYBE_WebSocket_ValidClose DISABLED_WebSocket_ValidClose
#define MAYBE_WebSocket_BufferedAmount DISABLED_WebSocket_BufferedAmount
#define MAYBE_WebSocket_AbortCallsWithCallback DISABLED_WebSocket_AbortCallsWithCallback
#define MAYBE_WebSocket_AbortCloseCall DISABLED_WebSocket_AbortCloseCall
#define MAYBE_WebSocket_CcInterfaces DISABLED_WebSocket_CcInterfaces
#define MAYBE_WebSocket_UtilityValidClose DISABLED_WebSocket_UtilityValidClose
#define MAYBE_WebSocket_UtilityBufferedAmount DISABLED_WebSocket_UtilityBufferedAmount
#else
#define MAYBE_WebSocket_InvalidClose WebSocket_InvalidClose
#define MAYBE_WebSocket_ValidClose WebSocket_ValidClose
#define MAYBE_WebSocket_BufferedAmount WebSocket_BufferedAmount
#define MAYBE_WebSocket_AbortCallsWithCallback WebSocket_AbortCallsWithCallback
#define MAYBE_WebSocket_AbortCloseCall WebSocket_AbortCloseCall
#define MAYBE_WebSocket_CcInterfaces WebSocket_CcInterfaces
#define MAYBE_WebSocket_UtilityValidClose WebSocket_UtilityValidClose
#define MAYBE_WebSocket_UtilityBufferedAmount WebSocket_UtilityBufferedAmount
#endif
...
TEST_PPAPI_NACL_VIA_HTTP_WITH_WS(MAYBE_WebSocket_InvalidClose)
TEST_PPAPI_NACL_VIA_HTTP_WITH_WS(MAYBE_WebSocket_ValidClose)
...
TEST_PPAPI_NACL_VIA_HTTP_WITH_WS(MAYBE_WebSocket_BufferedAmount)
TEST_PPAPI_NACL_VIA_HTTP_WITH_WS(MAYBE_WebSocket_AbortCallsWithCallback)
TEST_PPAPI_NACL_VIA_HTTP_WITH_WS(WebSocket_AbortSendMessageCall)
TEST_PPAPI_NACL_VIA_HTTP_WITH_WS(MAYBE_WebSocket_AbortCloseCall)
...
TEST_PPAPI_NACL_VIA_HTTP_WITH_WS(MAYBE_WebSocket_UtilityValidClose)
...
TEST_PPAPI_NACL_VIA_HTTP_WITH_WS(MAYBE_WebSocket_UtilityBufferedAmount)
