...
class MyInstance : public Instance {
 ...
 private:
  std::string TestServerSocket() {
    int32_t socket_id = 0;
    {
      TestCompletionCallbackWithOutput<socket::CreateInfo_Dev>
    ...
    {
      TestCompletionCallbackWithOutput<socket::AcceptInfo_Dev>
          callback(pp_instance());
    ...
    {
      TestCompletionCallbackWithOutput<socket::WriteInfo_Dev>
          callback(pp_instance());
    ...
    {
      TestCompletionCallbackWithOutput<socket::ReadInfo_Dev>
          callback(pp_instance());
  ...
  std::string TestClientSocket() {
    ...
    {
      TestCompletionCallbackWithOutput<socket::SocketInfo_Dev>
          callback(pp_instance());
...

    {
      ...
      if (socket_type.value == socket::SocketType_Dev::TCP) {
        ...
        TestCompletionCallbackWithOutput<socket::RecvFromInfo_Dev>
