...
public class PrecacheUMA {
    ...
    public static class Event {
         ...
         * Chrome upgrade or boot signal from Android.
         */
        public static final int PERIODIC_TASK_SCHEDULE_BOOT_SIGNAL = 11;
        public static final int PERIODIC_TASK_SCHEDULE_BOOT_SIGNAL_FAIL = 12;
        ...
        public static final int EVENT_END = 63;
    ...
    public static void record(int event) {
        ...
        if (LibraryLoader.isInitialized()) {
            RecordHistogram.recordEnumeratedHistogram(EVENTS_HISTOGRAM, Event.getBitPosition(event),
                    Event.getBitPosition(Event.EVENT_END));
            for (int e : Event.getEventsFromBitMask(persistent_metric)) {
                RecordHistogram.recordEnumeratedHistogram(EVENTS_HISTOGRAM, Event.getBitPosition(e),
                        Event.getBitPosition(Event.EVENT_END));
            }
