...
#ifndef COMPONENTS_TEST_RUNNER_APP_BANNER_SERVICE_H_
#define COMPONENTS_TEST_RUNNER_APP_BANNER_SERVICE_H_
...
#endif  // COMPONENTS_TEST_RUNNER_APP_BANNER_SERVICE_H_
