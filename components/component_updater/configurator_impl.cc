...
std::vector<uint8_t> ConfiguratorImpl::GetRunActionKeyHash() const {
  ...
  return std::vector<uint8_t>{0x83, 0x32, 0x8f, 0x2b, 0x99, 0x75, 0x46, 0x25,
                              0x00, 0x00, 0xf3, 0x8b, 0x33, 0xff, 0xb0, 0xbf,
                              0xea, 0xea, 0x19, 0xb3, 0x38, 0xfb, 0xdc, 0xb3,
                              0x28, 0x90, 0x5f, 0xe2, 0xbe, 0x28, 0x89, 0x11};
}
