...
#ifndef COMPONENTS_SYNC_API_SYNC_ERROR_FACTORY_MOCK_H_
#define COMPONENTS_SYNC_API_SYNC_ERROR_FACTORY_MOCK_H_
...
#endif  // COMPONENTS_SYNC_API_SYNC_ERROR_FACTORY_MOCK_H_
