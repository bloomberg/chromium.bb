...
#ifndef COMPONENTS_SYNC_TEST_DIRECTORY_BACKING_STORE_CORRUPTION_TESTING_H_
#define COMPONENTS_SYNC_TEST_DIRECTORY_BACKING_STORE_CORRUPTION_TESTING_H_
...
#endif  // COMPONENTS_SYNC_TEST_DIRECTORY_BACKING_STORE_CORRUPTION_TESTING_H_
