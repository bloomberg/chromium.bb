...
TEST_F(CrashHandlerTest, UseAfterFree) {
...
TEST_F(CrashHandlerTest, DoubleFree) {
  base::ScopedTempDir database_dir;
  ASSERT_TRUE(database_dir.CreateUniqueTempDir());
...
TEST_F(CrashHandlerTest, Underflow) {
  base::ScopedTempDir database_dir;
  ASSERT_TRUE(database_dir.CreateUniqueTempDir());
...
TEST_F(CrashHandlerTest, Overflow) {
  base::ScopedTempDir database_dir;
  ASSERT_TRUE(database_dir.CreateUniqueTempDir());
...
TEST_F(CrashHandlerTest, UnrelatedException) {
  base::ScopedTempDir database_dir;
  ASSERT_TRUE(database_dir.CreateUniqueTempDir());
