...
#ifndef COMPONENTS_VIZ_DISPLAY_COMPOSITOR_DISPLAY_PROVIDER_H_
#define COMPONENTS_VIZ_DISPLAY_COMPOSITOR_DISPLAY_PROVIDER_H_
...
#endif  //  COMPONENTS_VIZ_DISPLAY_COMPOSITOR_DISPLAY_PROVIDER_H_
