...
class TestPaygenBuildLibDiscoverRequiredPayloads(MockImageDiscoveryHelper,
  ...
  def testCanaryEverything(self):
    ...
    # Define the expected payloads.
    mp_full = gspaths.Payload(tgt_image=mp_image)
    premp_full = gspaths.Payload(tgt_image=premp_image)
    test_full = gspaths.Payload(tgt_image=test_image)
    n2n_delta = gspaths.Payload(tgt_image=test_image, src_image=test_image)
    mp_delta = gspaths.Payload(tgt_image=mp_image, src_image=prev_mp_image)
    premp_delta = gspaths.Payload(tgt_image=premp_image,
  ...
  def testStable(self):
    ...
    mp_delta_8530 = gspaths.Payload(
        tgt_image=mp_image, src_image=image_8530)
    test_delta_8530 = gspaths.Payload(
        tgt_image=test_image, src_image=test_image_8530)
    mp_delta_8743 = gspaths.Payload(
        tgt_image=mp_image, src_image=image_8743)
    test_delta_8743 = gspaths.Payload(
        tgt_image=test_image, src_image=test_image_8743)
    mp_delta_8872 = gspaths.Payload(
        tgt_image=mp_image, src_image=image_8872)
    test_delta_8872 = gspaths.Payload(
        tgt_image=test_image, src_image=test_image_8872)
    mp_delta_9000 = gspaths.Payload(
        tgt_image=mp_image, src_image=image_9000)
    test_delta_9000 = gspaths.Payload(
        tgt_image=test_image, src_image=test_image_9000)
    mp_delta_9202 = gspaths.Payload(
        tgt_image=mp_image, src_image=image_9202)
    test_delta_9202 = gspaths.Payload(
        tgt_image=test_image, src_image=test_image_9202)
    mp_delta_9334 = gspaths.Payload(
        tgt_image=mp_image, src_image=image_9334)
    test_delta_9334 = gspaths.Payload(
        tgt_image=test_image, src_image=test_image_9334)
    mp_delta_9460 = gspaths.Payload(
        tgt_image=mp_image, src_image=image_9460)
    test_delta_9460 = gspaths.Payload(
        tgt_image=test_image, src_image=test_image_9460)
    mp_delta_9460_67 = gspaths.Payload(
        tgt_image=mp_image, src_image=image_9460_67)
    test_delta_9460_67 = gspaths.Payload(
        tgt_image=test_image, src_image=test_image_9460_67)
