...
const char kSampleCompressPakContentsV5[] = {
    ...
    // echo -n "this is id 6!" | gzip -f -c | hexdump -C
    0x1f, 0x8b, 0x08, 0x00, 0x9f, 0x97, 0xf5, 0x5c, 0x00, 0x03, 0x2b, 0xc9,
    0xc8, 0x2c, 0x56, 0x00, 0xa1, 0x14, 0x05, 0x33, 0x45, 0x00, 0x50, 0x98,
    0xa7, 0x27, 0x0d, 0x00, 0x00, 0x00};
...
const char kSampleCompressScaledPakContents[] = {
    ...
    't', 'h', 'i', 's', ' ', 'i', 's', ' ', 'i', 'd', ' ', '4',
    // "x2 is id 6" gzipped with
    // echo -n "x2 is id 6" | gzip -f -c | hexdump -C
    0x1f, 0x8b, 0x08, 0x00, 0x65, 0x98, 0xf5, 0x5c, 0x00, 0x03, 0xab, 0x30,
    0x52, 0xc8, 0x2c, 0x56, 0xc8, 0x4c, 0x51, 0x30, 0x03, 0x00, 0x0b, 0x14,
    0x32, 0xfe, 0x0a, 0x00, 0x00, 0x00};
