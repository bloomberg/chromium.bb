...
UI_BASE_EXPORT extern const char kMaterialDesignInkDrop[];
UI_BASE_EXPORT extern const char kMaterialDesignInkDropCircle[];
UI_BASE_EXPORT extern const char kMaterialDesignInkDropSquare[];
