...
ICCProfile ICCProfileForTestingAdobeRGB() {
  const unsigned char adobe_rgb_icc_data[] = {
  ...
  return ICCProfile::FromData(reinterpret_cast<const char*>(adobe_rgb_icc_data),
                              arraysize(adobe_rgb_icc_data));
}

ICCProfile ICCProfileForTestingGenericRGB() {
  const unsigned char generic_rgb_icc_data[] = {
  ...
  return ICCProfile::FromData(
      reinterpret_cast<const char*>(generic_rgb_icc_data),
      arraysize(generic_rgb_icc_data));
}
