...
struct AX_EXPORT AssistantNode {
  AssistantNode();
...
struct AX_EXPORT AssistantTree {
  AssistantTree();
  ~AssistantTree();
...
AX_EXPORT bool AXRoleIsLink(ax::mojom::Role role);
AX_EXPORT base::string16 AXUrlBaseText(base::string16 url);
AX_EXPORT const char* AXRoleToAndroidClassName(ax::mojom::Role role,
                                               bool has_parent);
