...
#ifndef UI_OZONE_PUBLIC_GPU_MEMORY_BUFFER_FACTORY_OZONE_NATIVE_BUFFER_H_
#define UI_OZONE_PUBLIC_GPU_MEMORY_BUFFER_FACTORY_OZONE_NATIVE_BUFFER_H_
...
class OZONE_BASE_EXPORT GpuMemoryBufferFactoryOzoneNativeBuffer {
 public:
...
#endif  // UI_OZONE_PUBLIC_SURFACE_FACTORY_OZONE_NATIVE_BUFFER_H_
