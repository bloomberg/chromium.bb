...
_BUILDERCONFIG = _descriptor.Descriptor(
  ...
  nested_types=[_BUILDERCONFIG_ID, _BUILDERCONFIG_GENERAL, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
