...
#ifndef STREAMING_CAST_PACKET_RECEIVE_STATS_TRACKER_H_
#define STREAMING_CAST_PACKET_RECEIVE_STATS_TRACKER_H_
...
class PacketReceiveStatsTracker {
 ...
 private:
  ...
  platform::Clock::time_point last_rtp_packet_arrival_time_;
  ...
  platform::Clock::duration jitter_;
};

}  // namespace cast_streaming
}  // namespace openscreen

#endif  // STREAMING_CAST_PACKET_RECEIVE_STATS_TRACKER_H_
