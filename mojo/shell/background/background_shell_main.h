...
#ifndef MOJO_SHELL_BACKGROUND_BACKGROUND_SHELL_MAIN_H_
#define MOJO_SHELL_BACKGROUND_BACKGROUND_SHELL_MAIN_H_
...
#endif  // MOJO_SHELL_BACKGROUND_BACKGROUND_SHELL_MAIN_H_
