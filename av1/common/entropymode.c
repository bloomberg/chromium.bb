...
const aom_cdf_prob
    default_kf_y_mode_cdf[INTRA_MODES][INTRA_MODES][CDF_SIZE(INTRA_MODES)] = {
...
#else
      {
          ...
          {
              AOM_ICDF(11008), AOM_ICDF(15004), AOM_ICDF(16534),
              AOM_ICDF(18158), AOM_ICDF(21515), AOM_ICDF(26668),
              AOM_ICDF(27834), AOM_ICDF(28735), AOM_ICDF(30471),
              AOM_ICDF(30839), AOM_ICDF(30969), AOM_ICDF(31068),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6272), AOM_ICDF(7963), AOM_ICDF(11944), AOM_ICDF(12780),
              AOM_ICDF(17944), AOM_ICDF(19198), AOM_ICDF(24071),
              AOM_ICDF(25295), AOM_ICDF(25834), AOM_ICDF(29014),
              AOM_ICDF(29949), AOM_ICDF(31733), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(8192), AOM_ICDF(10189), AOM_ICDF(14596), AOM_ICDF(15680),
              AOM_ICDF(17143), AOM_ICDF(17909), AOM_ICDF(19201),
              AOM_ICDF(23711), AOM_ICDF(24503), AOM_ICDF(28207),
              AOM_ICDF(29338), AOM_ICDF(31424), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(10752), AOM_ICDF(13199), AOM_ICDF(15048),
              AOM_ICDF(17151), AOM_ICDF(18445), AOM_ICDF(19604),
              AOM_ICDF(20363), AOM_ICDF(21782), AOM_ICDF(24311),
              AOM_ICDF(28026), AOM_ICDF(29517), AOM_ICDF(30962),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(7424), AOM_ICDF(10301), AOM_ICDF(13245), AOM_ICDF(14307),
              AOM_ICDF(16021), AOM_ICDF(16257), AOM_ICDF(17265),
              AOM_ICDF(18739), AOM_ICDF(20080), AOM_ICDF(26066),
              AOM_ICDF(28325), AOM_ICDF(31184), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6528), AOM_ICDF(10893), AOM_ICDF(13773), AOM_ICDF(14824),
              AOM_ICDF(16540), AOM_ICDF(16926), AOM_ICDF(17748),
              AOM_ICDF(18876), AOM_ICDF(20396), AOM_ICDF(25974),
              AOM_ICDF(28795), AOM_ICDF(30820), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(8704), AOM_ICDF(11005), AOM_ICDF(14320), AOM_ICDF(15349),
              AOM_ICDF(16746), AOM_ICDF(16884), AOM_ICDF(17887),
              AOM_ICDF(19304), AOM_ICDF(20265), AOM_ICDF(26115),
              AOM_ICDF(27672), AOM_ICDF(31358), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6272), AOM_ICDF(9504), AOM_ICDF(15437), AOM_ICDF(16399),
              AOM_ICDF(17355), AOM_ICDF(17948), AOM_ICDF(18814),
              AOM_ICDF(20270), AOM_ICDF(21134), AOM_ICDF(23690),
              AOM_ICDF(24759), AOM_ICDF(26454), AOM_ICDF(32768), 0,
          },
      },
      {
          {
          ...
          },
          {
              ...
              AOM_ICDF(21519), AOM_ICDF(26341), AOM_ICDF(26922),
              AOM_ICDF(27575), AOM_ICDF(29863), AOM_ICDF(30432),
              AOM_ICDF(30769), AOM_ICDF(30881), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(2944), AOM_ICDF(11971), AOM_ICDF(13509), AOM_ICDF(14295),
              AOM_ICDF(17202), AOM_ICDF(19005), AOM_ICDF(21605),
              AOM_ICDF(22458), AOM_ICDF(23839), AOM_ICDF(27774),
              AOM_ICDF(29492), AOM_ICDF(30787), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(4224), AOM_ICDF(13072), AOM_ICDF(15288), AOM_ICDF(16406),
              AOM_ICDF(17285), AOM_ICDF(18362), AOM_ICDF(19003),
              AOM_ICDF(21378), AOM_ICDF(22942), AOM_ICDF(27093),
              AOM_ICDF(29381), AOM_ICDF(30872), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(5120), AOM_ICDF(15375), AOM_ICDF(16188), AOM_ICDF(17415),
              AOM_ICDF(18183), AOM_ICDF(19756), AOM_ICDF(20030),
              AOM_ICDF(20883), AOM_ICDF(23935), AOM_ICDF(27428),
              AOM_ICDF(29627), AOM_ICDF(30608), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(2816), AOM_ICDF(14999), AOM_ICDF(16352), AOM_ICDF(16969),
              AOM_ICDF(17836), AOM_ICDF(18125), AOM_ICDF(18514),
              AOM_ICDF(19181), AOM_ICDF(20650), AOM_ICDF(25773),
              AOM_ICDF(29172), AOM_ICDF(30662), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(2560), AOM_ICDF(16158), AOM_ICDF(17320), AOM_ICDF(17839),
              AOM_ICDF(18545), AOM_ICDF(18848), AOM_ICDF(19130),
              AOM_ICDF(19599), AOM_ICDF(20863), AOM_ICDF(25449),
              AOM_ICDF(29304), AOM_ICDF(30408), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(3328), AOM_ICDF(15146), AOM_ICDF(16880), AOM_ICDF(17523),
              AOM_ICDF(18340), AOM_ICDF(18563), AOM_ICDF(18896),
              AOM_ICDF(19582), AOM_ICDF(20944), AOM_ICDF(25914),
              AOM_ICDF(28759), AOM_ICDF(30583), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(2560), AOM_ICDF(16618), AOM_ICDF(18460), AOM_ICDF(19207),
              AOM_ICDF(19654), AOM_ICDF(20276), AOM_ICDF(20529),
              AOM_ICDF(21179), AOM_ICDF(22355), AOM_ICDF(25423),
              AOM_ICDF(27696), AOM_ICDF(28638), AOM_ICDF(32768), 0,
          },
      },
      {
          {
          ...
          {
              AOM_ICDF(11264), AOM_ICDF(14751), AOM_ICDF(18517),
              AOM_ICDF(20285), AOM_ICDF(23172), AOM_ICDF(25970),
              AOM_ICDF(27312), AOM_ICDF(28684), AOM_ICDF(29803),
              AOM_ICDF(30242), AOM_ICDF(30412), AOM_ICDF(30668),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6528), AOM_ICDF(7509), AOM_ICDF(14190), AOM_ICDF(14953),
              AOM_ICDF(17905), AOM_ICDF(18452), AOM_ICDF(23074),
              AOM_ICDF(24910), AOM_ICDF(25374), AOM_ICDF(28605),
              AOM_ICDF(29542), AOM_ICDF(31640), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6784), AOM_ICDF(7644), AOM_ICDF(15953), AOM_ICDF(17055),
              AOM_ICDF(17945), AOM_ICDF(18242), AOM_ICDF(19351),
              AOM_ICDF(24705), AOM_ICDF(25365), AOM_ICDF(28466),
              AOM_ICDF(29334), AOM_ICDF(31245), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(8192), AOM_ICDF(9802), AOM_ICDF(14519), AOM_ICDF(15740),
              AOM_ICDF(17351), AOM_ICDF(18084), AOM_ICDF(18962),
              AOM_ICDF(20908), AOM_ICDF(22937), AOM_ICDF(26847),
              AOM_ICDF(28284), AOM_ICDF(29888), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(5888), AOM_ICDF(7534), AOM_ICDF(14635), AOM_ICDF(15436),
              AOM_ICDF(16710), AOM_ICDF(16830), AOM_ICDF(18000),
              AOM_ICDF(19760), AOM_ICDF(20571), AOM_ICDF(25777),
              AOM_ICDF(27649), AOM_ICDF(30668), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(5248), AOM_ICDF(7364), AOM_ICDF(14858), AOM_ICDF(15545),
              AOM_ICDF(16861), AOM_ICDF(17016), AOM_ICDF(17859),
              AOM_ICDF(19384), AOM_ICDF(20237), AOM_ICDF(25239),
              AOM_ICDF(27715), AOM_ICDF(29865), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6656), AOM_ICDF(7989), AOM_ICDF(15472), AOM_ICDF(16265),
              AOM_ICDF(17271), AOM_ICDF(17334), AOM_ICDF(18563),
              AOM_ICDF(20327), AOM_ICDF(20916), AOM_ICDF(26173),
              AOM_ICDF(27350), AOM_ICDF(31034), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(4480), AOM_ICDF(6411), AOM_ICDF(17828), AOM_ICDF(18611),
              AOM_ICDF(19399), AOM_ICDF(19684), AOM_ICDF(20504),
              AOM_ICDF(21782), AOM_ICDF(22335), AOM_ICDF(25286),
              AOM_ICDF(26352), AOM_ICDF(28016), AOM_ICDF(32768), 0,
          },
      },
      {
          {
          ...
          },
          {
              ...
              AOM_ICDF(19574), AOM_ICDF(24868), AOM_ICDF(25937),
              AOM_ICDF(27299), AOM_ICDF(31104), AOM_ICDF(31448),
              AOM_ICDF(31580), AOM_ICDF(31679), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(4992), AOM_ICDF(6458), AOM_ICDF(9945), AOM_ICDF(11961),
              AOM_ICDF(16136), AOM_ICDF(17677), AOM_ICDF(20946),
              AOM_ICDF(23042), AOM_ICDF(24475), AOM_ICDF(28304),
              AOM_ICDF(29748), AOM_ICDF(31791), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(9600), AOM_ICDF(11879), AOM_ICDF(14703), AOM_ICDF(17653),
              AOM_ICDF(19176), AOM_ICDF(20185), AOM_ICDF(20880),
              AOM_ICDF(25194), AOM_ICDF(26584), AOM_ICDF(29655),
              AOM_ICDF(30430), AOM_ICDF(32044), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(9856), AOM_ICDF(11385), AOM_ICDF(13457), AOM_ICDF(18705),
              AOM_ICDF(19577), AOM_ICDF(20266), AOM_ICDF(20746),
              AOM_ICDF(22207), AOM_ICDF(26724), AOM_ICDF(29431),
              AOM_ICDF(30645), AOM_ICDF(31604), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6272), AOM_ICDF(9318), AOM_ICDF(11569), AOM_ICDF(14812),
              AOM_ICDF(16351), AOM_ICDF(16619), AOM_ICDF(17537),
              AOM_ICDF(19596), AOM_ICDF(22025), AOM_ICDF(27384),
              AOM_ICDF(29277), AOM_ICDF(31422), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(5888), AOM_ICDF(9348), AOM_ICDF(11416), AOM_ICDF(14690),
              AOM_ICDF(16254), AOM_ICDF(16633), AOM_ICDF(17457),
              AOM_ICDF(19031), AOM_ICDF(21875), AOM_ICDF(27080),
              AOM_ICDF(29442), AOM_ICDF(31193), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6912), AOM_ICDF(9329), AOM_ICDF(12218), AOM_ICDF(15177),
              AOM_ICDF(16806), AOM_ICDF(16998), AOM_ICDF(17991),
              AOM_ICDF(20005), AOM_ICDF(21952), AOM_ICDF(27108),
              AOM_ICDF(28867), AOM_ICDF(31657), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(5120), AOM_ICDF(9098), AOM_ICDF(13132), AOM_ICDF(17701),
              AOM_ICDF(18739), AOM_ICDF(19534), AOM_ICDF(20415),
              AOM_ICDF(22136), AOM_ICDF(24213), AOM_ICDF(27199),
              AOM_ICDF(28504), AOM_ICDF(29960), AOM_ICDF(32768), 0,
          },
      },
      {
          {
          ...
          },
          {
              ...
              AOM_ICDF(19608), AOM_ICDF(25882), AOM_ICDF(28520),
              AOM_ICDF(29445), AOM_ICDF(31106), AOM_ICDF(31573),
              AOM_ICDF(31775), AOM_ICDF(31872), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(3840), AOM_ICDF(4833), AOM_ICDF(7551), AOM_ICDF(8449),
              AOM_ICDF(16668), AOM_ICDF(18614), AOM_ICDF(23952),
              AOM_ICDF(25668), AOM_ICDF(26721), AOM_ICDF(29888),
              AOM_ICDF(30697), AOM_ICDF(32090), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6528), AOM_ICDF(8011), AOM_ICDF(11083), AOM_ICDF(12427),
              AOM_ICDF(16188), AOM_ICDF(17548), AOM_ICDF(19625),
              AOM_ICDF(23787), AOM_ICDF(24792), AOM_ICDF(28649),
              AOM_ICDF(29872), AOM_ICDF(31845), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(7168), AOM_ICDF(9170), AOM_ICDF(10655), AOM_ICDF(12439),
              AOM_ICDF(15550), AOM_ICDF(18128), AOM_ICDF(19565),
              AOM_ICDF(21412), AOM_ICDF(23355), AOM_ICDF(28007),
              AOM_ICDF(30080), AOM_ICDF(31568), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(5504), AOM_ICDF(7636), AOM_ICDF(10174), AOM_ICDF(11056),
              AOM_ICDF(15562), AOM_ICDF(16252), AOM_ICDF(17931),
              AOM_ICDF(19598), AOM_ICDF(20967), AOM_ICDF(26845),
              AOM_ICDF(29149), AOM_ICDF(31490), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(5248), AOM_ICDF(7810), AOM_ICDF(10004), AOM_ICDF(11015),
              AOM_ICDF(15359), AOM_ICDF(16310), AOM_ICDF(17834),
              AOM_ICDF(19185), AOM_ICDF(20903), AOM_ICDF(26728),
              AOM_ICDF(29585), AOM_ICDF(31478), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(5376), AOM_ICDF(7322), AOM_ICDF(10592), AOM_ICDF(11694),
              AOM_ICDF(15586), AOM_ICDF(16103), AOM_ICDF(17999),
              AOM_ICDF(19740), AOM_ICDF(20950), AOM_ICDF(26894),
              AOM_ICDF(28912), AOM_ICDF(31591), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(4608), AOM_ICDF(7276), AOM_ICDF(12153), AOM_ICDF(13388),
              AOM_ICDF(16091), AOM_ICDF(17970), AOM_ICDF(19548),
              AOM_ICDF(21175), AOM_ICDF(22481), AOM_ICDF(26543),
              AOM_ICDF(28212), AOM_ICDF(29908), AOM_ICDF(32768), 0,
          },
      },
      {
          {
              AOM_ICDF(6656), AOM_ICDF(12225), AOM_ICDF(14441), AOM_ICDF(15158),
              AOM_ICDF(19600), AOM_ICDF(27127), AOM_ICDF(28221),
              AOM_ICDF(29186), AOM_ICDF(30439), AOM_ICDF(30913),
              AOM_ICDF(31135), AOM_ICDF(31238), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6400), AOM_ICDF(14608), AOM_ICDF(15920), AOM_ICDF(16643),
              AOM_ICDF(20149), AOM_ICDF(27328), AOM_ICDF(27896),
              AOM_ICDF(28672), AOM_ICDF(30227), AOM_ICDF(30778),
              AOM_ICDF(31053), AOM_ICDF(31120), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(3840), AOM_ICDF(6925), AOM_ICDF(14671), AOM_ICDF(15709),
              AOM_ICDF(19830), AOM_ICDF(24216), AOM_ICDF(25507),
              AOM_ICDF(27459), AOM_ICDF(28552), AOM_ICDF(29569),
              AOM_ICDF(29808), AOM_ICDF(30169), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(9600), AOM_ICDF(13604), AOM_ICDF(15202), AOM_ICDF(17530),
              AOM_ICDF(20878), AOM_ICDF(24279), AOM_ICDF(25278),
              AOM_ICDF(28255), AOM_ICDF(30651), AOM_ICDF(31170),
              AOM_ICDF(31343), AOM_ICDF(31410), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(4608), AOM_ICDF(8535), AOM_ICDF(9588), AOM_ICDF(10740),
              AOM_ICDF(18673), AOM_ICDF(27664), AOM_ICDF(28826),
              AOM_ICDF(29828), AOM_ICDF(31081), AOM_ICDF(31503),
              AOM_ICDF(31680), AOM_ICDF(31778), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(4864), AOM_ICDF(10543), AOM_ICDF(11313), AOM_ICDF(12197),
              AOM_ICDF(16785), AOM_ICDF(27858), AOM_ICDF(28556),
              AOM_ICDF(29480), AOM_ICDF(30892), AOM_ICDF(31486),
              AOM_ICDF(31722), AOM_ICDF(31787), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(3968), AOM_ICDF(7492), AOM_ICDF(10283), AOM_ICDF(11318),
              AOM_ICDF(18486), AOM_ICDF(24061), AOM_ICDF(26761),
              AOM_ICDF(28456), AOM_ICDF(30126), AOM_ICDF(30872),
              AOM_ICDF(31088), AOM_ICDF(31305), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6016), AOM_ICDF(10246), AOM_ICDF(12999), AOM_ICDF(15083),
              AOM_ICDF(18769), AOM_ICDF(22398), AOM_ICDF(23584),
              AOM_ICDF(27098), AOM_ICDF(29574), AOM_ICDF(30609),
              AOM_ICDF(30898), AOM_ICDF(31200), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(7808), AOM_ICDF(13404), AOM_ICDF(14723), AOM_ICDF(16413),
              AOM_ICDF(20186), AOM_ICDF(24739), AOM_ICDF(25407),
              AOM_ICDF(27106), AOM_ICDF(29929), AOM_ICDF(30507),
              AOM_ICDF(30827), AOM_ICDF(30915), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(2816), AOM_ICDF(6530), AOM_ICDF(8123), AOM_ICDF(9240),
              AOM_ICDF(12536), AOM_ICDF(17593), AOM_ICDF(18754),
              AOM_ICDF(20319), AOM_ICDF(22070), AOM_ICDF(27037),
              AOM_ICDF(29332), AOM_ICDF(30779), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(2432), AOM_ICDF(6577), AOM_ICDF(8010), AOM_ICDF(9215),
              AOM_ICDF(12657), AOM_ICDF(18898), AOM_ICDF(19588),
              AOM_ICDF(20953), AOM_ICDF(22766), AOM_ICDF(27231),
              AOM_ICDF(29927), AOM_ICDF(31109), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(3200), AOM_ICDF(6974), AOM_ICDF(9162), AOM_ICDF(10450),
              AOM_ICDF(13818), AOM_ICDF(17757), AOM_ICDF(19119),
              AOM_ICDF(20842), AOM_ICDF(22269), AOM_ICDF(27170),
              AOM_ICDF(29271), AOM_ICDF(30804), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(4480), AOM_ICDF(10689), AOM_ICDF(15307), AOM_ICDF(16589),
              AOM_ICDF(19738), AOM_ICDF(24416), AOM_ICDF(25332),
              AOM_ICDF(26541), AOM_ICDF(28634), AOM_ICDF(29711),
              AOM_ICDF(29913), AOM_ICDF(30116), AOM_ICDF(32768), 0,
          },
      },
      {
          {
              AOM_ICDF(9600), AOM_ICDF(11066), AOM_ICDF(15832), AOM_ICDF(16515),
              AOM_ICDF(18844), AOM_ICDF(19883), AOM_ICDF(24302),
              AOM_ICDF(25759), AOM_ICDF(26358), AOM_ICDF(29290),
              AOM_ICDF(30262), AOM_ICDF(31682), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(8832), AOM_ICDF(12814), AOM_ICDF(16171), AOM_ICDF(17041),
              AOM_ICDF(19066), AOM_ICDF(20145), AOM_ICDF(22933),
              AOM_ICDF(24074), AOM_ICDF(25006), AOM_ICDF(28115),
              AOM_ICDF(29722), AOM_ICDF(30991), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(3840), AOM_ICDF(4486), AOM_ICDF(15821), AOM_ICDF(16330),
              AOM_ICDF(18461), AOM_ICDF(18879), AOM_ICDF(22436),
              AOM_ICDF(25051), AOM_ICDF(25443), AOM_ICDF(28637),
              AOM_ICDF(29396), AOM_ICDF(31412), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(9856), AOM_ICDF(10863), AOM_ICDF(14050), AOM_ICDF(15920),
              AOM_ICDF(18783), AOM_ICDF(19531), AOM_ICDF(22502),
              AOM_ICDF(24577), AOM_ICDF(25361), AOM_ICDF(28559),
              AOM_ICDF(29600), AOM_ICDF(31336), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6528), AOM_ICDF(7620), AOM_ICDF(10182), AOM_ICDF(11199),
              AOM_ICDF(17281), AOM_ICDF(19946), AOM_ICDF(23885),
              AOM_ICDF(25333), AOM_ICDF(26130), AOM_ICDF(29425),
              AOM_ICDF(30332), AOM_ICDF(31948), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(9728), AOM_ICDF(11821), AOM_ICDF(13954), AOM_ICDF(15233),
              AOM_ICDF(19855), AOM_ICDF(24478), AOM_ICDF(28675),
              AOM_ICDF(29878), AOM_ICDF(31238), AOM_ICDF(31741),
              AOM_ICDF(31874), AOM_ICDF(32048), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(5120), AOM_ICDF(5753), AOM_ICDF(9673), AOM_ICDF(10149),
              AOM_ICDF(14343), AOM_ICDF(15190), AOM_ICDF(24967),
              AOM_ICDF(26378), AOM_ICDF(26841), AOM_ICDF(29749),
              AOM_ICDF(30527), AOM_ICDF(32120), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(5888), AOM_ICDF(6606), AOM_ICDF(11498), AOM_ICDF(12538),
              AOM_ICDF(14737), AOM_ICDF(15425), AOM_ICDF(19549),
              AOM_ICDF(24047), AOM_ICDF(24765), AOM_ICDF(28711),
              AOM_ICDF(29822), AOM_ICDF(32138), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(10368), AOM_ICDF(11757), AOM_ICDF(14126),
              AOM_ICDF(15474), AOM_ICDF(18311), AOM_ICDF(19358),
              AOM_ICDF(21539), AOM_ICDF(23451), AOM_ICDF(25034),
              AOM_ICDF(28791), AOM_ICDF(30035), AOM_ICDF(31280),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6016), AOM_ICDF(7623), AOM_ICDF(11378), AOM_ICDF(12248),
              AOM_ICDF(15171), AOM_ICDF(15459), AOM_ICDF(18958),
              AOM_ICDF(20875), AOM_ICDF(21955), AOM_ICDF(27411),
              AOM_ICDF(29196), AOM_ICDF(31723), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(5760), AOM_ICDF(7469), AOM_ICDF(11399), AOM_ICDF(12323),
              AOM_ICDF(15165), AOM_ICDF(15528), AOM_ICDF(18804),
              AOM_ICDF(20769), AOM_ICDF(21767), AOM_ICDF(27129),
              AOM_ICDF(29435), AOM_ICDF(31502), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(7040), AOM_ICDF(8295), AOM_ICDF(12298), AOM_ICDF(13035),
              AOM_ICDF(15194), AOM_ICDF(15357), AOM_ICDF(18976),
              AOM_ICDF(21100), AOM_ICDF(21805), AOM_ICDF(26978),
              AOM_ICDF(28342), AOM_ICDF(31763), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(5632), AOM_ICDF(7465), AOM_ICDF(14220), AOM_ICDF(15035),
              AOM_ICDF(17014), AOM_ICDF(18105), AOM_ICDF(21111),
              AOM_ICDF(23027), AOM_ICDF(23934), AOM_ICDF(27207),
              AOM_ICDF(28293), AOM_ICDF(30330), AOM_ICDF(32768), 0,
          },
      },
      {
          {
              AOM_ICDF(11008), AOM_ICDF(13089), AOM_ICDF(17144),
              AOM_ICDF(18425), AOM_ICDF(19954), AOM_ICDF(20624),
              AOM_ICDF(21658), AOM_ICDF(24229), AOM_ICDF(25290),
              AOM_ICDF(28803), AOM_ICDF(29938), AOM_ICDF(31493),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(9088), AOM_ICDF(14218), AOM_ICDF(16378), AOM_ICDF(17699),
              AOM_ICDF(18935), AOM_ICDF(19928), AOM_ICDF(20524),
              AOM_ICDF(22781), AOM_ICDF(24155), AOM_ICDF(27523),
              AOM_ICDF(29068), AOM_ICDF(30270), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6144), AOM_ICDF(7194), AOM_ICDF(17912), AOM_ICDF(18991),
              AOM_ICDF(19879), AOM_ICDF(20151), AOM_ICDF(21170),
              AOM_ICDF(23938), AOM_ICDF(24712), AOM_ICDF(27763),
              AOM_ICDF(28556), AOM_ICDF(30584), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(10496), AOM_ICDF(11614), AOM_ICDF(13652),
              AOM_ICDF(16928), AOM_ICDF(18425), AOM_ICDF(18967),
              AOM_ICDF(19724), AOM_ICDF(23817), AOM_ICDF(25594),
              AOM_ICDF(28685), AOM_ICDF(29734), AOM_ICDF(30941),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(7296), AOM_ICDF(8915), AOM_ICDF(11163), AOM_ICDF(13821),
              AOM_ICDF(16951), AOM_ICDF(18507), AOM_ICDF(20180),
              AOM_ICDF(22423), AOM_ICDF(24017), AOM_ICDF(28294),
              AOM_ICDF(29614), AOM_ICDF(31673), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(9728), AOM_ICDF(13441), AOM_ICDF(15858), AOM_ICDF(18860),
              AOM_ICDF(21713), AOM_ICDF(24478), AOM_ICDF(25995),
              AOM_ICDF(28233), AOM_ICDF(30347), AOM_ICDF(30853),
              AOM_ICDF(31081), AOM_ICDF(31328), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6400), AOM_ICDF(7480), AOM_ICDF(11482), AOM_ICDF(13206),
              AOM_ICDF(16199), AOM_ICDF(16908), AOM_ICDF(20436),
              AOM_ICDF(23507), AOM_ICDF(24650), AOM_ICDF(28360),
              AOM_ICDF(29438), AOM_ICDF(31532), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(9856), AOM_ICDF(10979), AOM_ICDF(13430), AOM_ICDF(15195),
              AOM_ICDF(15957), AOM_ICDF(16350), AOM_ICDF(16871),
              AOM_ICDF(26198), AOM_ICDF(26991), AOM_ICDF(29612),
              AOM_ICDF(30438), AOM_ICDF(31962), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(8960), AOM_ICDF(10529), AOM_ICDF(12640), AOM_ICDF(15350),
              AOM_ICDF(16987), AOM_ICDF(17859), AOM_ICDF(18590),
              AOM_ICDF(21400), AOM_ICDF(23812), AOM_ICDF(28188),
              AOM_ICDF(29589), AOM_ICDF(31280), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(7168), AOM_ICDF(8877), AOM_ICDF(12393), AOM_ICDF(14015),
              AOM_ICDF(15655), AOM_ICDF(15794), AOM_ICDF(16814),
              AOM_ICDF(19923), AOM_ICDF(21086), AOM_ICDF(26723),
              AOM_ICDF(28669), AOM_ICDF(31468), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6400), AOM_ICDF(8900), AOM_ICDF(12241), AOM_ICDF(13828),
              AOM_ICDF(15513), AOM_ICDF(15671), AOM_ICDF(16500),
              AOM_ICDF(19257), AOM_ICDF(20456), AOM_ICDF(25984),
              AOM_ICDF(28658), AOM_ICDF(31017), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(7296), AOM_ICDF(8820), AOM_ICDF(12885), AOM_ICDF(14441),
              AOM_ICDF(15813), AOM_ICDF(15911), AOM_ICDF(16954),
              AOM_ICDF(20026), AOM_ICDF(20950), AOM_ICDF(26563),
              AOM_ICDF(28140), AOM_ICDF(31673), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6272), AOM_ICDF(8455), AOM_ICDF(13328), AOM_ICDF(15907),
              AOM_ICDF(17026), AOM_ICDF(17464), AOM_ICDF(18267),
              AOM_ICDF(21436), AOM_ICDF(22712), AOM_ICDF(26403),
              AOM_ICDF(27660), AOM_ICDF(29559), AOM_ICDF(32768), 0,
          },
      },
      {
          {
              AOM_ICDF(6784), AOM_ICDF(11216), AOM_ICDF(13269), AOM_ICDF(15677),
              AOM_ICDF(16931), AOM_ICDF(18445), AOM_ICDF(19097),
              AOM_ICDF(20082), AOM_ICDF(24298), AOM_ICDF(28236),
              AOM_ICDF(30118), AOM_ICDF(31448), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(5760), AOM_ICDF(13240), AOM_ICDF(14110), AOM_ICDF(16966),
              AOM_ICDF(17743), AOM_ICDF(18916), AOM_ICDF(19281),
              AOM_ICDF(19848), AOM_ICDF(25552), AOM_ICDF(28646),
              AOM_ICDF(30444), AOM_ICDF(31291), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(4352), AOM_ICDF(6870), AOM_ICDF(14660), AOM_ICDF(16597),
              AOM_ICDF(17361), AOM_ICDF(18126), AOM_ICDF(18852),
              AOM_ICDF(20765), AOM_ICDF(23526), AOM_ICDF(27670),
              AOM_ICDF(29096), AOM_ICDF(31214), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(9472), AOM_ICDF(11736), AOM_ICDF(13172), AOM_ICDF(18192),
              AOM_ICDF(19070), AOM_ICDF(19651), AOM_ICDF(19991),
              AOM_ICDF(21793), AOM_ICDF(26005), AOM_ICDF(29291),
              AOM_ICDF(30500), AOM_ICDF(31767), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(4480), AOM_ICDF(7252), AOM_ICDF(8651), AOM_ICDF(12379),
              AOM_ICDF(14936), AOM_ICDF(17493), AOM_ICDF(18326),
              AOM_ICDF(19527), AOM_ICDF(23655), AOM_ICDF(28031),
              AOM_ICDF(29960), AOM_ICDF(31773), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6016), AOM_ICDF(11561), AOM_ICDF(12864), AOM_ICDF(15793),
              AOM_ICDF(18765), AOM_ICDF(23040), AOM_ICDF(23640),
              AOM_ICDF(24415), AOM_ICDF(31040), AOM_ICDF(31473),
              AOM_ICDF(31740), AOM_ICDF(31827), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(4480), AOM_ICDF(6825), AOM_ICDF(8810), AOM_ICDF(11269),
              AOM_ICDF(14257), AOM_ICDF(15716), AOM_ICDF(18397),
              AOM_ICDF(20006), AOM_ICDF(24020), AOM_ICDF(28230),
              AOM_ICDF(29780), AOM_ICDF(31773), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6912), AOM_ICDF(9466), AOM_ICDF(11717), AOM_ICDF(15159),
              AOM_ICDF(16237), AOM_ICDF(17145), AOM_ICDF(17814),
              AOM_ICDF(21258), AOM_ICDF(24754), AOM_ICDF(28864),
              AOM_ICDF(30313), AOM_ICDF(32061), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(7680), AOM_ICDF(10517), AOM_ICDF(11381), AOM_ICDF(16202),
              AOM_ICDF(16809), AOM_ICDF(17425), AOM_ICDF(17774),
              AOM_ICDF(18764), AOM_ICDF(26842), AOM_ICDF(29600),
              AOM_ICDF(31073), AOM_ICDF(31886), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(4992), AOM_ICDF(8626), AOM_ICDF(10531), AOM_ICDF(13103),
              AOM_ICDF(14495), AOM_ICDF(14784), AOM_ICDF(15365),
              AOM_ICDF(16657), AOM_ICDF(21051), AOM_ICDF(27011),
              AOM_ICDF(29685), AOM_ICDF(31574), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(4736), AOM_ICDF(9433), AOM_ICDF(10981), AOM_ICDF(13494),
              AOM_ICDF(14644), AOM_ICDF(15043), AOM_ICDF(15396),
              AOM_ICDF(16378), AOM_ICDF(21506), AOM_ICDF(26869),
              AOM_ICDF(29824), AOM_ICDF(31454), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(5760), AOM_ICDF(9526), AOM_ICDF(11905), AOM_ICDF(14476),
              AOM_ICDF(15722), AOM_ICDF(16103), AOM_ICDF(16768),
              AOM_ICDF(18070), AOM_ICDF(21630), AOM_ICDF(27401),
              AOM_ICDF(29592), AOM_ICDF(31818), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(4480), AOM_ICDF(9947), AOM_ICDF(12386), AOM_ICDF(15909),
              AOM_ICDF(16496), AOM_ICDF(17397), AOM_ICDF(17866),
              AOM_ICDF(18927), AOM_ICDF(24408), AOM_ICDF(27750),
              AOM_ICDF(29614), AOM_ICDF(30889), AOM_ICDF(32768), 0,
          },
      },
      {
          {
              AOM_ICDF(7424), AOM_ICDF(10538), AOM_ICDF(14098), AOM_ICDF(14891),
              AOM_ICDF(16486), AOM_ICDF(16756), AOM_ICDF(17607),
              AOM_ICDF(18952), AOM_ICDF(20168), AOM_ICDF(26275),
              AOM_ICDF(28617), AOM_ICDF(31580), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(5376), AOM_ICDF(13070), AOM_ICDF(14969), AOM_ICDF(15848),
              AOM_ICDF(17197), AOM_ICDF(17447), AOM_ICDF(17954),
              AOM_ICDF(18747), AOM_ICDF(20137), AOM_ICDF(25628),
              AOM_ICDF(28753), AOM_ICDF(30628), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(3584), AOM_ICDF(5287), AOM_ICDF(16141), AOM_ICDF(16840),
              AOM_ICDF(17670), AOM_ICDF(17760), AOM_ICDF(18532),
              AOM_ICDF(20387), AOM_ICDF(21102), AOM_ICDF(26118),
              AOM_ICDF(27535), AOM_ICDF(30830), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(7424), AOM_ICDF(9594), AOM_ICDF(11770), AOM_ICDF(14505),
              AOM_ICDF(16234), AOM_ICDF(16365), AOM_ICDF(17201),
              AOM_ICDF(20286), AOM_ICDF(22128), AOM_ICDF(27371),
              AOM_ICDF(29426), AOM_ICDF(31580), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(5632), AOM_ICDF(8393), AOM_ICDF(10566), AOM_ICDF(11917),
              AOM_ICDF(16025), AOM_ICDF(16697), AOM_ICDF(18123),
              AOM_ICDF(19541), AOM_ICDF(21135), AOM_ICDF(27059),
              AOM_ICDF(29325), AOM_ICDF(31814), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(3840), AOM_ICDF(7916), AOM_ICDF(9526), AOM_ICDF(11010),
              AOM_ICDF(14114), AOM_ICDF(18169), AOM_ICDF(19510),
              AOM_ICDF(21031), AOM_ICDF(23083), AOM_ICDF(27769),
              AOM_ICDF(29782), AOM_ICDF(31299), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(5376), AOM_ICDF(7338), AOM_ICDF(10657), AOM_ICDF(11699),
              AOM_ICDF(14780), AOM_ICDF(15070), AOM_ICDF(18291),
              AOM_ICDF(20170), AOM_ICDF(21347), AOM_ICDF(26985),
              AOM_ICDF(28811), AOM_ICDF(31805), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(5632), AOM_ICDF(7669), AOM_ICDF(11558), AOM_ICDF(12653),
              AOM_ICDF(13962), AOM_ICDF(14116), AOM_ICDF(15074),
              AOM_ICDF(19886), AOM_ICDF(21123), AOM_ICDF(26953),
              AOM_ICDF(28755), AOM_ICDF(31708), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6528), AOM_ICDF(9739), AOM_ICDF(11612), AOM_ICDF(13211),
              AOM_ICDF(14992), AOM_ICDF(15237), AOM_ICDF(16016),
              AOM_ICDF(17677), AOM_ICDF(20588), AOM_ICDF(26647),
              AOM_ICDF(29116), AOM_ICDF(31435), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(5376), AOM_ICDF(8346), AOM_ICDF(11022), AOM_ICDF(11976),
              AOM_ICDF(13541), AOM_ICDF(13749), AOM_ICDF(14520),
              AOM_ICDF(16173), AOM_ICDF(17567), AOM_ICDF(25182),
              AOM_ICDF(28111), AOM_ICDF(31591), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(4736), AOM_ICDF(8894), AOM_ICDF(11294), AOM_ICDF(12220),
              AOM_ICDF(13753), AOM_ICDF(14029), AOM_ICDF(14645),
              AOM_ICDF(16065), AOM_ICDF(17621), AOM_ICDF(24911),
              AOM_ICDF(28655), AOM_ICDF(31344), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(5760), AOM_ICDF(8193), AOM_ICDF(11667), AOM_ICDF(12461),
              AOM_ICDF(13880), AOM_ICDF(14040), AOM_ICDF(14946),
              AOM_ICDF(16537), AOM_ICDF(17642), AOM_ICDF(25117),
              AOM_ICDF(27333), AOM_ICDF(31713), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(4096), AOM_ICDF(8479), AOM_ICDF(13751), AOM_ICDF(14813),
              AOM_ICDF(15994), AOM_ICDF(16157), AOM_ICDF(16905),
              AOM_ICDF(18314), AOM_ICDF(19575), AOM_ICDF(25132),
              AOM_ICDF(27445), AOM_ICDF(30192), AOM_ICDF(32768), 0,
          },
      },
      {
          {
              AOM_ICDF(7936), AOM_ICDF(12263), AOM_ICDF(15558), AOM_ICDF(16331),
              AOM_ICDF(17779), AOM_ICDF(18148), AOM_ICDF(18810),
              AOM_ICDF(19794), AOM_ICDF(21046), AOM_ICDF(26644),
              AOM_ICDF(29417), AOM_ICDF(31507), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(5376), AOM_ICDF(15025), AOM_ICDF(16457), AOM_ICDF(17074),
              AOM_ICDF(18079), AOM_ICDF(18299), AOM_ICDF(18648),
              AOM_ICDF(19240), AOM_ICDF(20612), AOM_ICDF(25687),
              AOM_ICDF(29392), AOM_ICDF(30842), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(3840), AOM_ICDF(6037), AOM_ICDF(17465), AOM_ICDF(18089),
              AOM_ICDF(18869), AOM_ICDF(18953), AOM_ICDF(19688),
              AOM_ICDF(21223), AOM_ICDF(21816), AOM_ICDF(26562),
              AOM_ICDF(28195), AOM_ICDF(30621), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(8448), AOM_ICDF(11255), AOM_ICDF(13307), AOM_ICDF(15676),
              AOM_ICDF(17392), AOM_ICDF(17603), AOM_ICDF(18268),
              AOM_ICDF(20783), AOM_ICDF(22646), AOM_ICDF(27628),
              AOM_ICDF(29737), AOM_ICDF(31628), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(5760), AOM_ICDF(9119), AOM_ICDF(11015), AOM_ICDF(12269),
              AOM_ICDF(16280), AOM_ICDF(17023), AOM_ICDF(18282),
              AOM_ICDF(19418), AOM_ICDF(21325), AOM_ICDF(27309),
              AOM_ICDF(30004), AOM_ICDF(31818), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(3968), AOM_ICDF(9094), AOM_ICDF(10606), AOM_ICDF(12007),
              AOM_ICDF(14218), AOM_ICDF(18911), AOM_ICDF(20089),
              AOM_ICDF(20924), AOM_ICDF(23587), AOM_ICDF(27808),
              AOM_ICDF(30253), AOM_ICDF(31305), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6016), AOM_ICDF(8627), AOM_ICDF(11201), AOM_ICDF(12200),
              AOM_ICDF(15305), AOM_ICDF(15671), AOM_ICDF(18639),
              AOM_ICDF(20185), AOM_ICDF(21627), AOM_ICDF(26990),
              AOM_ICDF(29449), AOM_ICDF(31723), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6272), AOM_ICDF(8768), AOM_ICDF(12320), AOM_ICDF(13296),
              AOM_ICDF(14643), AOM_ICDF(14970), AOM_ICDF(15760),
              AOM_ICDF(20545), AOM_ICDF(21863), AOM_ICDF(27473),
              AOM_ICDF(29535), AOM_ICDF(31836), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6912), AOM_ICDF(10905), AOM_ICDF(12656), AOM_ICDF(14084),
              AOM_ICDF(15705), AOM_ICDF(16069), AOM_ICDF(16674),
              AOM_ICDF(17779), AOM_ICDF(21041), AOM_ICDF(26586),
              AOM_ICDF(29539), AOM_ICDF(31253), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(5248), AOM_ICDF(9672), AOM_ICDF(12113), AOM_ICDF(12871),
              AOM_ICDF(14423), AOM_ICDF(14710), AOM_ICDF(15376),
              AOM_ICDF(16708), AOM_ICDF(18092), AOM_ICDF(25260),
              AOM_ICDF(28991), AOM_ICDF(31585), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(4736), AOM_ICDF(10789), AOM_ICDF(13029), AOM_ICDF(13750),
              AOM_ICDF(15040), AOM_ICDF(15385), AOM_ICDF(15840),
              AOM_ICDF(16887), AOM_ICDF(18393), AOM_ICDF(25230),
              AOM_ICDF(29558), AOM_ICDF(31454), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6016), AOM_ICDF(9916), AOM_ICDF(12938), AOM_ICDF(13741),
              AOM_ICDF(15030), AOM_ICDF(15297), AOM_ICDF(16116),
              AOM_ICDF(17333), AOM_ICDF(18672), AOM_ICDF(25954),
              AOM_ICDF(28498), AOM_ICDF(31618), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(4608), AOM_ICDF(10266), AOM_ICDF(15450), AOM_ICDF(16299),
              AOM_ICDF(17114), AOM_ICDF(17288), AOM_ICDF(17775),
              AOM_ICDF(18835), AOM_ICDF(20227), AOM_ICDF(25199),
              AOM_ICDF(28098), AOM_ICDF(30018), AOM_ICDF(32768), 0,
          },
      },
      {
          {
              AOM_ICDF(7296), AOM_ICDF(9951), AOM_ICDF(14124), AOM_ICDF(14806),
              AOM_ICDF(16181), AOM_ICDF(16377), AOM_ICDF(17485),
              AOM_ICDF(19069), AOM_ICDF(20078), AOM_ICDF(26051),
              AOM_ICDF(27777), AOM_ICDF(31574), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(5376), AOM_ICDF(13823), AOM_ICDF(15889), AOM_ICDF(16620),
              AOM_ICDF(17709), AOM_ICDF(17881), AOM_ICDF(18327),
              AOM_ICDF(19140), AOM_ICDF(20374), AOM_ICDF(25685),
              AOM_ICDF(28160), AOM_ICDF(30521), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(3200), AOM_ICDF(4602), AOM_ICDF(16404), AOM_ICDF(17042),
              AOM_ICDF(17780), AOM_ICDF(17829), AOM_ICDF(18706),
              AOM_ICDF(20608), AOM_ICDF(21115), AOM_ICDF(25884),
              AOM_ICDF(26960), AOM_ICDF(30804), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(7040), AOM_ICDF(9444), AOM_ICDF(11770), AOM_ICDF(14321),
              AOM_ICDF(15951), AOM_ICDF(16074), AOM_ICDF(17033),
              AOM_ICDF(20352), AOM_ICDF(22301), AOM_ICDF(27567),
              AOM_ICDF(29151), AOM_ICDF(31662), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6016), AOM_ICDF(8316), AOM_ICDF(10849), AOM_ICDF(12136),
              AOM_ICDF(15860), AOM_ICDF(16430), AOM_ICDF(17935),
              AOM_ICDF(19659), AOM_ICDF(21083), AOM_ICDF(26968),
              AOM_ICDF(28839), AOM_ICDF(31618), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(3840), AOM_ICDF(7472), AOM_ICDF(9436), AOM_ICDF(11038),
              AOM_ICDF(13625), AOM_ICDF(17596), AOM_ICDF(18959),
              AOM_ICDF(20543), AOM_ICDF(22879), AOM_ICDF(27487),
              AOM_ICDF(29351), AOM_ICDF(31186), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(5376), AOM_ICDF(7117), AOM_ICDF(11424), AOM_ICDF(12381),
              AOM_ICDF(14823), AOM_ICDF(15053), AOM_ICDF(18656),
              AOM_ICDF(20818), AOM_ICDF(21722), AOM_ICDF(27042),
              AOM_ICDF(28233), AOM_ICDF(31591), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(5760), AOM_ICDF(7281), AOM_ICDF(11910), AOM_ICDF(12912),
              AOM_ICDF(14229), AOM_ICDF(14391), AOM_ICDF(15474),
              AOM_ICDF(20113), AOM_ICDF(21128), AOM_ICDF(26627),
              AOM_ICDF(28077), AOM_ICDF(31713), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6656), AOM_ICDF(9452), AOM_ICDF(11526), AOM_ICDF(13288),
              AOM_ICDF(14861), AOM_ICDF(15062), AOM_ICDF(15909),
              AOM_ICDF(17695), AOM_ICDF(20429), AOM_ICDF(26225),
              AOM_ICDF(28603), AOM_ICDF(31340), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(5376), AOM_ICDF(7722), AOM_ICDF(10921), AOM_ICDF(11813),
              AOM_ICDF(13222), AOM_ICDF(13348), AOM_ICDF(14211),
              AOM_ICDF(15976), AOM_ICDF(17110), AOM_ICDF(24634),
              AOM_ICDF(27176), AOM_ICDF(31484), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(4736), AOM_ICDF(8226), AOM_ICDF(11137), AOM_ICDF(11988),
              AOM_ICDF(13518), AOM_ICDF(13706), AOM_ICDF(14332),
              AOM_ICDF(16016), AOM_ICDF(17301), AOM_ICDF(24641),
              AOM_ICDF(27704), AOM_ICDF(31016), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(5760), AOM_ICDF(7592), AOM_ICDF(11880), AOM_ICDF(12612),
              AOM_ICDF(13738), AOM_ICDF(13813), AOM_ICDF(14681),
              AOM_ICDF(16392), AOM_ICDF(17306), AOM_ICDF(24619),
              AOM_ICDF(26334), AOM_ICDF(31818), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(4096), AOM_ICDF(8524), AOM_ICDF(14316), AOM_ICDF(15392),
              AOM_ICDF(16295), AOM_ICDF(16433), AOM_ICDF(17197),
              AOM_ICDF(18718), AOM_ICDF(19924), AOM_ICDF(25123),
              AOM_ICDF(26953), AOM_ICDF(29856), AOM_ICDF(32768), 0,
          },
      },
      {
          {
              AOM_ICDF(6528), AOM_ICDF(13383), AOM_ICDF(17642), AOM_ICDF(18342),
              AOM_ICDF(19224), AOM_ICDF(20209), AOM_ICDF(20899),
              AOM_ICDF(21944), AOM_ICDF(23137), AOM_ICDF(25966),
              AOM_ICDF(27429), AOM_ICDF(28463), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(4480), AOM_ICDF(16901), AOM_ICDF(18876), AOM_ICDF(19560),
              AOM_ICDF(20257), AOM_ICDF(20912), AOM_ICDF(21169),
              AOM_ICDF(21959), AOM_ICDF(23036), AOM_ICDF(25781),
              AOM_ICDF(27676), AOM_ICDF(28569), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(2688), AOM_ICDF(5337), AOM_ICDF(18178), AOM_ICDF(18829),
              AOM_ICDF(19344), AOM_ICDF(19628), AOM_ICDF(20267),
              AOM_ICDF(22135), AOM_ICDF(22671), AOM_ICDF(25817),
              AOM_ICDF(26914), AOM_ICDF(28773), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(8192), AOM_ICDF(11378), AOM_ICDF(14742), AOM_ICDF(17269),
              AOM_ICDF(18230), AOM_ICDF(19001), AOM_ICDF(19655),
              AOM_ICDF(22949), AOM_ICDF(24337), AOM_ICDF(28025),
              AOM_ICDF(29503), AOM_ICDF(30848), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(5120), AOM_ICDF(10133), AOM_ICDF(13144), AOM_ICDF(14374),
              AOM_ICDF(17020), AOM_ICDF(18920), AOM_ICDF(20235),
              AOM_ICDF(21677), AOM_ICDF(23142), AOM_ICDF(27131),
              AOM_ICDF(28671), AOM_ICDF(30284), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(7424), AOM_ICDF(15588), AOM_ICDF(18431), AOM_ICDF(19723),
              AOM_ICDF(21455), AOM_ICDF(24705), AOM_ICDF(25461),
              AOM_ICDF(26753), AOM_ICDF(28923), AOM_ICDF(29475),
              AOM_ICDF(29729), AOM_ICDF(29897), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(4224), AOM_ICDF(8689), AOM_ICDF(13024), AOM_ICDF(13658),
              AOM_ICDF(16637), AOM_ICDF(17307), AOM_ICDF(20836),
              AOM_ICDF(22665), AOM_ICDF(23673), AOM_ICDF(27015),
              AOM_ICDF(28310), AOM_ICDF(30203), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(5120), AOM_ICDF(7896), AOM_ICDF(13618), AOM_ICDF(14900),
              AOM_ICDF(15708), AOM_ICDF(16153), AOM_ICDF(16997),
              AOM_ICDF(23625), AOM_ICDF(24466), AOM_ICDF(27719),
              AOM_ICDF(28892), AOM_ICDF(30500), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(5760), AOM_ICDF(11305), AOM_ICDF(13669), AOM_ICDF(15462),
              AOM_ICDF(16564), AOM_ICDF(17683), AOM_ICDF(18252),
              AOM_ICDF(20073), AOM_ICDF(22917), AOM_ICDF(27005),
              AOM_ICDF(28923), AOM_ICDF(30236), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(4224), AOM_ICDF(9510), AOM_ICDF(13787), AOM_ICDF(14587),
              AOM_ICDF(15753), AOM_ICDF(15925), AOM_ICDF(16513),
              AOM_ICDF(18193), AOM_ICDF(19490), AOM_ICDF(24944),
              AOM_ICDF(27482), AOM_ICDF(29757), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(3840), AOM_ICDF(10052), AOM_ICDF(14106), AOM_ICDF(14887),
              AOM_ICDF(15827), AOM_ICDF(15996), AOM_ICDF(16522),
              AOM_ICDF(17939), AOM_ICDF(19204), AOM_ICDF(24508),
              AOM_ICDF(27661), AOM_ICDF(29491), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(4736), AOM_ICDF(9676), AOM_ICDF(14492), AOM_ICDF(15163),
              AOM_ICDF(16179), AOM_ICDF(16390), AOM_ICDF(17133),
              AOM_ICDF(18905), AOM_ICDF(19864), AOM_ICDF(25185),
              AOM_ICDF(27191), AOM_ICDF(30030), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(3584), AOM_ICDF(9370), AOM_ICDF(14746), AOM_ICDF(15820),
              AOM_ICDF(16708), AOM_ICDF(17224), AOM_ICDF(17718),
              AOM_ICDF(19329), AOM_ICDF(20405), AOM_ICDF(23541),
              AOM_ICDF(25258), AOM_ICDF(26726), AOM_ICDF(32768), 0,
          },
      },
#endif
#else
      {
          {
              AOM_ICDF(15488), AOM_ICDF(18706), AOM_ICDF(22561),
              AOM_ICDF(23619), AOM_ICDF(24954), AOM_ICDF(25782),
              AOM_ICDF(26710), AOM_ICDF(27861), AOM_ICDF(28656),
              AOM_ICDF(30743), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(11648), AOM_ICDF(18744), AOM_ICDF(20846),
              AOM_ICDF(22100), AOM_ICDF(23332), AOM_ICDF(24337),
              AOM_ICDF(25093), AOM_ICDF(26104), AOM_ICDF(27097),
              AOM_ICDF(29633), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(8448), AOM_ICDF(10732), AOM_ICDF(22507), AOM_ICDF(23254),
              AOM_ICDF(24382), AOM_ICDF(24876), AOM_ICDF(25827),
              AOM_ICDF(27488), AOM_ICDF(28040), AOM_ICDF(30108),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(13568), AOM_ICDF(16981), AOM_ICDF(19885),
              AOM_ICDF(22014), AOM_ICDF(23543), AOM_ICDF(24658),
              AOM_ICDF(25641), AOM_ICDF(27378), AOM_ICDF(28625),
              AOM_ICDF(31043), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(9600), AOM_ICDF(12225), AOM_ICDF(14408), AOM_ICDF(16033),
              AOM_ICDF(19544), AOM_ICDF(22318), AOM_ICDF(23960),
              AOM_ICDF(25617), AOM_ICDF(26522), AOM_ICDF(30596),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(12160), AOM_ICDF(15078), AOM_ICDF(16990),
              AOM_ICDF(18964), AOM_ICDF(22725), AOM_ICDF(25793),
              AOM_ICDF(27133), AOM_ICDF(28447), AOM_ICDF(30831),
              AOM_ICDF(30836), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(9088), AOM_ICDF(11274), AOM_ICDF(15818), AOM_ICDF(16940),
              AOM_ICDF(21178), AOM_ICDF(22338), AOM_ICDF(26171),
              AOM_ICDF(27754), AOM_ICDF(28503), AOM_ICDF(31473),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(10880), AOM_ICDF(13846), AOM_ICDF(18649),
              AOM_ICDF(20252), AOM_ICDF(22157), AOM_ICDF(22992),
              AOM_ICDF(24396), AOM_ICDF(27581), AOM_ICDF(28501),
              AOM_ICDF(31400), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(11008), AOM_ICDF(13462), AOM_ICDF(15747),
              AOM_ICDF(18378), AOM_ICDF(20085), AOM_ICDF(21663),
              AOM_ICDF(22766), AOM_ICDF(24635), AOM_ICDF(27476),
              AOM_ICDF(30643), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(10112), AOM_ICDF(13147), AOM_ICDF(16135),
              AOM_ICDF(17577), AOM_ICDF(19681), AOM_ICDF(19689),
              AOM_ICDF(20856), AOM_ICDF(22374), AOM_ICDF(24454),
              AOM_ICDF(30555), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(8704), AOM_ICDF(12176), AOM_ICDF(17582), AOM_ICDF(18905),
              AOM_ICDF(19994), AOM_ICDF(20669), AOM_ICDF(21635),
              AOM_ICDF(23564), AOM_ICDF(24741), AOM_ICDF(27222),
              AOM_ICDF(32768), 0,
          },
      },
      {
          {
              ...
              AOM_ICDF(23358), AOM_ICDF(24675), AOM_ICDF(25193),
              AOM_ICDF(26119), AOM_ICDF(27310), AOM_ICDF(30773),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6656), AOM_ICDF(22027), AOM_ICDF(23242), AOM_ICDF(23986),
              AOM_ICDF(24529), AOM_ICDF(25363), AOM_ICDF(25646),
              AOM_ICDF(26087), AOM_ICDF(27130), AOM_ICDF(30218),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(7168), AOM_ICDF(13862), AOM_ICDF(21137), AOM_ICDF(22124),
              AOM_ICDF(23036), AOM_ICDF(23803), AOM_ICDF(24458),
              AOM_ICDF(26390), AOM_ICDF(27342), AOM_ICDF(30968),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(9600), AOM_ICDF(17409), AOM_ICDF(19830), AOM_ICDF(21521),
              AOM_ICDF(22580), AOM_ICDF(23726), AOM_ICDF(24377),
              AOM_ICDF(25679), AOM_ICDF(27269), AOM_ICDF(30867),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6912), AOM_ICDF(15832), AOM_ICDF(17559), AOM_ICDF(18777),
              AOM_ICDF(20425), AOM_ICDF(22719), AOM_ICDF(23447),
              AOM_ICDF(24952), AOM_ICDF(26527), AOM_ICDF(30950),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(7808), AOM_ICDF(18730), AOM_ICDF(20143), AOM_ICDF(21445),
              AOM_ICDF(23347), AOM_ICDF(26267), AOM_ICDF(27229),
              AOM_ICDF(28315), AOM_ICDF(30911), AOM_ICDF(30915),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6784), AOM_ICDF(14299), AOM_ICDF(17264), AOM_ICDF(18505),
              AOM_ICDF(20765), AOM_ICDF(22440), AOM_ICDF(24331),
              AOM_ICDF(26038), AOM_ICDF(27481), AOM_ICDF(31448),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(8832), AOM_ICDF(15726), AOM_ICDF(19455), AOM_ICDF(20668),
              AOM_ICDF(21607), AOM_ICDF(22655), AOM_ICDF(23384),
              AOM_ICDF(26356), AOM_ICDF(27697), AOM_ICDF(31459),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(8192), AOM_ICDF(17385), AOM_ICDF(18866), AOM_ICDF(20120),
              AOM_ICDF(21273), AOM_ICDF(22853), AOM_ICDF(23470),
              AOM_ICDF(24881), AOM_ICDF(27216), AOM_ICDF(31040),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6656), AOM_ICDF(16341), AOM_ICDF(18497), AOM_ICDF(19439),
              AOM_ICDF(20706), AOM_ICDF(20711), AOM_ICDF(21234),
              AOM_ICDF(22307), AOM_ICDF(23950), AOM_ICDF(30728),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6400), AOM_ICDF(17625), AOM_ICDF(20326), AOM_ICDF(21821),
              AOM_ICDF(22568), AOM_ICDF(23415), AOM_ICDF(23854),
              AOM_ICDF(24896), AOM_ICDF(26171), AOM_ICDF(29575),
              AOM_ICDF(32768), 0,
          },
      },
      {
          {
              AOM_ICDF(12032), AOM_ICDF(14259), AOM_ICDF(22597),
              AOM_ICDF(23443), AOM_ICDF(24581), AOM_ICDF(25079),
              AOM_ICDF(26399), AOM_ICDF(27862), AOM_ICDF(28509),
              AOM_ICDF(30419), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(9216), AOM_ICDF(14883), AOM_ICDF(20941), AOM_ICDF(21958),
              AOM_ICDF(23597), AOM_ICDF(24328), AOM_ICDF(25208),
              AOM_ICDF(26590), AOM_ICDF(27377), AOM_ICDF(29364),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6784), AOM_ICDF(8088), AOM_ICDF(24407), AOM_ICDF(25006),
              AOM_ICDF(25777), AOM_ICDF(25950), AOM_ICDF(26882),
              AOM_ICDF(28811), AOM_ICDF(29159), AOM_ICDF(30636),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(11904), AOM_ICDF(14425), AOM_ICDF(18729),
              AOM_ICDF(20730), AOM_ICDF(21998), AOM_ICDF(22686),
              AOM_ICDF(23856), AOM_ICDF(26580), AOM_ICDF(27613),
              AOM_ICDF(29834), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(10752), AOM_ICDF(12784), AOM_ICDF(16305),
              AOM_ICDF(17624), AOM_ICDF(20320), AOM_ICDF(22450),
              AOM_ICDF(24380), AOM_ICDF(26773), AOM_ICDF(27837),
              AOM_ICDF(30016), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(10496), AOM_ICDF(14090), AOM_ICDF(18314),
              AOM_ICDF(20621), AOM_ICDF(23539), AOM_ICDF(25261),
              AOM_ICDF(26953), AOM_ICDF(28692), AOM_ICDF(30064),
              AOM_ICDF(30071), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(8448), AOM_ICDF(10229), AOM_ICDF(16542), AOM_ICDF(17725),
              AOM_ICDF(21504), AOM_ICDF(22332), AOM_ICDF(26006),
              AOM_ICDF(27895), AOM_ICDF(28487), AOM_ICDF(31248),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(9728), AOM_ICDF(11162), AOM_ICDF(19379), AOM_ICDF(20981),
              AOM_ICDF(22356), AOM_ICDF(22926), AOM_ICDF(24318),
              AOM_ICDF(28364), AOM_ICDF(29020), AOM_ICDF(31328),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(9216), AOM_ICDF(10861), AOM_ICDF(14850), AOM_ICDF(16471),
              AOM_ICDF(18611), AOM_ICDF(19674), AOM_ICDF(21009),
              AOM_ICDF(23454), AOM_ICDF(26078), AOM_ICDF(29272),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(7808), AOM_ICDF(10132), AOM_ICDF(17327), AOM_ICDF(18472),
              AOM_ICDF(20126), AOM_ICDF(20132), AOM_ICDF(21599),
              AOM_ICDF(23338), AOM_ICDF(24514), AOM_ICDF(29843),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6784), AOM_ICDF(9210), AOM_ICDF(19309), AOM_ICDF(20715),
              AOM_ICDF(21833), AOM_ICDF(22262), AOM_ICDF(23353),
              AOM_ICDF(24942), AOM_ICDF(25800), AOM_ICDF(28200),
              AOM_ICDF(32768), 0,
          },
      },
      {
          {
              AOM_ICDF(12288), AOM_ICDF(15040), AOM_ICDF(18401),
              AOM_ICDF(21071), AOM_ICDF(22800), AOM_ICDF(23945),
              AOM_ICDF(25274), AOM_ICDF(26939), AOM_ICDF(28554),
              AOM_ICDF(31328), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(9344), AOM_ICDF(17170), AOM_ICDF(19325), AOM_ICDF(22119),
              AOM_ICDF(23284), AOM_ICDF(24378), AOM_ICDF(24911),
              AOM_ICDF(26095), AOM_ICDF(27781), AOM_ICDF(31121),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(9344), AOM_ICDF(11650), AOM_ICDF(19788), AOM_ICDF(21928),
              AOM_ICDF(22916), AOM_ICDF(23571), AOM_ICDF(24362),
              AOM_ICDF(26633), AOM_ICDF(27946), AOM_ICDF(31212),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(12928), AOM_ICDF(14428), AOM_ICDF(17080),
              AOM_ICDF(20882), AOM_ICDF(22104), AOM_ICDF(23149),
              AOM_ICDF(23715), AOM_ICDF(27167), AOM_ICDF(28932),
              AOM_ICDF(31218), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(9088), AOM_ICDF(11962), AOM_ICDF(13849), AOM_ICDF(16880),
              AOM_ICDF(19818), AOM_ICDF(21895), AOM_ICDF(23000),
              AOM_ICDF(25923), AOM_ICDF(27961), AOM_ICDF(31380),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(10240), AOM_ICDF(13336), AOM_ICDF(15505),
              AOM_ICDF(18844), AOM_ICDF(21646), AOM_ICDF(24723),
              AOM_ICDF(25832), AOM_ICDF(27802), AOM_ICDF(31088),
              AOM_ICDF(31096), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(8704), AOM_ICDF(10683), AOM_ICDF(14446), AOM_ICDF(17035),
              AOM_ICDF(20211), AOM_ICDF(21577), AOM_ICDF(24370),
              AOM_ICDF(26477), AOM_ICDF(28223), AOM_ICDF(31734),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(12928), AOM_ICDF(17358), AOM_ICDF(19982),
              AOM_ICDF(22123), AOM_ICDF(23335), AOM_ICDF(23948),
              AOM_ICDF(24890), AOM_ICDF(28884), AOM_ICDF(30197),
              AOM_ICDF(32148), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(10496), AOM_ICDF(12429), AOM_ICDF(16401),
              AOM_ICDF(20493), AOM_ICDF(21471), AOM_ICDF(22433),
              AOM_ICDF(23162), AOM_ICDF(24686), AOM_ICDF(29027),
              AOM_ICDF(31115), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(8448), AOM_ICDF(12157), AOM_ICDF(14796), AOM_ICDF(17676),
              AOM_ICDF(19754), AOM_ICDF(19762), AOM_ICDF(20641),
              AOM_ICDF(23274), AOM_ICDF(25569), AOM_ICDF(31058),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(7296), AOM_ICDF(11083), AOM_ICDF(15313), AOM_ICDF(20550),
              AOM_ICDF(21783), AOM_ICDF(22727), AOM_ICDF(23461),
              AOM_ICDF(25072), AOM_ICDF(27195), AOM_ICDF(30380),
              AOM_ICDF(32768), 0,
          },
      },
      {
          {
              AOM_ICDF(10880), AOM_ICDF(13214), AOM_ICDF(15829),
              AOM_ICDF(16866), AOM_ICDF(20613), AOM_ICDF(22316),
              AOM_ICDF(24539), AOM_ICDF(27077), AOM_ICDF(28116),
              AOM_ICDF(31485), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(9984), AOM_ICDF(13868), AOM_ICDF(16397), AOM_ICDF(17486),
              AOM_ICDF(20011), AOM_ICDF(22071), AOM_ICDF(23357),
              AOM_ICDF(24990), AOM_ICDF(26336), AOM_ICDF(30276),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(7168), AOM_ICDF(8637), AOM_ICDF(17963), AOM_ICDF(18813),
              AOM_ICDF(21065), AOM_ICDF(22052), AOM_ICDF(23502),
              AOM_ICDF(25702), AOM_ICDF(26745), AOM_ICDF(30668),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(8960), AOM_ICDF(10682), AOM_ICDF(12496), AOM_ICDF(18240),
              AOM_ICDF(20500), AOM_ICDF(21585), AOM_ICDF(23387),
              AOM_ICDF(25795), AOM_ICDF(27119), AOM_ICDF(31001),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(9856), AOM_ICDF(12056), AOM_ICDF(13722), AOM_ICDF(15196),
              AOM_ICDF(19276), AOM_ICDF(21891), AOM_ICDF(23643),
              AOM_ICDF(25538), AOM_ICDF(26854), AOM_ICDF(31515),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(9984), AOM_ICDF(12963), AOM_ICDF(14960), AOM_ICDF(16734),
              AOM_ICDF(21279), AOM_ICDF(25616), AOM_ICDF(27638),
              AOM_ICDF(28950), AOM_ICDF(31161), AOM_ICDF(31166),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(7168), AOM_ICDF(8604), AOM_ICDF(12044), AOM_ICDF(13632),
              AOM_ICDF(18931), AOM_ICDF(20553), AOM_ICDF(23452),
              AOM_ICDF(25800), AOM_ICDF(27754), AOM_ICDF(31668),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(11520), AOM_ICDF(13372), AOM_ICDF(16642),
              AOM_ICDF(18137), AOM_ICDF(20232), AOM_ICDF(21510),
              AOM_ICDF(23052), AOM_ICDF(26792), AOM_ICDF(27974),
              AOM_ICDF(31274), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(10240), AOM_ICDF(12483), AOM_ICDF(14364),
              AOM_ICDF(16168), AOM_ICDF(18668), AOM_ICDF(20707),
              AOM_ICDF(22158), AOM_ICDF(24410), AOM_ICDF(26370),
              AOM_ICDF(30744), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(8064), AOM_ICDF(10798), AOM_ICDF(13829), AOM_ICDF(15128),
              AOM_ICDF(19136), AOM_ICDF(19152), AOM_ICDF(21057),
              AOM_ICDF(22583), AOM_ICDF(24513), AOM_ICDF(30645),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(8448), AOM_ICDF(11025), AOM_ICDF(16073), AOM_ICDF(17603),
              AOM_ICDF(20094), AOM_ICDF(21468), AOM_ICDF(22971),
              AOM_ICDF(24628), AOM_ICDF(26015), AOM_ICDF(29728),
              AOM_ICDF(32768), 0,
          },
      },
      {
          {
              AOM_ICDF(10368), AOM_ICDF(15372), AOM_ICDF(18442),
              AOM_ICDF(19576), AOM_ICDF(22674), AOM_ICDF(27128),
              AOM_ICDF(28232), AOM_ICDF(29624), AOM_ICDF(31363),
              AOM_ICDF(31368), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(9472), AOM_ICDF(16687), AOM_ICDF(18957), AOM_ICDF(20272),
              AOM_ICDF(22852), AOM_ICDF(27082), AOM_ICDF(27839),
              AOM_ICDF(28995), AOM_ICDF(30943), AOM_ICDF(30948),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(8064), AOM_ICDF(12334), AOM_ICDF(19197), AOM_ICDF(20956),
              AOM_ICDF(24804), AOM_ICDF(26553), AOM_ICDF(27556),
              AOM_ICDF(29877), AOM_ICDF(31311), AOM_ICDF(31320),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(8960), AOM_ICDF(14083), AOM_ICDF(16058), AOM_ICDF(19129),
              AOM_ICDF(21136), AOM_ICDF(23635), AOM_ICDF(24870),
              AOM_ICDF(27577), AOM_ICDF(31176), AOM_ICDF(31187),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(9984), AOM_ICDF(14208), AOM_ICDF(15589), AOM_ICDF(17640),
              AOM_ICDF(22080), AOM_ICDF(26660), AOM_ICDF(27947),
              AOM_ICDF(29400), AOM_ICDF(31605), AOM_ICDF(31611),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(9216), AOM_ICDF(15167), AOM_ICDF(16263), AOM_ICDF(17767),
              AOM_ICDF(21531), AOM_ICDF(26689), AOM_ICDF(27607),
              AOM_ICDF(28880), AOM_ICDF(31291), AOM_ICDF(31296),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(8448), AOM_ICDF(12756), AOM_ICDF(15781), AOM_ICDF(17279),
              AOM_ICDF(21198), AOM_ICDF(24057), AOM_ICDF(26171),
              AOM_ICDF(29200), AOM_ICDF(31901), AOM_ICDF(31913),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(9984), AOM_ICDF(15074), AOM_ICDF(18244), AOM_ICDF(19878),
              AOM_ICDF(22246), AOM_ICDF(24436), AOM_ICDF(25560),
              AOM_ICDF(28991), AOM_ICDF(31687), AOM_ICDF(31700),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(10496), AOM_ICDF(15128), AOM_ICDF(17012),
              AOM_ICDF(18989), AOM_ICDF(21294), AOM_ICDF(25011),
              AOM_ICDF(25999), AOM_ICDF(27784), AOM_ICDF(30934),
              AOM_ICDF(30941), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(2944), AOM_ICDF(5875), AOM_ICDF(8846), AOM_ICDF(11817),
              AOM_ICDF(14806), AOM_ICDF(17795), AOM_ICDF(20769),
              AOM_ICDF(23761), AOM_ICDF(26747), AOM_ICDF(29739),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(7424), AOM_ICDF(12915), AOM_ICDF(17544), AOM_ICDF(19392),
              AOM_ICDF(23074), AOM_ICDF(25635), AOM_ICDF(26431),
              AOM_ICDF(28241), AOM_ICDF(30088), AOM_ICDF(30095),
              AOM_ICDF(32768), 0,
          },
      },
      {
          {
              AOM_ICDF(11648), AOM_ICDF(13565), AOM_ICDF(18996),
              AOM_ICDF(19908), AOM_ICDF(21897), AOM_ICDF(22852),
              AOM_ICDF(26656), AOM_ICDF(28172), AOM_ICDF(28995),
              AOM_ICDF(31283), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(10240), AOM_ICDF(14255), AOM_ICDF(18109),
              AOM_ICDF(19716), AOM_ICDF(21521), AOM_ICDF(22859),
              AOM_ICDF(24613), AOM_ICDF(26161), AOM_ICDF(27279),
              AOM_ICDF(30392), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6784), AOM_ICDF(7848), AOM_ICDF(18820), AOM_ICDF(19447),
              AOM_ICDF(22335), AOM_ICDF(22733), AOM_ICDF(25112),
              AOM_ICDF(28427), AOM_ICDF(29013), AOM_ICDF(31550),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(11904), AOM_ICDF(13581), AOM_ICDF(17695),
              AOM_ICDF(19311), AOM_ICDF(21698), AOM_ICDF(22562),
              AOM_ICDF(24391), AOM_ICDF(26559), AOM_ICDF(27779),
              AOM_ICDF(30567), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(10624), AOM_ICDF(12334), AOM_ICDF(14643),
              AOM_ICDF(16255), AOM_ICDF(20783), AOM_ICDF(22767),
              AOM_ICDF(24929), AOM_ICDF(26876), AOM_ICDF(27998),
              AOM_ICDF(31470), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(12032), AOM_ICDF(14415), AOM_ICDF(16715),
              AOM_ICDF(18712), AOM_ICDF(21557), AOM_ICDF(25332),
              AOM_ICDF(27840), AOM_ICDF(29663), AOM_ICDF(31708),
              AOM_ICDF(31715), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(9728), AOM_ICDF(10683), AOM_ICDF(13955), AOM_ICDF(14786),
              AOM_ICDF(18481), AOM_ICDF(19492), AOM_ICDF(26749),
              AOM_ICDF(28483), AOM_ICDF(29116), AOM_ICDF(31958),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(8960), AOM_ICDF(10032), AOM_ICDF(15755), AOM_ICDF(16949),
              AOM_ICDF(19144), AOM_ICDF(19744), AOM_ICDF(22082),
              AOM_ICDF(27608), AOM_ICDF(28411), AOM_ICDF(31838),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(14592), AOM_ICDF(15937), AOM_ICDF(18518),
              AOM_ICDF(19566), AOM_ICDF(21817), AOM_ICDF(23102),
              AOM_ICDF(24436), AOM_ICDF(26651), AOM_ICDF(28100),
              AOM_ICDF(30993), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(8960), AOM_ICDF(10791), AOM_ICDF(14718), AOM_ICDF(16094),
              AOM_ICDF(18560), AOM_ICDF(18570), AOM_ICDF(22120),
              AOM_ICDF(24188), AOM_ICDF(25677), AOM_ICDF(31280),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(11136), AOM_ICDF(13058), AOM_ICDF(19006),
              AOM_ICDF(20135), AOM_ICDF(21463), AOM_ICDF(22159),
              AOM_ICDF(24042), AOM_ICDF(26348), AOM_ICDF(27367),
              AOM_ICDF(30064), AOM_ICDF(32768), 0,
          },
      },
      {
          {
              AOM_ICDF(12544), AOM_ICDF(15384), AOM_ICDF(20327),
              AOM_ICDF(21555), AOM_ICDF(23456), AOM_ICDF(24144),
              AOM_ICDF(25421), AOM_ICDF(27884), AOM_ICDF(28875),
              AOM_ICDF(31188), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(10368), AOM_ICDF(15009), AOM_ICDF(17631),
              AOM_ICDF(18970), AOM_ICDF(20691), AOM_ICDF(21850),
              AOM_ICDF(22749), AOM_ICDF(25280), AOM_ICDF(26570),
              AOM_ICDF(29530), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(9088), AOM_ICDF(10956), AOM_ICDF(21554), AOM_ICDF(22698),
              AOM_ICDF(23666), AOM_ICDF(24052), AOM_ICDF(25122),
              AOM_ICDF(27792), AOM_ICDF(28612), AOM_ICDF(30825),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(11520), AOM_ICDF(12888), AOM_ICDF(16374),
              AOM_ICDF(19132), AOM_ICDF(21186), AOM_ICDF(21843),
              AOM_ICDF(22902), AOM_ICDF(26440), AOM_ICDF(27928),
              AOM_ICDF(29946), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(9984), AOM_ICDF(12199), AOM_ICDF(14625), AOM_ICDF(17321),
              AOM_ICDF(20195), AOM_ICDF(21574), AOM_ICDF(23010),
              AOM_ICDF(25688), AOM_ICDF(27600), AOM_ICDF(30988),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(10112), AOM_ICDF(13705), AOM_ICDF(16847),
              AOM_ICDF(19242), AOM_ICDF(22011), AOM_ICDF(24064),
              AOM_ICDF(26481), AOM_ICDF(29125), AOM_ICDF(30545),
              AOM_ICDF(30555), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(9344), AOM_ICDF(10994), AOM_ICDF(15018), AOM_ICDF(16915),
              AOM_ICDF(20471), AOM_ICDF(21334), AOM_ICDF(24577),
              AOM_ICDF(27472), AOM_ICDF(28592), AOM_ICDF(31578),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(12928), AOM_ICDF(14540), AOM_ICDF(18022),
              AOM_ICDF(19481), AOM_ICDF(21028), AOM_ICDF(21825),
              AOM_ICDF(22728), AOM_ICDF(28191), AOM_ICDF(29154),
              AOM_ICDF(31683), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(10368), AOM_ICDF(12160), AOM_ICDF(14900),
              AOM_ICDF(17161), AOM_ICDF(19379), AOM_ICDF(20521),
              AOM_ICDF(21747), AOM_ICDF(24534), AOM_ICDF(26677),
              AOM_ICDF(30318), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(8960), AOM_ICDF(11488), AOM_ICDF(16197), AOM_ICDF(18030),
              AOM_ICDF(20010), AOM_ICDF(20018), AOM_ICDF(21347),
              AOM_ICDF(23948), AOM_ICDF(25016), AOM_ICDF(30536),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(7808), AOM_ICDF(10310), AOM_ICDF(15420), AOM_ICDF(18961),
              AOM_ICDF(20114), AOM_ICDF(20772), AOM_ICDF(21721),
              AOM_ICDF(24599), AOM_ICDF(26237), AOM_ICDF(29160),
              AOM_ICDF(32768), 0,
          },
      },
      {
          {
              ...
              AOM_ICDF(20802), AOM_ICDF(22302), AOM_ICDF(23113),
              AOM_ICDF(24519), AOM_ICDF(27717), AOM_ICDF(31604),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(8704), AOM_ICDF(15725), AOM_ICDF(17309), AOM_ICDF(20296),
              AOM_ICDF(21257), AOM_ICDF(22573), AOM_ICDF(23165),
              AOM_ICDF(23893), AOM_ICDF(27755), AOM_ICDF(31170),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(7936), AOM_ICDF(11343), AOM_ICDF(19355), AOM_ICDF(21223),
              AOM_ICDF(22121), AOM_ICDF(22978), AOM_ICDF(23703),
              AOM_ICDF(26079), AOM_ICDF(27978), AOM_ICDF(31507),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(11264), AOM_ICDF(14823), AOM_ICDF(17314),
              AOM_ICDF(20715), AOM_ICDF(21999), AOM_ICDF(22982),
              AOM_ICDF(23728), AOM_ICDF(25229), AOM_ICDF(28593),
              AOM_ICDF(31508), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(8704), AOM_ICDF(11788), AOM_ICDF(13666), AOM_ICDF(16523),
              AOM_ICDF(18630), AOM_ICDF(20579), AOM_ICDF(21574),
              AOM_ICDF(23335), AOM_ICDF(26298), AOM_ICDF(31264),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(9088), AOM_ICDF(14031), AOM_ICDF(15766), AOM_ICDF(18533),
              AOM_ICDF(21457), AOM_ICDF(24078), AOM_ICDF(24973),
              AOM_ICDF(26102), AOM_ICDF(31284), AOM_ICDF(31288),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(7040), AOM_ICDF(9648), AOM_ICDF(12140), AOM_ICDF(14601),
              AOM_ICDF(16742), AOM_ICDF(18070), AOM_ICDF(21154),
              AOM_ICDF(23582), AOM_ICDF(27647), AOM_ICDF(31763),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(10240), AOM_ICDF(13466), AOM_ICDF(16837),
              AOM_ICDF(19351), AOM_ICDF(20636), AOM_ICDF(21620),
              AOM_ICDF(22474), AOM_ICDF(25815), AOM_ICDF(28364),
              AOM_ICDF(31976), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(11008), AOM_ICDF(13682), AOM_ICDF(15127),
              AOM_ICDF(18779), AOM_ICDF(19841), AOM_ICDF(20792),
              AOM_ICDF(21954), AOM_ICDF(23365), AOM_ICDF(29100),
              AOM_ICDF(31748), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(7168), AOM_ICDF(12260), AOM_ICDF(15037), AOM_ICDF(17152),
              AOM_ICDF(18730), AOM_ICDF(18736), AOM_ICDF(19436),
              AOM_ICDF(20484), AOM_ICDF(24465), AOM_ICDF(30868),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6784), AOM_ICDF(12469), AOM_ICDF(15422), AOM_ICDF(19291),
              AOM_ICDF(20301), AOM_ICDF(21344), AOM_ICDF(21894),
              AOM_ICDF(23415), AOM_ICDF(27696), AOM_ICDF(31042),
              AOM_ICDF(32768), 0,
          },
      },
      {
          {
              AOM_ICDF(10112), AOM_ICDF(13929), AOM_ICDF(17880),
              AOM_ICDF(18857), AOM_ICDF(20955), AOM_ICDF(20963),
              AOM_ICDF(21974), AOM_ICDF(23273), AOM_ICDF(24734),
              AOM_ICDF(31352), AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(8064), AOM_ICDF(15826), AOM_ICDF(17929), AOM_ICDF(19017),
              AOM_ICDF(21016), AOM_ICDF(21024), AOM_ICDF(21687),
              AOM_ICDF(22701), AOM_ICDF(24242), AOM_ICDF(30645),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6528), AOM_ICDF(9196), AOM_ICDF(20118), AOM_ICDF(21101),
              AOM_ICDF(22227), AOM_ICDF(22231), AOM_ICDF(22997),
              AOM_ICDF(25070), AOM_ICDF(25919), AOM_ICDF(30923),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(9600), AOM_ICDF(13218), AOM_ICDF(15898), AOM_ICDF(17780),
              AOM_ICDF(19991), AOM_ICDF(20000), AOM_ICDF(21196),
              AOM_ICDF(23912), AOM_ICDF(26044), AOM_ICDF(31139),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(8960), AOM_ICDF(12037), AOM_ICDF(14178), AOM_ICDF(15681),
              AOM_ICDF(20126), AOM_ICDF(20143), AOM_ICDF(21435),
              AOM_ICDF(23083), AOM_ICDF(24675), AOM_ICDF(31466),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(2944), AOM_ICDF(5875), AOM_ICDF(8846), AOM_ICDF(11817),
          ...
          },
          {
              ...
              AOM_ICDF(19972), AOM_ICDF(19984), AOM_ICDF(22292),
              AOM_ICDF(24384), AOM_ICDF(25891), AOM_ICDF(31676),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(8448), AOM_ICDF(11176), AOM_ICDF(15497), AOM_ICDF(16676),
              AOM_ICDF(18528), AOM_ICDF(18535), AOM_ICDF(19595),
              AOM_ICDF(24334), AOM_ICDF(25725), AOM_ICDF(31723),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(8704), AOM_ICDF(12141), AOM_ICDF(14313), AOM_ICDF(15828),
              AOM_ICDF(18358), AOM_ICDF(18368), AOM_ICDF(19469),
              AOM_ICDF(21089), AOM_ICDF(24027), AOM_ICDF(30700),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(7680), AOM_ICDF(11689), AOM_ICDF(14556), AOM_ICDF(15548),
              AOM_ICDF(17878), AOM_ICDF(17887), AOM_ICDF(18873),
              AOM_ICDF(20512), AOM_ICDF(22152), AOM_ICDF(31004),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6656), AOM_ICDF(11476), AOM_ICDF(16600), AOM_ICDF(18052),
              AOM_ICDF(19683), AOM_ICDF(19689), AOM_ICDF(20509),
              AOM_ICDF(22077), AOM_ICDF(23496), AOM_ICDF(29504),
              AOM_ICDF(32768), 0,
          },
      },
      {
          {
              ...
              AOM_ICDF(21680), AOM_ICDF(22479), AOM_ICDF(23516),
              AOM_ICDF(24952), AOM_ICDF(26183), AOM_ICDF(28538),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(8832), AOM_ICDF(18693), AOM_ICDF(20913), AOM_ICDF(21933),
              AOM_ICDF(22956), AOM_ICDF(23831), AOM_ICDF(24341),
              AOM_ICDF(25317), AOM_ICDF(26434), AOM_ICDF(29028),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(5888), AOM_ICDF(8413), AOM_ICDF(20542), AOM_ICDF(21609),
              AOM_ICDF(22437), AOM_ICDF(22864), AOM_ICDF(23663),
              AOM_ICDF(26329), AOM_ICDF(26900), AOM_ICDF(29828),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(9984), AOM_ICDF(13134), AOM_ICDF(16328), AOM_ICDF(18267),
              AOM_ICDF(19814), AOM_ICDF(21461), AOM_ICDF(22393),
              AOM_ICDF(24944), AOM_ICDF(26320), AOM_ICDF(29653),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(8448), AOM_ICDF(12425), AOM_ICDF(15474), AOM_ICDF(17031),
              AOM_ICDF(19216), AOM_ICDF(20889), AOM_ICDF(23077),
              AOM_ICDF(25108), AOM_ICDF(26548), AOM_ICDF(30108),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(9856), AOM_ICDF(15675), AOM_ICDF(19169), AOM_ICDF(20837),
              AOM_ICDF(22638), AOM_ICDF(24556), AOM_ICDF(25438),
              AOM_ICDF(27114), AOM_ICDF(29449), AOM_ICDF(29456),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6784), AOM_ICDF(10294), AOM_ICDF(14542), AOM_ICDF(15724),
              AOM_ICDF(19109), AOM_ICDF(19972), AOM_ICDF(24084),
              AOM_ICDF(26329), AOM_ICDF(27637), AOM_ICDF(30433),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(8320), AOM_ICDF(10873), AOM_ICDF(17095), AOM_ICDF(18466),
              AOM_ICDF(19674), AOM_ICDF(20129), AOM_ICDF(21230),
              AOM_ICDF(27562), AOM_ICDF(28568), AOM_ICDF(30858),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(9088), AOM_ICDF(13196), AOM_ICDF(15898), AOM_ICDF(17566),
              AOM_ICDF(19210), AOM_ICDF(20354), AOM_ICDF(21186),
              AOM_ICDF(23647), AOM_ICDF(26235), AOM_ICDF(30548),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6912), AOM_ICDF(11512), AOM_ICDF(16390), AOM_ICDF(17479),
              AOM_ICDF(19065), AOM_ICDF(19071), AOM_ICDF(19740),
              AOM_ICDF(21715), AOM_ICDF(23208), AOM_ICDF(29132),
              AOM_ICDF(32768), 0,
          },
          {
              AOM_ICDF(6656), AOM_ICDF(11485), AOM_ICDF(16060), AOM_ICDF(17734),
              AOM_ICDF(19099), AOM_ICDF(19814), AOM_ICDF(21018),
              AOM_ICDF(23053), AOM_ICDF(24333), AOM_ICDF(27260),
              AOM_ICDF(32768), 0,
          },
      },
#endif  // CONFIG_SMOOTH_HV
