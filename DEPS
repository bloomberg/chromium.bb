...
vars = {
  ...
  'webkit_revision': 'b150ddef49d83a4d65bb69f0551144c753c09077', # from svn revision 196008
  ...
  'skia_revision': '084d1b61bca3b9e246cdf26377c373744ab6411c',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and V8 without interference from each other.
  'v8_branch': 'trunk',
  'v8_revision': '8d896cb3e84c8438798714c0d06575c09e122253',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/libjingle/source/talk':
    Var('chromium_git') + '/external/webrtc/trunk/talk.git' + '@' + 'fdfdec893facec2bb99cea3385a2289c98fd323f', # commit position 9308
  ...
  'src/third_party/webrtc':
    Var('chromium_git') + '/external/webrtc/trunk/webrtc.git' + '@' + '464cde1aac5c0983acf68e64608d51ca4b75f308', # commit position 9312
...
deps_os = {
  ...
  'unix': {
    ...
    'src/third_party/chromite':
     Var('chromium_git') + '/chromiumos/chromite.git' + '@' + '46c52fb8bcc08f7b4c6f7326517398fd800b6999',
