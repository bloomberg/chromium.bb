...
vars = {
  ...
  'webkit_revision': 'cce53bed7a7e427ffdc4f7a84d1b441a37bc2e26', # from svn revision 200419
  'chromium_git': 'https://chromium.googlesource.com',
  'libvpx_revision': '19bcff869995b401194074278634e6b5cf391333',
  'sfntly_revision': '1bdaae8fc788a5ac8936d68bf24f37d977a13dac',
  'skia_revision': '58d890bd45a201477ec6c4ba0ae61c574b4e5aef',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'da355b085277092ae6fc7e0c172dd1898eda353b',
  # Three lines of non-changing comments so that
...
deps_os = {
  ...
  'android': {
    ...
    'src/third_party/android_tools':
     Var('chromium_git') + '/android_tools.git' + '@' + '334ba2c28be73ed0d6f4fa6e6c55e91c97b931f1',
