...
vars = {
  ...
  'webkit_revision': 'dcb6aa9bef3b496069e234ed4dc52d1e8c636776', # from svn revision 184812
  ...
  'skia_revision': '2f5cb2fb955234f891655b420187597617e5ab3a',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and V8 without interference from each other.
  'v8_branch': 'trunk',
  'v8_revision': 'e1b4ab6408e609fecb22738da9703f9073a66099', # from svn revision 25089
  # Three lines of non-changing comments so that
