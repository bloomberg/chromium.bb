...
vars = {
  ...
  'webkit_revision': '4de928c1ba66a9d963d54b1ca76ff2a043a6e0f1', # from svn revision 197696
  'chromium_git': 'https://chromium.googlesource.com',
  'libvpx_revision': 'db3f34772338a7e02fc5a7fb9da4d72de68e71b9',
  'sfntly_revision': '1bdaae8fc788a5ac8936d68bf24f37d977a13dac',
  'skia_revision': '56b73fc63f765048fa8c182a43c34ae4d2824a74',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'b90630065532903a908152088dc0aa19068d90b1',
  # Three lines of non-changing comments so that
