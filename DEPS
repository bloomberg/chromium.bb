...
vars = {
  ...
  'webkit_revision': 'a40fe3eafdbcba996365f1816e63cd485c0245a2', # from svn revision 198520
  'chromium_git': 'https://chromium.googlesource.com',
  'libvpx_revision': 'aa9b5f1d6e226fbeae31b2e8984d6c135c61169f',
  'sfntly_revision': '1bdaae8fc788a5ac8936d68bf24f37d977a13dac',
  'skia_revision': '37fffc6e8fc1d7eaff7c1d977cfbc3a7e85e7fae',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'd606a68ecfe19c1673582f0dc4cd771195aec0e9',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/libjingle/source/talk':
    Var('chromium_git') + '/external/webrtc/trunk/talk.git' + '@' + '2495e0ae73f263b6fd7455e4507373e1d61ac1c3', # commit position 9553
  ...
  'src/third_party/webrtc':
    Var('chromium_git') + '/external/webrtc/trunk/webrtc.git' + '@' + '123ea528adafd3e862b6589fb430afb572c1d117', # commit position 9553
