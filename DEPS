...
vars = {
  ...
  'webkit_revision': 'a8cccf8082bf9db3b41bd12c897d0e71fdabfe11', # from svn revision 202417
...
deps = {
  ...
  'src/third_party/ffmpeg':
   Var('chromium_git') + '/chromium/third_party/ffmpeg.git' + '@' + 'e1236a7b76784166d34629b361968f5e9594f6c0',
