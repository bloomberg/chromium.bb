...
vars = {
  ...
  'webkit_revision': 'b67112cef5012d2b20e79b1f60b6e11c3470b9a9', # from svn revision 186302
  ...
  'v8_branch': 'trunk',
  'v8_revision': '47901bd8aa62f62187c8a411d7ef6710a241f0bd',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'buildtools_revision': '8c53ec417e79e1db1b5af93b76b9e1f702b709a6',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'boringssl_revision': '192f34b17599343c99c4d0b9e22fb61a31b21ad2',
  # Three lines of non-changing comments so that
