...
vars = {
  ...
  'webkit_revision': '4d062fadd2aa51b0c6840cd7e53a79a743094b01', # from svn revision 200356
  'chromium_git': 'https://chromium.googlesource.com',
  'libvpx_revision': '19bcff869995b401194074278634e6b5cf391333',
  'sfntly_revision': '1bdaae8fc788a5ac8936d68bf24f37d977a13dac',
  'skia_revision': '2ccdb636e8618db77be8e05cdacd82c249c6898c',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'e348bba636df70eeb20ea73872d899300b8bbe63',
  # Three lines of non-changing comments so that
