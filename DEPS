...
vars = {
  ...
  'webkit_revision': '5a0fc5a804b4ea9a858de821445558b779fc4d11', # from svn revision 197396
  'chromium_git': 'https://chromium.googlesource.com',
  'libvpx_revision': 'db3f34772338a7e02fc5a7fb9da4d72de68e71b9',
  'sfntly_revision': '1bdaae8fc788a5ac8936d68bf24f37d977a13dac',
  'skia_revision': '4c58e085b27c4cd9813ed7cad2388194d1d1f089',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '5780dfa56262e13945f2b643d987142d84215f3d',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': 'e1a5518e4d3c1da79d2a584aa9c80ce5dca6b8ca',
  # Three lines of non-changing comments so that
