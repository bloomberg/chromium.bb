...
vars = {
  ...
  'webkit_revision': 'ce443b3d1a17f640dc46b32e1470a8d8b0aef284', # from svn revision 197740
  'chromium_git': 'https://chromium.googlesource.com',
  'libvpx_revision': 'db3f34772338a7e02fc5a7fb9da4d72de68e71b9',
  'sfntly_revision': '1bdaae8fc788a5ac8936d68bf24f37d977a13dac',
  'skia_revision': '724ae2823e1481e162b576ecfe8525a329c100d5',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '77bccf023da0fc321e8bf11f1883ef96016cae7c',
  # Three lines of non-changing comments so that
