...
vars = {
  ...
  'webkit_revision': '5d185994db600614dae243adfb09a7e191208e2a', # from svn revision 181243
  ...
  'skia_revision': '294739b848c7103afa92390855175dd0bd1cc2d8',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and V8 without interference from each other.
  'v8_branch': 'trunk',
  'v8_revision': '14ff016b8100e5b34fccac4fcf08b8f2e46b02bd', # from svn revision 23571
  # Three lines of non-changing comments so that
