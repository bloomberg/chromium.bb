...
vars = {
  ...
  "skia_revision": "13618",
  "skia_hash": "9d0ecf48c411d45e86378c1c30feffcb513e5df7",
...
deps = {
  ...
  "src/third_party/angle":
    Var("chromium_git") +
    "/angle/angle.git@b75fee4e9e67546dbc80b7d33cf830e65b2ceac4",
...
deps_os = {
  "win": {
    ...
    "src/third_party/syzygy/binaries":
      (Var("googlecode_url") % "sawbuck") + "/trunk/syzygy/binaries@2045",
