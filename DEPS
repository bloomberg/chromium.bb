...
vars = {
  ...
  'webkit_revision': '1e9af2f2d8b3e55dd5888a987d2146ea845fa622', # from svn revision 198103
...
deps = {
  ...
  'src/third_party/icu':
   Var('chromium_git') + '/chromium/deps/icu.git' + '@' + '1b697da5c2c0112e2b70e7e75d3e3d985f464a8f',
