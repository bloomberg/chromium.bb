...
vars = {
  ...
  # and whatever else without interference from each other.
  'angle_revision': '51386f4a5e8b81a3b697e3ebe76c86b49c6364fb',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/glslang/src':
    Var('chromium_git') + '/external/github.com/KhronosGroup/glslang.git' + '@' + '0e5d1bb66ad3135cd14972afd86763520140768a',
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@b2e2edfd0377bcfa5dff6c7b42da6fff74c3456d',
