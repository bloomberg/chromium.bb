...
vars = {
  ...
  'webkit_revision': 'b9921154e46faf187df28751001ee37d661f624f', # from svn revision 198004
  'chromium_git': 'https://chromium.googlesource.com',
  'libvpx_revision': 'db3f34772338a7e02fc5a7fb9da4d72de68e71b9',
  'sfntly_revision': '1bdaae8fc788a5ac8936d68bf24f37d977a13dac',
  'skia_revision': '146a4ba33640d2cf826248fa5562a81e3b68e164',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': 'f8db8da0ebece85c322f75197e72926e52755ef6',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('chromium_git') + '/external/webrtc/trunk/webrtc.git' + '@' + 'd9e75601941b5a46cd3727b6c594d1ff7eb07f83', # commit position 9509
