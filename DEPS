...
vars = {
  ...
  'webkit_revision': 'd35535c2005931aba0a7421ac73fa36960de53f8', # from svn revision 198668
  ...
  'v8_revision': 'b9bc5ef6ebebf78e230879154a04872f1f68963e',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('chromium_git') + '/external/webrtc/trunk/webrtc.git' + '@' + '54d0fdf9a5851515ec9a3bdee10ccbb79ad6e76f', # commit position 9564
