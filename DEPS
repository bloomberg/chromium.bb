...
vars = {
  ...
  'webkit_revision': 'bd4495c9299bcd38c00d29551fd8b63b5077c654', # from svn revision 183906
  ...
  'skia_revision': 'dc89ca56e6f33790cda2cd93ad772ca61497346b',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and V8 without interference from each other.
  'v8_branch': 'trunk',
  'v8_revision': '990186b035529d93d4f629ca566a2fa9e5f6fa54', # from svn revision 24692
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'nacl_revision': 'fb58e927098b853a04818c2809b68b55b84af78f', # from svn revision r13921
}
