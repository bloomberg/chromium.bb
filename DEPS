...
vars = {
  ...
  'webkit_revision': 'ea6d13f690102b98174fd2ce5162515a1d2bd499', # from svn revision 182906
  ...
  'skia_revision': 'c5e15a1afab2621e860a251c3fcf5917867ad49f',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and V8 without interference from each other.
  'v8_branch': 'trunk',
  'v8_revision': '7e426183e2dd585b43750a1eb6ef7c6310282769', # from svn revision 24298
  # Three lines of non-changing comments so that
