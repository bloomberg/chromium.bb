...
vars = {
  ...
  'webkit_revision': '7778da5a0069fc73d46b107420b65e68668f2cbf', # from svn revision 196753
  'chromium_git': 'https://chromium.googlesource.com',
  'libvpx_revision': 'a43631169b4200f2000c8cfa82404ce507e31486',
  'sfntly_revision': '1bdaae8fc788a5ac8936d68bf24f37d977a13dac',
  'skia_revision': 'b3f0ec9f9967da2f80f0d842cb7fd53617b48de3',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '92b3202d30be83ca64843b9301ca2fd180ed364e',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('chromium_git') + '/external/webrtc/trunk/webrtc.git' + '@' + '7f8aa1b126dd868f1edc4387dccde44709887609', # commit position 9394
