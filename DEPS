...
vars = {
  ...
  'webkit_revision': '4a137c27d133243ce3cf9530fe2f6b328bc66c38', # from svn revision 183430
  ...
  'skia_revision': '208d1704c2cc1161ea337a05155f2b9a04edd351',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and V8 without interference from each other.
  'v8_branch': 'trunk',
  'v8_revision': 'bd013e8dac27738ba63346e09b50fdf556603c79', # from svn revision 24476
  # Three lines of non-changing comments so that
