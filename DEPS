...
vars = {
  ...
  'webkit_revision': '34469eae2d7bf0327677da34deef126f190d7e1b', # from svn revision 182277
  ...
  'skia_revision': '3c29c4d36174750a13fc0db1be5584fc47737898',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and V8 without interference from each other.
  'v8_branch': 'trunk',
  'v8_revision': '22cf3f9d4c636215aa2e2a8169573d795142c328', # from svn revision 24057
  # Three lines of non-changing comments so that
