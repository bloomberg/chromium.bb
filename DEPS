...
vars = {
  ...
  'webkit_revision': '47f9e9e95602cc5403c40214cfddf206454d6dff', # from svn revision 187686
  ...
  'skia_revision': '2f1e50ab26a3da463e93beca32bced4dc49ad64a',
...
deps_os = {
  ...
  'unix': {
    ...
    'src/third_party/chromite':
     Var('chromium_git') + '/chromiumos/chromite.git' + '@' + 'ebfaba48b76d45a9f8462510d5379ba877ceb847',
