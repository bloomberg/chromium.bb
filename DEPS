...
vars = {
  ...
  'webkit_revision': '55df7752ffc743d3471b2c3288db87fb3da73807', # from svn revision 197124
  'chromium_git': 'https://chromium.googlesource.com',
  'libvpx_revision': 'db3f34772338a7e02fc5a7fb9da4d72de68e71b9',
  'sfntly_revision': '1bdaae8fc788a5ac8936d68bf24f37d977a13dac',
  'skia_revision': 'f5c633f95db6e15da6f443a4f49f534e01edb676',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '0e57f1e8d031bc3e32c44145202a6e3493db91d0',
  # Three lines of non-changing comments so that
