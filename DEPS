...
vars = {
  ...
  'webkit_revision': '1c9fc9d2d9015e265ecc3ec60cd83ad7440a5d4a', # from svn revision 183628
  ...
  'skia_revision': '5b9cb0676122d0b44621a6f989952958082428ac',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and V8 without interference from each other.
  'v8_branch': 'trunk',
  'v8_revision': '96e349092feb54d69222cbaedaf88d0d2866e40d', # from svn revision 24605
  # Three lines of non-changing comments so that
