...
vars = {
  ...
  'webkit_revision': '54f3f4a314c696617276e0eccce117e26f1ebd08', # from svn revision 199721
  'chromium_git': 'https://chromium.googlesource.com',
  'libvpx_revision': 'd5c834797554016ff9eee05da9f3e4c1fd4fd819',
  'sfntly_revision': '1bdaae8fc788a5ac8936d68bf24f37d977a13dac',
  'skia_revision': 'a15cd9cb7fad31b93cd44541993b69bd5d006582',
  ...
  'android': {
   ...
   'src/third_party/elfutils/src':
    ...
    'src/third_party/custom_tabs_client/src':
      Var('chromium_git') + '/external/github.com/GoogleChrome/custom-tabs-client.git' + '@' + '19d5cb35bece11876e8f34c17c6fdfd9bad609bc',
  },
}
