...
vars = {
  ...
  'skia_revision': '05982367f5ee85a5f0359bb9063c3dbefbd5aa59',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and V8 without interference from each other.
  'v8_branch': 'trunk',
  'v8_revision': 'd16c95fcb64102a90ba014cb570e54b235375604',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/webrtc':
    Var('chromium_git') + '/external/webrtc/trunk/webrtc.git' + '@' + '1bbfeb8214dc549a0e1dacaf39864767999b465a', # from svn revision 8084
