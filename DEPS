...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': 'e5cb7c9a5eb3d4d848a0adb50502382be14d193d',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'pdfium_revision': '475f43338d78ff889851967a09b7398574d95a44',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'catapult_revision': '8114d33c7d557803b613e40f5a80cb2a1087f2a8',
  # Three lines of non-changing comments so that
  ...
  'fuchsia': [
    {
      ...
      'action': [
        ...
        'ea457dcf78ad20e3f60e6558a06123ced6df3e5b',
      ],
    },
  ],
}
