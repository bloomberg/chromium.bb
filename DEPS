...
vars = {
  ...
  'webkit_revision': '9e5f32f72531df9e39722128a0fef0068cd56c61', # from svn revision 195916
  ...
  'skia_revision': '43315bbe4b39073bb8a585cc806eb50a72224e5a',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling Skia
  # and V8 without interference from each other.
  'v8_branch': 'trunk',
  'v8_revision': '5adbe58b96011e69a28e7e19cc2d67446cc4128c',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/third_party/libjingle/source/talk':
    Var('chromium_git') + '/external/webrtc/trunk/talk.git' + '@' + '12875f4200337788c92a1be27364749c479f3f2b', # commit position 9281
  ...
  'src/third_party/webrtc':
    Var('chromium_git') + '/external/webrtc/trunk/webrtc.git' + '@' + '0bc107944ad12465be476d64ce6ffbff4d5c7915', # commit position 9283
