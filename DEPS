...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '7b55818248cc497669b3574ca161c52f4b1d5ea8',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '969150468d9d68a6ce98bbc4abba28b4a09ff97e',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': '86f651198df25fd91e807da8411ad8dd82fdc435',
  # Three lines of non-changing comments so that
  ...
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
  'dawn_revision': 'b639e68495ae732faaa81d5ed85584f39ff6e580',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling feed
  # and whatever else without interference from each other.
...
deps = {
  ...
  'src/third_party/perfetto':
    Var('android_git') + '/platform/external/perfetto.git' + '@' + 'ad0250cefb22d08c15393eaa9e4e5c1dbb1d28d4',
  ...
  'src/third_party/webrtc':
    Var('webrtc_git') + '/src.git' + '@' + '74f35e48d500f3fa54c221d0e2c7d69273780fe9',
