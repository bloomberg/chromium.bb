...

{
  'variables': {
    'conditions': [
      ['(target_arch == "ia32" or target_arch == "x64") and (ffmpeg_branding == "Chrome") and (OS == "win")', {
        'c_sources': [
      ...
      ['(1) and (ffmpeg_branding == "Chrome" or ffmpeg_branding == "ChromiumOS" or ffmpeg_branding == "ChromeOS") and (1)', {
        'c_sources': [
