    ...
    'conditions': [
      ...
      ['(1) and (1) and (1)', {
        ...
        'converter_outputs': [
          ...
          '<(shared_generated_dir)/libavformat/flacdec_picture.c',
          ...
          '<(shared_generated_dir)/libavutil/adler32.c',
          ...
          '<(shared_generated_dir)/libavutil/hash.c',
          ...
          '<(shared_generated_dir)/libavutil/murmur3.c',
          ...
          '<(shared_generated_dir)/libavutil/ripemd.c',
          '<(shared_generated_dir)/libavutil/samplefmt.c',
          '<(shared_generated_dir)/libavutil/sha.c',
          '<(shared_generated_dir)/libavutil/sha512.c',
