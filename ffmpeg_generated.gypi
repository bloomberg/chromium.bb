...

{
  'variables': {
    'conditions': [
      ['(target_arch == "ia32") and (ffmpeg_branding == "Chrome" or ffmpeg_branding == "Chromium") and (OS == "win")', {
        'c_sources': [
      ...
      ['(1) and (1) and (1)', {
        ...
        'converter_outputs': [
          ...
          '<(shared_generated_dir)/libavformat/rm.c',
          '<(shared_generated_dir)/libavformat/rmdec.c',
          ...
          '<(shared_generated_dir)/libavformat/wav.c',
          '<(shared_generated_dir)/libavutil/audio_fifo.c',
          '<(shared_generated_dir)/libavutil/audioconvert.c',
          ...
          '<(shared_generated_dir)/libavutil/inverse.c',
          '<(shared_generated_dir)/libavutil/lfg.c',
          '<(shared_generated_dir)/libavutil/log.c',
          '<(shared_generated_dir)/libavutil/lzo.c',
