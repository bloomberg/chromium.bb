...
TEST(WebTransformAnimationCurveTest, OneTransformKeyframe) {
  scoped_ptr<WebTransformAnimationCurve> curve(
      new WebTransformAnimationCurveImpl);
  scoped_ptr<WebTransformOperations> operations(
      new WebTransformOperationsImpl());
  operations->appendTranslate(2, 0, 0);
  curve->add(WebTransformKeyframe(0, operations.release()),
...
TEST(WebTransformAnimationCurveTest, TwoTransformKeyframe) {
  scoped_ptr<WebTransformAnimationCurve> curve(
      new WebTransformAnimationCurveImpl);
  scoped_ptr<WebTransformOperations> operations1(
      new WebTransformOperationsImpl());
  operations1->appendTranslate(2, 0, 0);
  scoped_ptr<WebTransformOperations> operations2(
      new WebTransformOperationsImpl());
  operations2->appendTranslate(4, 0, 0);
  curve->add(WebTransformKeyframe(0, operations1.release()),
             WebAnimationCurve::TimingFunctionTypeLinear);
  curve->add(WebTransformKeyframe(1, operations2.release()),
             WebAnimationCurve::TimingFunctionTypeLinear);
  EXPECT_FLOAT_EQ(2, curve->getValue(-1).m41());
  EXPECT_FLOAT_EQ(2, curve->getValue(0).m41());
...
TEST(WebTransformAnimationCurveTest, ThreeTransformKeyframe) {
  ...
  scoped_ptr<WebTransformOperations> operations2(
      new WebTransformOperationsImpl());
  operations2->appendTranslate(4, 0, 0);
  scoped_ptr<WebTransformOperations> operations3(
      new WebTransformOperationsImpl());
  ...
  curve->add(WebTransformKeyframe(1, operations2.release()),
             WebAnimationCurve::TimingFunctionTypeLinear);
  curve->add(WebTransformKeyframe(2, operations3.release()),
             WebAnimationCurve::TimingFunctionTypeLinear);
  EXPECT_FLOAT_EQ(2, curve->getValue(-1).m41());
  EXPECT_FLOAT_EQ(2, curve->getValue(0).m41());
  EXPECT_FLOAT_EQ(3, curve->getValue(0.5).m41());
...
TEST(WebTransformAnimationCurveTest, RepeatedTransformKeyTimes) {
  ...
  scoped_ptr<WebTransformOperations> operations4(
      new WebTransformOperationsImpl());
  ...
  curve->add(WebTransformKeyframe(1, operations2.release()),
             WebAnimationCurve::TimingFunctionTypeLinear);
  curve->add(WebTransformKeyframe(1, operations3.release()),
             WebAnimationCurve::TimingFunctionTypeLinear);
  curve->add(WebTransformKeyframe(2, operations4.release()),
             WebAnimationCurve::TimingFunctionTypeLinear);
...
TEST(WebTransformAnimationCurveTest, EaseTimingFunction) {
  ...
  for (int i = 0; i <= 4; ++i) {
    ...
    EXPECT_FLOAT_EQ(timing_function->getValue(time),
                    curve->getValue(time).m41());
  }
}
