...
"""
    ...
    expected_results = """// Ensure comments and newlines don't get stripped.
BUG1 SLOW : 1.html = PASS
...
"""
  ...
  def testExcludeLastPlatformFromFlakiness(self):
    # If a test is flaky on 5/6 platforms and the 6th's expectations are not a
    # subset of the other 5/6, then don't give them all the same expectations.
    expectations = "BUG1 : 1.html = FAIL\n"
