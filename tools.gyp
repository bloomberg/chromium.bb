...

{
  ...
  'targets' : [
          ...
          'actions': [
            {
              ...
              'outputs': ['<(SHARED_INTERMEDIATE_DIR)/sdk/toolchain/<(OS)_x86/nacl_x86_newlib/nacl_x86_newlib.json'],
              'action': [
                'python',
                '<(DEPTH)/native_client/build/package_version/package_version.py',
                '--packages', 'nacl_x86_newlib',
                '--tar-dir', '<(DEPTH)/native_client/toolchain/.tars',
                '--dest-dir', '<(SHARED_INTERMEDIATE_DIR)/sdk/toolchain',
                'extract',
              ],
            },
          ]
          ...
          'actions': [
            {
              ...
              'outputs': ['<(SHARED_INTERMEDIATE_DIR)/sdk/toolchain/<(OS)_x86/nacl_x86_glibc/nacl_x86_glibc.json'],
              'action': [
                'python',
                '<(DEPTH)/native_client/build/package_version/package_version.py',
          ...
          'actions': [
            {
              ...
              'outputs': ['<(SHARED_INTERMEDIATE_DIR)/sdk/toolchain/<(OS)_x86/pnacl_newlib/pnacl_newlib.json'],
              'action': [
                'python',
                '<(DEPTH)/native_client/build/package_version/package_version.py',
          ...
          'actions': [
            {
              ...
              'outputs': ['<(SHARED_INTERMEDIATE_DIR)/sdk/toolchain/<(OS)_x86/nacl_arm_newlib/nacl_arm_newlib.json'],
              'action': [
                'python',
                '<(DEPTH)/native_client/build/package_version/package_version.py',
    ...
    },
    {
      ...
      'variables': {
        'newlib_dir': '<(SHARED_INTERMEDIATE_DIR)/sdk/toolchain/<(OS)_x86/nacl_x86_newlib',
        'glibc_dir': '<(SHARED_INTERMEDIATE_DIR)/sdk/toolchain/<(OS)_x86/nacl_x86_glibc',
        'pnacl_dir': '<(SHARED_INTERMEDIATE_DIR)/sdk/toolchain/<(OS)_x86/pnacl_newlib',
        'arm_dir': '<(SHARED_INTERMEDIATE_DIR)/sdk/toolchain/<(OS)_x86/nacl_arm_newlib',
      },
      'conditions': [
        ['disable_newlib==0', {
          'actions': [
