...
def BuildFactoryTestImage(board, extra_env):
...
def BuildFactoryInstallImage(board, extra_env):
...
def MakeNetboot(board, image_dir):
  ...
  cros_lib.RunCommand(cmd, enter_chroot=True)


def BuildRecoveryImage(board, image_dir, extra_env):
