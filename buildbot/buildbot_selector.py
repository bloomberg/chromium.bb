...
BOT_ASSIGNMENT = {
    ...
    'nacl-win32_newlib_opt': 'buildbot\\buildbot_win.bat opt 32',
    'nacl-win32_glibc_opt': 'buildbot\\buildbot_win.bat opt 32',
    'nacl-win64_newlib_dbg': 'buildbot\\buildbot_win.bat dbg 64',
    'nacl-win64_newlib_opt': 'buildbot\\buildbot_win.bat opt 64',
    'nacl-win64_glibc_opt': 'buildbot\\buildbot_win.bat opt 64',
    'nacl-mac10.5_newlib_opt': 'bash buildbot/buildbot_mac.sh opt',
    'nacl-mac10.5_glibc_opt': 'bash buildbot/buildbot_mac.sh opt',
    'nacl-mac10.6_newlib_opt': 'bash buildbot/buildbot_mac.sh opt',
    'nacl-mac10.6_glibc_opt': 'bash buildbot/buildbot_mac.sh opt',
    'nacl-hardy32_newlib_opt': 'bash buildbot/buildbot_linux.sh opt 32',
    'nacl-lucid32_newlib_dbg': 'bash buildbot/buildbot_linux.sh dbg 32',
    'nacl-lucid32_newlib_opt': 'bash buildbot/buildbot_linux.sh opt 32',
    'nacl-lucid32_glibc_opt': 'bash buildbot/buildbot_linux.sh opt 32',
    'nacl-hardy64_newlib_opt': 'bash buildbot/buildbot_linux.sh opt 64',
    'nacl-lucid64_newlib_dbg': 'bash buildbot/buildbot_linux.sh dbg 64',
    'nacl-lucid64_newlib_opt': 'bash buildbot/buildbot_linux.sh opt 64',
    'nacl-lucid64_glibc_opt': 'bash buildbot/buildbot_linux.sh opt 64',
