...
TEST(RecordingSourceTest, DiscardableImagesWithTransform) {
  ...
  // Tile sized iterators. These should find only one pixel ref.
  {
    ...
    EXPECT_TRUE(images[0]->paint_image().GetSkImage() ==
                discardable_image[0][0]);
    EXPECT_TRUE(images[1]->paint_image().GetSkImage() ==
                discardable_image[1][1]);
  }
  ...
  // Layer sized iterators. These should find all pixel refs.
  {
    ...
    EXPECT_TRUE(images[0]->paint_image().GetSkImage() ==
                discardable_image[0][0]);
    EXPECT_TRUE(images[1]->paint_image().GetSkImage() ==
                discardable_image[1][0]);
    EXPECT_TRUE(images[2]->paint_image().GetSkImage() ==
                discardable_image[1][1]);
  }
