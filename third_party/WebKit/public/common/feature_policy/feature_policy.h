...
#ifndef THIRD_PARTY_WEBKIT_PUBLIC_COMMON_FEATURE_POLICY_FEATURE_POLICY_H_
#define THIRD_PARTY_WEBKIT_PUBLIC_COMMON_FEATURE_POLICY_FEATURE_POLICY_H_
...
#endif  // THIRD_PARTY_WEBKIT_PUBLIC_COMMON_FEATURE_POLICY_FEATURE_POLICY_H_
