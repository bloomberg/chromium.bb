...
#ifndef THIRD_PARTY_WEBKIT_PUBLIC_COMMON_ORIGIN_TRIALS_TRIAL_TOKEN_H_
#define THIRD_PARTY_WEBKIT_PUBLIC_COMMON_ORIGIN_TRIALS_TRIAL_TOKEN_H_
...
#endif  // THIRD_PARTY_WEBKIT_PUBLIC_COMMON_ORIGIN_TRIALS_TRIAL_TOKEN_H_
