...
#ifndef THIRD_PARTY_WEBKIT_PUBLIC_COMMON_MESSAGE_PORT_MESSAGE_PORT_CHANNEL_H_
#define THIRD_PARTY_WEBKIT_PUBLIC_COMMON_MESSAGE_PORT_MESSAGE_PORT_CHANNEL_H_
...
#endif  // THIRD_PARTY_WEBKIT_PUBLIC_COMMON_MESSAGE_PORT_MESSAGE_PORT_CHANNEL_H_
