...
#ifndef THIRD_PARTY_WEBKIT_PUBLIC_COMMON_MESSAGE_PORT_CLONEABLE_MESSAGE_H_
#define THIRD_PARTY_WEBKIT_PUBLIC_COMMON_MESSAGE_PORT_CLONEABLE_MESSAGE_H_
...
#endif  // THIRD_PARTY_WEBKIT_PUBLIC_COMMON_MESSAGE_PORT_CLONEABLE_MESSAGE_H_
