...
layer at (0,0) size 800x354
  LayoutBlockFlow {HTML} at (0,0) size 800x354
    LayoutBlockFlow {BODY} at (8,8) size 784x338
      LayoutText {#text} at (149,26) size 4x18
        text run at (149,26) width 4: " "
      LayoutBR {BR} at (153,26) size 0x18
      LayoutText {#text} at (153,74) size 4x18
        text run at (153,74) width 4: " "
      LayoutText {#text} at (306,74) size 4x18
        text run at (306,74) width 4: " "
      LayoutBR {BR} at (310,74) size 0x18
      LayoutText {#text} at (149,118) size 4x18
        text run at (149,118) width 4: " "
      LayoutBR {BR} at (153,118) size 0x18
      ...
      LayoutText {#text} at (422,236) size 4x18
        text run at (422,236) width 4: " "
...
layer at (205,202) size 221x52 clip at (206,203) size 219x50
  LayoutTextControl {TEXTAREA} at (197,194) size 221x52 [bgcolor=#FFFFFF] [border: (1px solid #000000)]
    LayoutBlockFlow {DIV} at (3,3) size 215x23
      LayoutText {#text} at (0,0) size 28x23
        text run at (0,0) width 28: "foo"
layer at (438,192) size 261x62 clip at (439,193) size 259x60
  LayoutTextControl {TEXTAREA} at (430,184) size 261x62 [bgcolor=#FFFFFF] [border: (1px solid #000000)]
