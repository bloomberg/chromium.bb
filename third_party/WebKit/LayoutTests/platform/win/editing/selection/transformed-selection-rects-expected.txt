...
layer at (28,46) size 622x97
  LayoutBlockFlow {DIV} at (20,38) size 622x97 [border: (1px solid #000000)]
    LayoutBlockFlow {P} at (11,35) size 600x27
      LayoutText {#text} at (0,0) size 135x26
        text run at (0,0) width 135: "Lorem ipsum "
      LayoutInline {SPAN} at (0,0) size 388x26
        LayoutText {#text} at (134,0) size 388x26
          text run at (134,0) width 388: "dolor sit amet, consectetur adipisicing"
      LayoutText {#text} at (521,0) size 44x26
