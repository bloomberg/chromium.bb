    ...
    LayoutBlockFlow {BODY} at (8,8) size 784x584
      LayoutBlockFlow {DIV} at (0,0) size 784x220 [border: (4px solid #0000FF)]
        LayoutBlockFlow {DIV} at (20,20) size 744x69
          ...
          LayoutText {#text} at (97,48) size 188x20
            text run at (97,48) width 188: "Test typing before a table."
        ...
        LayoutBlockFlow {DIV} at (20,110) size 744x90
          ...
          LayoutText {#text} at (97,69) size 443x20
            text run at (97,69) width 443: "Typed text should appear before (on the line above) the table."
      LayoutBlockFlow {DIV} at (0,230) size 784x107 [border: (2px solid #008000)]
        LayoutBlockFlow (anonymous) at (2,2) size 780x27
          LayoutText {#text} at (0,0) size 36x26
            text run at (0,0) width 36: "xxx"
        LayoutTable {TABLE} at (2,29) size 46x76 [border: (1px outset #808080)]
      ...
      LayoutBlockFlow {DIV} at (0,347) size 784x107
        LayoutBlockFlow {DIV} at (0,0) size 784x107 [border: (2px solid #FF0000)]
          LayoutBlockFlow (anonymous) at (2,2) size 780x27
            LayoutText {#text} at (0,0) size 36x26
              text run at (0,0) width 36: "xxx"
          LayoutTable {TABLE} at (2,29) size 46x76 [border: (1px outset #808080)]
