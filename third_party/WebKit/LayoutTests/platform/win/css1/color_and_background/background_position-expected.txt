...
layer at (0,0) size 785x1475 backgroundClip at (0,0) size 785x600 clip at (0,0) size 785x600
  LayoutBlockFlow {HTML} at (0,0) size 785x1475
    LayoutBlockFlow {BODY} at (8,8) size 769x1459 [bgcolor=#CCCCCC]
      ...
      LayoutBlockFlow {PRE} at (0,34) size 769x272
      ...
      LayoutBlockFlow {HR} at (0,319) size 769x2 [border: (1px inset #EEEEEE)]
      LayoutBlockFlow {P} at (0,337) size 769x18
      ...
      LayoutBlockFlow {P} at (0,371) size 769x54 [bgcolor=#00FFFF]
        LayoutText {#text} at (0,0) size 757x53
          ...
          text run at (0,18) width 232: "fixed at the center of the paragraph. "
          text run at (231,18) width 526: "The background color will make it easier to determine the edges of the paragraph,"
          text run at (0,36) width 295: "and therefore allow you to calculate its center."
      LayoutBlockFlow {P} at (0,441) size 769x54 [bgcolor=#00FFFF]
        LayoutText {#text} at (0,0) size 757x53
          text run at (0,0) width 753: "This paragraph should have a single, small green image exactly in its center; that is, the center of the image should be"
          text run at (0,18) width 232: "fixed at the center of the paragraph. "
          text run at (231,18) width 526: "The background color will make it easier to determine the edges of the paragraph,"
          text run at (0,36) width 295: "and therefore allow you to calculate its center."
      LayoutBlockFlow {P} at (0,511) size 769x54 [bgcolor=#00FFFF]
        LayoutText {#text} at (0,0) size 765x53
          text run at (0,0) width 747: "This paragraph should have a single, small green image in its lower-right corner; that is, the lower right corner of the"
          text run at (0,18) width 418: "image should be fixed at the lower right corner of the paragraph. "
          text run at (417,18) width 348: "The background color will make it easier to determine"
          text run at (0,36) width 445: "the edges of the paragraph, and therefore allow you to see its corners."
      LayoutBlockFlow {P} at (0,581) size 769x54 [bgcolor=#00FFFF]
        LayoutText {#text} at (0,0) size 765x53
          text run at (0,0) width 747: "This paragraph should have a single, small green image in its lower-right corner; that is, the lower right corner of the"
          text run at (0,18) width 418: "image should be fixed at the lower right corner of the paragraph. "
          text run at (417,18) width 348: "The background color will make it easier to determine"
          text run at (0,36) width 445: "the edges of the paragraph, and therefore allow you to see its corners."
      LayoutBlockFlow {P} at (0,651) size 769x54 [bgcolor=#00FFFF]
        LayoutText {#text} at (0,0) size 752x53
          ...
          text run at (322,18) width 430: "The background color will make it easier to determine the edges of"
          text run at (0,36) width 391: "the paragraph, and therefore allow you to calculate its center."
      LayoutBlockFlow {P} at (0,721) size 769x54 [bgcolor=#00FFFF]
      ...
      LayoutBlockFlow {P} at (0,791) size 769x72 [bgcolor=#00FFFF]
        LayoutText {#text} at (0,0) size 769x71
      ...
      LayoutTable {TABLE} at (0,879) size 769x580 [border: (1px outset #808080)]
          ...
          LayoutTableRow {TR} at (0,26) size 767x552
            ...
            LayoutTableCell {TD} at (12,26) size 755x552 [border: (1px inset #808080)] [r=1 c=1 rs=1 cs=1]
              ...
              LayoutBlockFlow {P} at (4,38) size 747x54 [bgcolor=#00FFFF]
                LayoutText {#text} at (0,0) size 734x53
                  ...
                  text run at (250,18) width 454: "The background color will make it easier to determine the edges of the"
              ...
              LayoutBlockFlow {P} at (4,178) size 747x54 [bgcolor=#00FFFF]
                LayoutText {#text} at (0,0) size 747x53
                  text run at (0,0) width 747: "This paragraph should have a single, small green image in its lower-right corner; that is, the lower right corner of the"
                  text run at (0,18) width 418: "image should be fixed at the lower right corner of the paragraph. "
                  text run at (417,18) width 280: "The background color will make it easier to"
              ...
              LayoutBlockFlow {P} at (4,318) size 747x54 [bgcolor=#00FFFF]
                LayoutText {#text} at (0,0) size 741x53
                  text run at (0,0) width 741: "This paragraph should have a single, small green image exactly at the left center; that is, the left center of the image"
                  text run at (0,18) width 323: "should be fixed at the left center of the paragraph. "
                  text run at (322,18) width 413: "The background color will make it easier to determine the edges"
              ...
              LayoutBlockFlow {P} at (4,388) size 747x72 [bgcolor=#00FFFF]
                LayoutText {#text} at (0,0) size 719x71
              ...
              LayoutBlockFlow {P} at (4,476) size 747x72 [bgcolor=#00FFFF]
                LayoutText {#text} at (0,0) size 738x71
