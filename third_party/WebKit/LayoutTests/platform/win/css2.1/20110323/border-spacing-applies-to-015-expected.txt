  ...
  LayoutBlockFlow {HTML} at (0,0) size 800x298
    LayoutBlockFlow {BODY} at (8,16) size 784x274
      LayoutBlockFlow {P} at (0,0) size 784x18
        LayoutText {#text} at (0,0) size 656x17
          text run at (0,0) width 656: "Test passes if there is a blue and orange square below and there is no vertical gap between the squares."
      LayoutTable {DIV} at (0,34) size 120x240
