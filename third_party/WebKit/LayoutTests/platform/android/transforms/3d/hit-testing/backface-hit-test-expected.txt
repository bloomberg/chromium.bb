    ...
    LayoutBlockFlow {BODY} at (8,8) size 784x584
      LayoutBlockFlow {P} at (0,0) size 784x20
        LayoutText {#text} at (0,0) size 726x19
          text run at (0,0) width 726: "There are two boxes below, both rotated 180\x{B0} in Y. The rightmost one has backface-visibility: hidden, so you can't see it."
...
layer at (227,63) size 160x160
  LayoutBlockFlow {DIV} at (219,19) size 160x160 [bgcolor=#808080]
