...
layer at (0,0) size 785x1234 backgroundClip at (0,0) size 785x600 clip at (0,0) size 785x600
  LayoutBlockFlow {HTML} at (0,0) size 785x1234.19
    LayoutBlockFlow {BODY} at (8,17.41) size 769x1208.78 [color=#00FF00] [bgcolor=#333333]
      LayoutBlockFlow {H1} at (0,0) size 769x30
        LayoutText {#text} at (0,0) size 528x30
          text run at (0,0) width 528: "CSS2 Table Backgrounds Test Suite"
      LayoutBlockFlow {H2} at (0,47.41) size 769x23
        LayoutText {#text} at (0,0) size 324x23
      ...
      LayoutBlockFlow {P} at (0,118.78) size 769x16
      ...
      LayoutBlockFlow {DL} at (0,147.78) size 769x96
        ...
        LayoutBlockFlow {DD} at (40,16) size 729x16
          LayoutInline {A} at (0,0) size 416x16 [color=#FFFF00]
            LayoutText {#text} at (0,0) size 416x16
        ...
        LayoutBlockFlow {DD} at (40,80) size 729x16
          ...
          LayoutText {#text} at (0,0) size 0x0
      LayoutTable {TABLE} at (0,256.78) size 618x467 [color=#FFFFFF] [bgcolor=#000000] [border: (1px dotted #FFFFFF)]
      ...
      LayoutTable {TABLE} at (0,723.78) size 578x433 [color=#FFFFFF] [bgcolor=#000000] [border: (6px dotted #FFFFFF)]
        ...
        LayoutTableSection {TBODY} at (0,128) size 577x190
          ...
          LayoutTableRow {TR} at (0,107) size 577x83
            ...
            LayoutTableCell {TD} at (465,135) size 112x26 [border: (1px dotted #FFFFFF)] [r=1 c=3 rs=1 cs=1]
              LayoutText {#text} at (2,2) size 44x22
                text run at (2,2) width 44: "TD L"
      LayoutBlockFlow {DIV} at (0,1156.78) size 769x35
        LayoutInline {A} at (0,0) size 88x16 [color=#FFFF00]
          LayoutImage {IMG} at (0,0) size 88x31
        LayoutText {#text} at (0,0) size 0x0
      LayoutBlockFlow {ADDRESS} at (0,1191.78) size 769x17
