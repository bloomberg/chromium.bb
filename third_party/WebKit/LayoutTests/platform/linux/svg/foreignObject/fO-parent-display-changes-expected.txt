...
layer at (0,0) size 800x600
  LayoutSVGRoot {svg} at (0,0) size 100x90
    LayoutSVGContainer {g} at (0,0) size 0x0
      LayoutSVGForeignObject {foreignObject} at (0,0) size 0x0
        LayoutBlockFlow {html} at (0,0) size 0x100
    LayoutSVGRect {rect} at (0,0) size 100x90 [fill={[type=SOLID] [color=#008000]}] [x=0.00] [y=0.00] [width=100.00] [height=90.00]
layer at (0,0) size 100x100
  LayoutBlockFlow (relative positioned) {body} at (0,0) size 100x100 [color=#FFFFFF]
