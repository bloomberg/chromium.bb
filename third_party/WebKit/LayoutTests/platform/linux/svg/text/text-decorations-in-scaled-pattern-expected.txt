...
layer at (0,0) size 600x400
  LayoutSVGRoot {svg} at (0,0) size 417x234
    LayoutSVGHiddenContainer {defs} at (0,0) size 0x0
      LayoutSVGResourcePattern {pattern} [id="pattern"] [patternUnits=objectBoundingBox] [patternContentUnits=objectBoundingBox]
        LayoutSVGContainer {g} at (0,0) size 2x3 [transform={m=((0.05,0.01)(-0.00,0.20)) t=(0.00,0.00)}]
          LayoutSVGText {text} at (0,-3) size 27x15 contains 1 chunk(s)
            LayoutSVGTSpan {tspan} at (0,0) size 27x14
    ...
    LayoutSVGText {text} at (0,215) size 417x19 contains 1 chunk(s)
      LayoutSVGInlineText {#text} at (0,0) size 417x19
