...
layer at (0,0) size 785x1301 backgroundClip at (0,0) size 785x600 clip at (0,0) size 785x600
  LayoutBlockFlow {HTML} at (0,0) size 785x1301.39
    LayoutBlockFlow {BODY} at (8,16) size 769x1277.39
      ...
      LayoutTable {TABLE} at (1.39,1008) size 80x72 [border: (1px solid #808080)]
        LayoutBlockFlow {CAPTION} at (0,0) size 80x20
          LayoutText {#text} at (0,0) size 80x19
            text run at (0,0) width 80: "NormalTable"
        LayoutTableSection {TBODY} at (1,21) size 78x50
          LayoutTableRow {TR} at (0,2) size 78x22
            LayoutTableCell {TD} at (42,2) size 34x22 [r=0 c=0 rs=1 cs=1]
              LayoutText {#text} at (11,1) size 22x19
                text run at (11,1) width 22: "abc"
            LayoutTableCell {TD} at (2,2) size 38x22 [r=0 c=1 rs=1 cs=1]
              LayoutText {#text} at (18,1) size 19x19
                text run at (18,1) width 19: "def"
          LayoutTableRow {TR} at (0,26) size 78x22
            LayoutTableCell {TD} at (42,26) size 34x22 [r=1 c=0 rs=1 cs=1]
              LayoutText {#text} at (19,1) size 14x19
                text run at (19,1) width 14: "hij"
            LayoutTableCell {TD} at (2,26) size 38x22 [r=1 c=1 rs=1 cs=1]
              LayoutText {#text} at (13,1) size 24x19
        ...
        LayoutTable (anonymous) at (1,1) size 24x80
          LayoutTableSection (anonymous) at (0,20) size 24x40
            ...
            LayoutTableRow (anonymous) at (0,20) size 24x20
              LayoutTableCell {DIV} at (0,20) size 24x20 [r=1 c=0 rs=1 cs=1]
                LayoutText {#text} at (5,0) size 19x19
                  text run at (5,0) width 19 RTL override: "def"
          LayoutBlockFlow {DIV} at (0,0) size 24x20
            LayoutText {#text} at (10,0) size 14x19
