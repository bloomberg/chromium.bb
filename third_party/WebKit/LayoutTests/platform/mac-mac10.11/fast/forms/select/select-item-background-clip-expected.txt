...
layer at (0,0) size 800x600
  LayoutBlockFlow {HTML} at (0,0) size 800x600
    LayoutBlockFlow {BODY} at (8,8) size 784x584
      ...
      LayoutBlockFlow (anonymous) at (0,52) size 784x60
        LayoutText {#text} at (0,0) size 0x0
        LayoutText {#text} at (0,0) size 0x0
layer at (8,60) size 54x59 clip at (11,63) size 37x53 scrollHeight 62
  LayoutListBox {SELECT} at (0,-0.50) size 54.13x59.50 [bgcolor=#FFFFFF] [border: (3px solid #0000FF)]
    LayoutBlockFlow {OPTION} at (6,6) size 31.13x14.19
      LayoutText {#text} at (2,0) size 20x13
        text run at (2,0) width 20: "one"
    LayoutBlockFlow {OPTION} at (6,20.19) size 31.13x14.19
      LayoutText {#text} at (2,0) size 19x13
        text run at (2,0) width 19: "two"
    LayoutBlockFlow {OPTION} at (6,34.38) size 31.13x14.19
      LayoutText {#text} at (2,0) size 28x13
        text run at (2,0) width 28: "three"
    LayoutBlockFlow {OPTION} at (6,48.56) size 31.13x14.19 [bgcolor=#800080]
