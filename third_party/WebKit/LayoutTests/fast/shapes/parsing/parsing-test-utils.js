...
var validShapeValues = [
    ...
    ["inset(10px)", "inset(10px)", "inset(10px 0px 0px 0px round 0px 0px 0px 0px / 0px 0px 0px 0px)"],
    ...
    ["inset(10px round 9px)", "inset(10px round 9px 9px 9px 9px / 9px 9px 9px 9px)", "inset(10px 0px 0px 0px round 9px 9px 9px 9px / 9px 9px 9px 9px)"],
