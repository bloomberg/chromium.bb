  ...
  LayoutSVGRoot {svg} at (0,0) size 100x100
    LayoutSVGHiddenContainer {defs} at (0,0) size 0x0
      LayoutSVGResourceClipper {clipPath} [id="myclip"] [clipPathUnits=userSpaceOnUse]
        LayoutSVGPath {path} at (0,0) size 100x100 [transform={m=((0.50,0.00)(0.00,0.50)) t=(0.00,0.00)}] [fill={[type=SOLID] [color=#000000]}] [data="M 0 0 L 200 0 L 200 200 L 0 200 Z"]
