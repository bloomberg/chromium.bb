...
TEST_F(VisibleSelectionTest, expandUsingGranularity)
{
    ...
    selectionInFlatTree = createVisibleSelection(createVisiblePosition(PositionInFlatTree(one, 1)));
    ...
    selection.expandUsingGranularity(WordGranularity);
    selectionInFlatTree = createVisibleSelection(createVisiblePosition(PositionInFlatTree(two, 1)));
    selectionInFlatTree.expandUsingGranularity(WordGranularity);
    ...
    selection.expandUsingGranularity(WordGranularity);
    selectionInFlatTree = createVisibleSelection(createVisiblePosition(PositionInFlatTree(three, 1)));
    selectionInFlatTree.expandUsingGranularity(WordGranularity);
    ...
    selection.expandUsingGranularity(WordGranularity);
    selectionInFlatTree = createVisibleSelection(createVisiblePosition(PositionInFlatTree(four, 1)));
    selectionInFlatTree.expandUsingGranularity(WordGranularity);
    ...
    selection.expandUsingGranularity(WordGranularity);
    selectionInFlatTree = createVisibleSelection(createVisiblePosition(PositionInFlatTree(five, 1)));
    selectionInFlatTree.expandUsingGranularity(WordGranularity);
...
TEST_F(VisibleSelectionTest, ShadowCrossing)
{
    ...
    VisibleSelection selection = createVisibleSelection(Position::firstPositionInNode(one), Position::lastPositionInNode(shadowRoot));
    VisibleSelectionInFlatTree selectionInFlatTree = createVisibleSelection(PositionInFlatTree::firstPositionInNode(one), PositionInFlatTree::lastPositionInNode(host));
...
TEST_F(VisibleSelectionTest, ShadowV0DistributedNodes)
{
    ...
    VisibleSelection selection = createVisibleSelection(Position::firstPositionInNode(one), Position::lastPositionInNode(two));
    VisibleSelectionInFlatTree selectionInFlatTree = createVisibleSelection(PositionInFlatTree::firstPositionInNode(one), PositionInFlatTree::lastPositionInNode(two));
...
TEST_F(VisibleSelectionTest, ShadowNested)
{
    ...
    VisibleSelection selection = createVisibleSelection(Position::firstPositionInNode(one), Position::lastPositionInNode(shadowRoot2));
    VisibleSelectionInFlatTree selectionInFlatTree = createVisibleSelection(PositionInFlatTree::firstPositionInNode(one), PositionInFlatTree::afterNode(eight));
...
TEST_F(VisibleSelectionTest, validatePositionsIfNeededWithShadowHost)
{
    ...
    VisibleSelection selection = createVisibleSelection(Position(sample->firstChild(), 0));
