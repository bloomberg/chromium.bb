...
{
    TRACE_EVENT0("blink_rendering,comp-scroll", "RenderLayerStackingNoe::updateDescendantsAreContiguousInStackingOrder");
    ...
    if (!frameView || !frameView->containsScrollableArea(currentLayer->scrollableArea()))
        return;
