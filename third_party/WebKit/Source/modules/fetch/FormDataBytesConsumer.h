...
public:
    ...
    MODULES_EXPORT FormDataBytesConsumer(ExecutionContext*, PassRefPtr<EncodedFormData>);
    MODULES_EXPORT static FormDataBytesConsumer* createForTesting(ExecutionContext* executionContext, PassRefPtr<EncodedFormData> formData, BytesConsumer* consumer)
    {
    ...
    {
        return m_impl->endRead(readSize);
    }
...
private:
    MODULES_EXPORT FormDataBytesConsumer(ExecutionContext*, PassRefPtr<EncodedFormData>, BytesConsumer*);
