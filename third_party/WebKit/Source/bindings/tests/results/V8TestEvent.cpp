...
namespace WebCore {
WrapperTypeInfo V8TestEvent::info = { V8TestEvent::GetTemplate, V8TestEvent::derefObject, 0, 0, 0, V8TestEvent::installPerContextEnabledPrototypeProperties, &V8Event::info, WrapperTypeObjectPrototype };
