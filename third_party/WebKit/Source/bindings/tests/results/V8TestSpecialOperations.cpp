...
static void initializeScriptWrappableForInterface(TestSpecialOperations* impl)
{
    impl->setTypeInfo(&V8TestSpecialOperations::wrapperTypeInfo);
}
...
v8::Handle<v8::Object> V8TestSpecialOperations::createWrapper(PassRefPtr<TestSpecialOperations> impl, v8::Handle<v8::Object> creationContext, v8::Isolate* isolate)
{
    ...
    V8DOMWrapper::associateObjectWithWrapper<V8TestSpecialOperations>(impl, &wrapperTypeInfo, wrapper, isolate);
    return wrapper;
}
