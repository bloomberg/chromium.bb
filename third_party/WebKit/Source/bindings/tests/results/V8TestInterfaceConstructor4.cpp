...
static void initializeScriptWrappableForInterface(TestInterfaceConstructor4* impl)
{
    impl->setTypeInfo(&V8TestInterfaceConstructor4::wrapperTypeInfo);
}
...
v8::Handle<v8::Object> V8TestInterfaceConstructor4::createWrapper(PassRefPtr<TestInterfaceConstructor4> impl, v8::Handle<v8::Object> creationContext, v8::Isolate* isolate)
{
    ...
    V8DOMWrapper::associateObjectWithWrapper<V8TestInterfaceConstructor4>(impl, &wrapperTypeInfo, wrapper, isolate);
    return wrapper;
}
