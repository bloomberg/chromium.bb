...
protected:
    ...
    v8::Local<v8::Value> deserialize(String& data, BlobDataHandleMap& blobDataHandles, ArrayBufferContentsArray*, ImageBitmapArray*, v8::Isolate*, MessagePortArray* messagePorts, const WebBlobInfoArray*) override;
};
