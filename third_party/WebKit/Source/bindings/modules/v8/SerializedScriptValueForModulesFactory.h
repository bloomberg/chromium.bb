...
public:
    ...
    PassRefPtr<SerializedScriptValue> create(v8::Isolate*, v8::Local<v8::Value>, MessagePortArray*, TransferableArray*, WebBlobInfoArray*, ExceptionState&) override;
    PassRefPtr<SerializedScriptValue> create(v8::Isolate*, const String&) override;

protected:
    ScriptValueSerializer::Status doSerialize(v8::Local<v8::Value>, SerializedScriptValueWriter&, MessagePortArray*, TransferableArray*, WebBlobInfoArray*, BlobDataHandleMap&, v8::TryCatch&, String& errorMessage, v8::Isolate*) override;
