...

{
  'variables': {
    ...
    'bindings_modules_v8_generated_union_type_files': [
      ...
      '<(bindings_modules_v8_output_dir)/CanvasRenderingContext2DOrWebGLRenderingContextOrWebGL2RenderingContextOrImageBitmapRenderingContext.cpp',
      '<(bindings_modules_v8_output_dir)/CanvasRenderingContext2DOrWebGLRenderingContextOrWebGL2RenderingContextOrImageBitmapRenderingContext.h',
