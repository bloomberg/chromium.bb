...
sub GenerateInterface
{
    ...
    $implementation{nameSpaceWebCore} = new Block("Namespace WebCore", "namespace WebCore {\n", "\n} // namespace WebCore\n");
...
sub WriteData
{
    ...
    # FIXME: use $implementation{root}->toString() in both cases after generator use class Block for non-callback implementation.
    if ($interface->isCallback) {
