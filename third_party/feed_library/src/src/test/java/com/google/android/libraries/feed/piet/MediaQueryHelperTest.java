...
public class MediaQueryHelperTest {
                ...
                mediaQueryHelper.isMediaQueryMet(
                    MediaQueryCondition.newBuilder()
                        .setFrameWidth(
                            FrameWidthCondition.newBuilder()
                                .setWidth(midWidth)
                                .setCondition(ComparisonCondition.UNSPECIFIED))
                        .build()))
  ...
  public void testMediaQueryConditions_orientation() {
    ...
    assertThat(
            mediaQueryHelper.isMediaQueryMet(
                MediaQueryCondition.newBuilder()
                    .setOrientation(
                        OrientationCondition.newBuilder().setOrientation(Orientation.LANDSCAPE))
                    .build()))
        .isTrue();
    assertThat(
            mediaQueryHelper.isMediaQueryMet(
                MediaQueryCondition.newBuilder()
                    .setOrientation(
                        OrientationCondition.newBuilder().setOrientation(Orientation.PORTRAIT))
                    .build()))
        .isFalse();
    ...
    assertThat(
            mediaQueryHelper.isMediaQueryMet(
                MediaQueryCondition.newBuilder()
                    .setOrientation(
                        OrientationCondition.newBuilder().setOrientation(Orientation.UNSPECIFIED))
                    .build()))
        .isTrue();
  ...
  public void testMediaQueryConditions_darkLight() {
    ...
    assertThat(
            mediaQueryHelper.isMediaQueryMet(
                MediaQueryCondition.newBuilder()
                    .setDarkLight(
                        DarkLightCondition.newBuilder().setMode(DarkLightMode.UNSPECIFIED))
                    .build()))
        .isFalse();
  ...
  public void testMediaQueryConditions_allConditionsTrue() {
    MediaQueryCondition landscapeCondition =
        MediaQueryCondition.newBuilder()
            .setOrientation(OrientationCondition.newBuilder().setOrientation(Orientation.LANDSCAPE))
            .build();
