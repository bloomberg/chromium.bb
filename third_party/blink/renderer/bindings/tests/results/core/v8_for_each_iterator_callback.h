...
template <>
class V8PersistentCallbackFunction<V8ForEachIteratorCallback> final : public V8PersistentCallbackFunctionBase {
  using V8CallbackFunction = V8ForEachIteratorCallback;
 ...
 public:
  ...
  v8::Maybe<void> Invoke(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, ScriptValue value, ScriptValue key, ScriptValue obj) WARN_UNUSED_RESULT;
  CORE_EXPORT void InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter callback_this_value, ScriptValue value, ScriptValue key, ScriptValue obj);
...
// V8ForEachIteratorCallback is designed to be used with wrapper-tracing.
...
Persistent<V8ForEachIteratorCallback> WrapPersistent(V8ForEachIteratorCallback*) = delete;
