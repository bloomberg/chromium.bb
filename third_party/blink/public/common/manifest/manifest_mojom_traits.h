...
inline base::StringPiece16 TruncateString16(const base::string16& string) {
  return base::StringPiece16(string).substr(
      0, ::blink::Manifest::kMaxIPCStringLength);
}
...
struct BLINK_COMMON_EXPORT
  ...
  static int64_t theme_color(const ::blink::Manifest& manifest) {
    return manifest.theme_color;
  }

  static int64_t background_color(const ::blink::Manifest& manifest) {
