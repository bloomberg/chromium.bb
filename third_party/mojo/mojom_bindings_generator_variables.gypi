...

{
  'variables': {
    ...
    'mojom_bindings_generator_sources': [
      '<(mojom_bindings_generator)',
      '<(DEPTH)/mojo/public/tools/bindings/generators/cpp_templates/enum_macros.tmpl',
      ...
      '<(DEPTH)/mojo/public/tools/bindings/generators/java_templates/data_types_definition.tmpl',
      ...
      '<(DEPTH)/mojo/public/tools/bindings/generators/java_templates/union.java.tmpl',
      ...
      '<(DEPTH)/mojo/public/tools/bindings/generators/js_templates/union_definition.tmpl',
      '<(DEPTH)/mojo/public/tools/bindings/generators/js_templates/validation_macros.tmpl',
