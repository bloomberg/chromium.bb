...
#ifndef THIRD_PARTY_MOJO_SRC_MOJO_EDK_SYSTEM_HANDLE_TABLE_H_
#define THIRD_PARTY_MOJO_SRC_MOJO_EDK_SYSTEM_HANDLE_TABLE_H_
...
#endif  // THIRD_PARTY_MOJO_SRC_MOJO_EDK_SYSTEM_HANDLE_TABLE_H_
