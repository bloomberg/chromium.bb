...
(function() {
  ...
  var data = i18n.input.chrome.inputview.content.util.createData(
      keyCharacters, viewIdPrefix_, true, true, keyCodes, 'is.compact.qwerty');
  data['id'] = 'is';
  ...
  letterKeysetSpec[keysetSpecNode.ID] = 'is.compact.qwerty';
  ...
  letterKeysetSpec[keysetSpecNode.DATA] = i18n.input.chrome.inputview.content.
      compact.letter.keyIcelandicCharacters();

  var symbolKeysetSpec = {};
  symbolKeysetSpec[keysetSpecNode.ID] = 'is.compact.symbol';
  ...
  var moreKeysetSpec = {};
  moreKeysetSpec[keysetSpecNode.ID] = 'is.compact.more';
  ...
  numberKeysetSpec[keysetSpecNode.ID] = 'is.compact.numberpad';
