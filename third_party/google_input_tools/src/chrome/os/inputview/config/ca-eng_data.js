...
(function() {
  ...
  letterKeysetSpec[keysetSpecNode.ID] = 'ca-eng.compact.qwerty';
  ...
  symbolKeysetSpec[keysetSpecNode.ID] = 'ca-eng.compact.symbol';
  ...
  var moreKeysetSpec = {};
  moreKeysetSpec[keysetSpecNode.ID] = 'ca-eng.compact.more';
  ...
  numberKeysetSpec[keysetSpecNode.ID] = 'ca-eng.compact.numberpad';
