...
#include "ash/public/cpp/shelf_item_types.h"
...
extern const aura::WindowProperty<bool>* const kPanelAttachedKey;

// A property key to store the type of a window's shelf item.
extern const aura::WindowProperty<int32_t>* const kShelfItemTypeKey;
