  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        '../ui/views/controls/button/button_dropdown.h',
        ...
        '../ui/views/controls/button/text_button.cc',
        '../ui/views/controls/button/text_button.h',
        ...
        '../ui/views/controls/link_listener.h',
        '../ui/views/controls/menu/menu.cc',
        '../ui/views/controls/menu/menu.h',
        '../ui/views/controls/menu/menu_2.cc',
        '../ui/views/controls/menu/menu_2.h',
        ...
        '../ui/views/controls/menu/menu_gtk.cc',
        '../ui/views/controls/menu/menu_gtk.h',
        ...
        '../ui/views/controls/menu/menu_item_view_aura.cc',
        '../ui/views/controls/menu/menu_item_view_linux.cc',
        '../ui/views/controls/menu/menu_item_view_win.cc',
        '../ui/views/controls/menu/menu_listener.h',
        ...
        '../ui/views/controls/menu/menu_separator_aura.cc',
        '../ui/views/controls/menu/menu_separator_linux.cc',
        '../ui/views/controls/menu/menu_separator_win.cc',
        '../ui/views/controls/menu/menu_win.cc',
        '../ui/views/controls/menu/menu_win.h',
        '../ui/views/controls/menu/menu_wrapper.h',
        '../ui/views/controls/menu/native_menu_gtk.cc',
        '../ui/views/controls/menu/native_menu_gtk.h',
        '../ui/views/controls/menu/native_menu_host.h',
        '../ui/views/controls/menu/native_menu_host_delegate.h',
        ...
        '../ui/views/controls/menu/nested_dispatcher_gtk.cc',
        '../ui/views/controls/menu/nested_dispatcher_gtk.h',
      ...
      'conditions': [
        ...
        [ 'use_aura==1', {
          ...
          'sources/': [
            ...
            ['exclude', '../ui/views/test/test_tooltip_client.cc'],
          ],
        }],
      ],
    },  # target_name: views_unittests
