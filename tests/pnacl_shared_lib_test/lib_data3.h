...
EXTERN_OR_COMMON TLS_OR_NOT const char lib_3_string[kSTRING_3_LEN]
__attribute__((aligned(32)));
EXTERN_OR_COMMON TLS_OR_NOT double lib_3_double;
EXTERN_OR_COMMON TLS_OR_NOT int64_t lib_3_int64;
EXTERN_OR_COMMON TLS_OR_NOT int32_t lib_3_int32;
EXTERN_OR_COMMON TLS_OR_NOT int16_t lib_3_int16;
EXTERN_OR_COMMON TLS_OR_NOT int8_t lib_3_int8;
