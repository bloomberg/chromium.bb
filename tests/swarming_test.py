...
def gen_result_response(**kwargs):
  out = {
    u'bot_id': u'swarm6',
    u'completed_ts': u'2014-09-24 13:49:16.012345',
    u'created_ts': u'2014-09-24 13:49:03.012345',
    u'duration': 0.9636809825897217,
    u'exit_code': 0,
    u'failure': False,
    u'internal_failure': False,
    u'modified_ts': u'2014-09-24 13:49:17.012345',
    u'name': u'heartbeat-canary-2014-09-24_13:49:01-os=Linux',
    u'server_versions': [u'1'],
    u'started_ts': u'2014-09-24 13:49:09.012345',
    u'state': 'COMPLETED',
...
class TestMain(NetTestCase):
  ...
  def test_query_cursor(self):
    self.expected_requests(
        [
          (
            'https://localhost:1/_ah/api/swarming/v1/bot/botid/tasks?limit=2',
            {'data': None},
            {
              'cursor': '%',
              'extra': False,
