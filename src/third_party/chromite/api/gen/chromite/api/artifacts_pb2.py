...
_ARTIFACTSSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='chromite.api.ArtifactsService.BundleArtifacts',
    index=1,
    containing_service=None,
    input_type=_BUNDLEARTIFACTSREQUEST,
    output_type=_BUNDLEARTIFACTSRESPONSE,
    serialized_options=None,
  ),
  _descriptor.MethodDescriptor(
