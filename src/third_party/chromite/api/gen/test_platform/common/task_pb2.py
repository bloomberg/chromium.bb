...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x1ftest_platform/common/task.proto\x12\x14test_platform.common\"\x1d\n\x0bTaskLogData\x12\x0e\n\x06gs_url\x18\x01 \x01(\tB@Z>go.chromium.org/chromiumos/infra/proto/go/test_platform/commonb\x06proto3')
)
