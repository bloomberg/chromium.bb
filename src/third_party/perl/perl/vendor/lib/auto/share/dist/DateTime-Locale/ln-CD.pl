{
  ...
  first_day_of_week => 1,
  glibc_date_1_format => "%A %-e %B %Y, %H:%M:%S (UTC%z)",
  ...
  native_name => "ling\N{U+00e1}la Republ\N{U+00ed}ki ya Kong\N{U+00f3} Demokrat\N{U+00ed}ki",
  native_script => undef,
  native_territory => "Republ\N{U+00ed}ki ya Kong\N{U+00f3} Demokrat\N{U+00ed}ki",
