...
#
# This file was generated from the source file ha_GH.xml
...
package DateTime::Locale::ha_GH;

use strict;
use warnings;
use utf8;

use base 'DateTime::Locale::ha_Latn_GH';
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'ha_GH' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Hausa Ghana.

=head1 DATA

This locale inherits from the L<DateTime::Locale::ha_Latn_GH> locale.
