...
#
# This file was generated from the source file uz_Cyrl.xml
...
package DateTime::Locale::uz_Cyrl;
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'uz_Cyrl' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Uzbek Cyrillic.
