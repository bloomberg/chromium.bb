...
#
# This file was generated from the source file de_LI.xml
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'de_LI' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for German Liechtenstein.
