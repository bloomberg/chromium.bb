...
# The source file version number was 1.120, generated on
# 2009/06/15 03:46:25.
#
...
{
    my $month_format_abbreviated = [ "jan\.", "feb\.", "mars", "apr\.", "mai", "juni", "juli", "aug\.", "sep\.", "okt\.", "nov\.", "des\." ];
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'nb' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Norwegian Bokmål.
