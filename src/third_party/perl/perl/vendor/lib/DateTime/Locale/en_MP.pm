...
#
# This file was generated from the source file en_MP.xml
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'en_MP' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for English Northern Mariana Islands.
