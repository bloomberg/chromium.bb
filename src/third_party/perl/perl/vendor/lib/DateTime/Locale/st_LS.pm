...
#
# This file was generated from the source file st_LS.xml
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'st_LS' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Southern Sotho Lesotho.
