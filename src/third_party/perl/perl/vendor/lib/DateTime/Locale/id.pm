...
{
    my $day_format_abbreviated = [ "Sen", "Sel", "Rab", "Kam", "Jum", "Sab", "Min" ];
...
{
    my $day_format_wide = [ "Senin", "Selasa", "Rabu", "Kamis", "Jumat", "Sabtu", "Minggu" ];
...
{
    my $month_format_abbreviated = [ "Jan", "Feb", "Mar", "Apr", "Mei", "Jun", "Jul", "Agu", "Sep", "Okt", "Nov", "Des" ];
...
{
    my $month_format_wide = [ "Januari", "Februari", "Maret", "April", "Mei", "Juni", "Juli", "Agustus", "September", "Oktober", "November", "Desember" ];
...
{
    my $quarter_format_wide = [ "kuartal\ pertama", "kuartal\ kedua", "kuartal\ ketiga", "kuartal\ keempat" ];
...
This is the DateTime locale package for Indonesian.
