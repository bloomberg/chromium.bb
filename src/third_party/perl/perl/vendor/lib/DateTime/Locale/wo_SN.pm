...
#
# This file was generated from the source file wo_SN.xml
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'wo_SN' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Wolof Senegal.

=head1 DATA

This locale inherits from the L<DateTime::Locale::wo> locale.
