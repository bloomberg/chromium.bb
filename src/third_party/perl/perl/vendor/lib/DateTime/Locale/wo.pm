...
#
# This file was generated from the source file wo.xml
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'wo' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Wolof.
