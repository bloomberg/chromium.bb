...
typedef enum {
  ...
  /* In the NPDrawingModelCoreAnimation drawing model,
     the browser asks the plug-in for a Core Animation layer. */
...
/*
 * The drawing model for a Mac OS X plugin.
 * These are the possible values for the NPNVpluginDrawingModel variable.
 */
...
/*
 * The event model for a Mac OS X plugin.
 * These are the possible values for the NPNVpluginEventModel variable.
 */
