...
#ifndef THIRD_PARTY_BLINK_RENDERER_PLATFORM_WIDGET_INPUT_PREDICTION_PREDICTION_METRICS_HANDLER_H_
#define THIRD_PARTY_BLINK_RENDERER_PLATFORM_WIDGET_INPUT_PREDICTION_PREDICTION_METRICS_HANDLER_H_
...
// few metrics.
class PLATFORM_EXPORT PredictionMetricsHandler {
 public:
...
#endif  // THIRD_PARTY_BLINK_RENDERER_PLATFORM_WIDGET_INPUT_PREDICTION_PREDICTION_METRICS_HANDLER_H_
