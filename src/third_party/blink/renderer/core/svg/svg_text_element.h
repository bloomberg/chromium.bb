...
#ifndef THIRD_PARTY_BLINK_RENDERER_CORE_SVG_SVG_TEXT_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_CORE_SVG_SVG_TEXT_ELEMENT_H_
...
#endif  // THIRD_PARTY_BLINK_RENDERER_CORE_SVG_SVG_TEXT_ELEMENT_H_
