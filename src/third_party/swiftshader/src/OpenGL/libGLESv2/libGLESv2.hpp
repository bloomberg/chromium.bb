...
private:
	LibGLESv2exports *loadExports()
	{
		if(!loadLibraryAttempted && !libGLESv2)
		{
			#if defined(_WIN32)
				#if defined(__LP64__)
					const char *libGLESv2_lib[] = {"libswiftshader_libGLESv2.dll", SWIFT_GLESV2_LIBRARY_NAME, "lib64GLES_V2_translator.dll"};
				#else
					const char *libGLESv2_lib[] = {"libswiftshader_libGLESv2.dll", SWIFT_GLESV2_LIBRARY_NAME, "libGLES_V2_translator.dll"};
				#endif
