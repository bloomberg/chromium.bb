...
# source: infra_libs/ts_mon/protos/acquisition_network_device.proto
...
NetworkDevice = _reflection.GeneratedProtocolMessageType('NetworkDevice', (_message.Message,), {
  'DESCRIPTOR' : _NETWORKDEVICE,
  '__module__' : 'infra_libs.ts_mon.protos.acquisition_network_device_pb2'
