...
// 
//    = Store2RegisterImm12Op {constraints: & ~cccc010100101101tttt000000000100 }
class LoadStore2RegisterImm12OpTesterCase18
    : public LoadStore2RegisterImm12OpTester {
 public:
  LoadStore2RegisterImm12OpTesterCase18(const NamedClassDecoder& decoder)
    : LoadStore2RegisterImm12OpTester(decoder) {}
  virtual bool PassesParsePreconditions(
      nacl_arm_dec::Instruction inst,
      const NamedClassDecoder& decoder);
...
bool LoadStore2RegisterImm12OpTesterCase18
::PassesParsePreconditions(
     nacl_arm_dec::Instruction inst,
     const NamedClassDecoder& decoder) {
...
//    = Store2RegisterImm12Op {constraints: & ~cccc010100101101tttt000000000100 ,
//     rule: Str_Rule_194_A1_P384}
class Store2RegisterImm12OpTester_Case18
    : public LoadStore2RegisterImm12OpTesterCase18 {
 public:
  Store2RegisterImm12OpTester_Case18()
    : LoadStore2RegisterImm12OpTesterCase18(
...
//     rule: Str_Rule_194_A1_P384}
TEST_F(Arm32DecoderStateTests,
       Store2RegisterImm12OpTester_Case18_TestCase18) {
  Store2RegisterImm12OpTester_Case18 baseline_tester;
