...
class NamedArm32DecoderState : nacl_arm_dec::DecoderState {
 public:
  ...
  const NamedBinary2RegisterImmediateOpDynCodeReplace_ORR_immediate_A1 Binary2RegisterImmediateOpDynCodeReplace_ORR_immediate_A1_instance_;
  ...
  const NamedBinary3RegisterOp_ASR_register_A1 Binary3RegisterOp_ASR_register_A1_instance_;
  const NamedBinary3RegisterOp_LSL_register_A1 Binary3RegisterOp_LSL_register_A1_instance_;
  const NamedBinary3RegisterOp_LSR_register_A1 Binary3RegisterOp_LSR_register_A1_instance_;
  const NamedBinary3RegisterOp_ROR_register_A1 Binary3RegisterOp_ROR_register_A1_instance_;
  ...
  const NamedBinary3RegisterShiftedTest_CMN_register_shifted_register_A1 Binary3RegisterShiftedTest_CMN_register_shifted_register_A1_instance_;
  const NamedBinary3RegisterShiftedTest_CMP_register_shifted_register_A1 Binary3RegisterShiftedTest_CMP_register_shifted_register_A1_instance_;
  const NamedBinary3RegisterShiftedTest_TEQ_register_shifted_register_A1 Binary3RegisterShiftedTest_TEQ_register_shifted_register_A1_instance_;
  const NamedBinary3RegisterShiftedTest_TST_register_shifted_register_A1 Binary3RegisterShiftedTest_TST_register_shifted_register_A1_instance_;
  const NamedBinary4RegisterDualOp_MLA_A1 Binary4RegisterDualOp_MLA_A1_instance_;
  ...
  const NamedBinary4RegisterDualResult_SMLAL_A1 Binary4RegisterDualResult_SMLAL_A1_instance_;
  const NamedBinary4RegisterDualResult_SMULL_A1 Binary4RegisterDualResult_SMULL_A1_instance_;
  const NamedBinary4RegisterDualResult_UMAAL_A1 Binary4RegisterDualResult_UMAAL_A1_instance_;
  const NamedBinary4RegisterDualResult_UMLAL_A1 Binary4RegisterDualResult_UMLAL_A1_instance_;
  const NamedBinary4RegisterDualResult_UMULL_A1 Binary4RegisterDualResult_UMULL_A1_instance_;
  ...
  const NamedBinary4RegisterShiftedOp_ADC_register_shifted_register_A1 Binary4RegisterShiftedOp_ADC_register_shifted_register_A1_instance_;
  const NamedBinary4RegisterShiftedOp_ADD_register_shifted_register_A1 Binary4RegisterShiftedOp_ADD_register_shifted_register_A1_instance_;
  const NamedBinary4RegisterShiftedOp_AND_register_shifted_register_A1 Binary4RegisterShiftedOp_AND_register_shifted_register_A1_instance_;
  const NamedBinary4RegisterShiftedOp_BIC_register_shifted_register_A1 Binary4RegisterShiftedOp_BIC_register_shifted_register_A1_instance_;
  const NamedBinary4RegisterShiftedOp_EOR_register_shifted_register_A1 Binary4RegisterShiftedOp_EOR_register_shifted_register_A1_instance_;
  const NamedBinary4RegisterShiftedOp_ORR_register_shifted_register_A1 Binary4RegisterShiftedOp_ORR_register_shifted_register_A1_instance_;
  const NamedBinary4RegisterShiftedOp_RSB_register_shfited_register_A1 Binary4RegisterShiftedOp_RSB_register_shfited_register_A1_instance_;
  ...
  const NamedLdrImmediateOp_Ldr_Rule_58_A1_P120 LdrImmediateOp_Ldr_Rule_58_A1_P120_instance_;
  ...
  const NamedUnary1RegisterImmediateOpDynCodeReplace_MOV_immediate_A1 Unary1RegisterImmediateOpDynCodeReplace_MOV_immediate_A1_instance_;
  const NamedUnary1RegisterImmediateOpDynCodeReplace_MVN_immediate_A1 Unary1RegisterImmediateOpDynCodeReplace_MVN_immediate_A1_instance_;
  const NamedUnary1RegisterImmediateOpDynCodeReplace_Movt_Rule_99_A1_P200 Unary1RegisterImmediateOpDynCodeReplace_Movt_Rule_99_A1_P200_instance_;
  const NamedUnary1RegisterImmediateOpDynCodeReplace_Movw_Rule_96_A2_P194 Unary1RegisterImmediateOpDynCodeReplace_Movw_Rule_96_A2_P194_instance_;
  ...
  const NamedUnary3RegisterShiftedOp_MVN_register_shifted_register_A1 Unary3RegisterShiftedOp_MVN_register_shifted_register_A1_instance_;
  ...
  const NamedVectorStoreMultiple1_VST1_multiple_single_elements VectorStoreMultiple1_VST1_multiple_single_elements_instance_;
  const NamedVectorStoreMultiple2_VST2_multiple_2_element_structures VectorStoreMultiple2_VST2_multiple_2_element_structures_instance_;
  const NamedVectorStoreMultiple3_VST3_multiple_3_element_structures VectorStoreMultiple3_VST3_multiple_3_element_structures_instance_;
  const NamedVectorStoreMultiple4_VST4_multiple_4_element_structures VectorStoreMultiple4_VST4_multiple_4_element_structures_instance_;
  const NamedVectorStoreSingle1_VST1_single_element_from_one_lane VectorStoreSingle1_VST1_single_element_from_one_lane_instance_;
  const NamedVectorStoreSingle2_VST2_single_2_element_structure_from_one_lane VectorStoreSingle2_VST2_single_2_element_structure_from_one_lane_instance_;
  const NamedVectorStoreSingle3_VST3_single_3_element_structure_from_one_lane VectorStoreSingle3_VST3_single_3_element_structure_from_one_lane_instance_;
  const NamedVectorStoreSingle4_VST4_single_4_element_structure_form_one_lane VectorStoreSingle4_VST4_single_4_element_structure_form_one_lane_instance_;
  ...
  const NamedDefs12To15RdRmRnNotPc_ASR_register_A1 Defs12To15RdRmRnNotPc_ASR_register_A1_instance_;
  const NamedDefs12To15RdRmRnNotPc_LSL_register_A1 Defs12To15RdRmRnNotPc_LSL_register_A1_instance_;
  const NamedDefs12To15RdRmRnNotPc_LSR_register_A1 Defs12To15RdRmRnNotPc_LSR_register_A1_instance_;
  const NamedDefs12To15RdRmRnNotPc_MVN_register_shifted_register_A1 Defs12To15RdRmRnNotPc_MVN_register_shifted_register_A1_instance_;
  const NamedDefs12To15RdRmRnNotPc_ROR_register_A1 Defs12To15RdRmRnNotPc_ROR_register_A1_instance_;
  const NamedDefs12To15RdRnNotPc_Clz_Rule_31_A1_P72 Defs12To15RdRnNotPc_Clz_Rule_31_A1_P72_instance_;
  const NamedDefs12To15RdRnRsRmNotPc_ADC_register_shifted_register_A1 Defs12To15RdRnRsRmNotPc_ADC_register_shifted_register_A1_instance_;
  const NamedDefs12To15RdRnRsRmNotPc_ADD_register_shifted_register_A1 Defs12To15RdRnRsRmNotPc_ADD_register_shifted_register_A1_instance_;
  const NamedDefs12To15RdRnRsRmNotPc_AND_register_shifted_register_A1 Defs12To15RdRnRsRmNotPc_AND_register_shifted_register_A1_instance_;
  const NamedDefs12To15RdRnRsRmNotPc_BIC_register_shifted_register_A1 Defs12To15RdRnRsRmNotPc_BIC_register_shifted_register_A1_instance_;
  const NamedDefs12To15RdRnRsRmNotPc_EOR_register_shifted_register_A1 Defs12To15RdRnRsRmNotPc_EOR_register_shifted_register_A1_instance_;
  const NamedDefs12To15RdRnRsRmNotPc_ORR_register_shifted_register_A1 Defs12To15RdRnRsRmNotPc_ORR_register_shifted_register_A1_instance_;
  const NamedDefs12To15RdRnRsRmNotPc_RSB_register_shfited_register_A1 Defs12To15RdRnRsRmNotPc_RSB_register_shfited_register_A1_instance_;
  const NamedDefs12To15RdRnRsRmNotPc_RSC_register_shifted_register_A1 Defs12To15RdRnRsRmNotPc_RSC_register_shifted_register_A1_instance_;
  const NamedDefs12To15RdRnRsRmNotPc_SBC_register_shifted_register_A1 Defs12To15RdRnRsRmNotPc_SBC_register_shifted_register_A1_instance_;
  const NamedDefs12To15RdRnRsRmNotPc_SUB_register_shifted_register_A1 Defs12To15RdRnRsRmNotPc_SUB_register_shifted_register_A1_instance_;
  const NamedDefs12To19CondsDontCareRdRmRnNotPc_SMLAL_A1 Defs12To19CondsDontCareRdRmRnNotPc_SMLAL_A1_instance_;
  const NamedDefs12To19CondsDontCareRdRmRnNotPc_SMULL_A1 Defs12To19CondsDontCareRdRmRnNotPc_SMULL_A1_instance_;
  const NamedDefs12To19CondsDontCareRdRmRnNotPc_UMAAL_A1 Defs12To19CondsDontCareRdRmRnNotPc_UMAAL_A1_instance_;
  const NamedDefs12To19CondsDontCareRdRmRnNotPc_UMLAL_A1 Defs12To19CondsDontCareRdRmRnNotPc_UMLAL_A1_instance_;
  const NamedDefs12To19CondsDontCareRdRmRnNotPc_UMULL_A1 Defs12To19CondsDontCareRdRmRnNotPc_UMULL_A1_instance_;
  ...
  const NamedDefs16To19CondsDontCareRdRaRmRnNotPc_MLA_A1 Defs16To19CondsDontCareRdRaRmRnNotPc_MLA_A1_instance_;
  const NamedDefs16To19CondsDontCareRdRaRmRnNotPc_MLS_A1 Defs16To19CondsDontCareRdRaRmRnNotPc_MLS_A1_instance_;
  ...
  const NamedDefs16To19CondsDontCareRdRmRnNotPc_MUL_A1 Defs16To19CondsDontCareRdRmRnNotPc_MUL_A1_instance_;
  ...
  const NamedDontCareInstRnRsRmNotPc_CMN_register_shifted_register_A1 DontCareInstRnRsRmNotPc_CMN_register_shifted_register_A1_instance_;
  const NamedDontCareInstRnRsRmNotPc_CMP_register_shifted_register_A1 DontCareInstRnRsRmNotPc_CMP_register_shifted_register_A1_instance_;
  const NamedDontCareInstRnRsRmNotPc_TEQ_register_shifted_register_A1 DontCareInstRnRsRmNotPc_TEQ_register_shifted_register_A1_instance_;
  const NamedDontCareInstRnRsRmNotPc_TST_register_shifted_register_A1 DontCareInstRnRsRmNotPc_TST_register_shifted_register_A1_instance_;
