...
class NamedArm32DecoderState : nacl_arm_dec::DecoderState {
 public:
  ...
  const NamedPreloadRegisterPairOpRAndRnNotPc_Pld_Rule_119_A1_P240 PreloadRegisterPairOpRAndRnNotPc_Pld_Rule_119_A1_P240_instance_;
  const NamedPreloadRegisterPairOpRAndRnNotPc_Pldw_Rule_119_A1_P240 PreloadRegisterPairOpRAndRnNotPc_Pldw_Rule_119_A1_P240_instance_;
