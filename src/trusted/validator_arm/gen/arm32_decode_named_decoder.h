...
class NamedArm32DecoderState : nacl_arm_dec::DecoderState {
 public:
  ...
  const NamedTest_None Test_None_instance_;
  ...
  const NamedImmediateBic_Bic_Rule_19_A1_P50 ImmediateBic_Bic_Rule_19_A1_P50_instance_;
  const NamedTestImmediate_Tst_Rule_230_A1_P454 TestImmediate_Tst_Rule_230_A1_P454_instance_;
 private:
