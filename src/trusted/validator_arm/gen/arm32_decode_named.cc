...
const char* NamedCoprocessorOp::name() const {
  return "CoprocessorOp";
}

const char* NamedImmediateBic::name() const {
  return "ImmediateBic";
}

const char* NamedLoadMultiple::name() const {
  return "LoadMultiple";
}

const char* NamedLoadCoprocessor::name() const {
  return "LoadCoprocessor";
}

const char* NamedLoadDoubleExclusive::name() const {
  return "LoadDoubleExclusive";
}

const char* NamedBranch::name() const {
  return "Branch";
}

const char* NamedTest::name() const {
  return "Test";
}

const char* NamedStoreRegister::name() const {
  return "StoreRegister";
}

const char* NamedMoveDoubleFromCoprocessor::name() const {
  return "MoveDoubleFromCoprocessor";
}

const char* NamedTestImmediate::name() const {
  return "TestImmediate";
}

const char* NamedBxBlx::name() const {
  return "BxBlx";
}

const char* NamedEffectiveNoOp::name() const {
  return "EffectiveNoOp";
}

const char* NamedLongMultiply::name() const {
  return "LongMultiply";
}

const char* NamedBinary4RegisterShiftedOp::name() const {
  return "Binary4RegisterShiftedOp";
}

const char* NamedBreakpoint::name() const {
  return "Breakpoint";
}

const char* NamedMultiply::name() const {
  return "Multiply";
}

const char* NamedPackSatRev::name() const {
  return "PackSatRev";
}

const char* NamedLoadExclusive::name() const {
  return "LoadExclusive";
}

const char* NamedVectorStore::name() const {
  return "VectorStore";
}

const char* NamedUnary3RegisterShiftedOp::name() const {
  return "Unary3RegisterShiftedOp";
}

const char* NamedUndefined::name() const {
  return "Undefined";
}

const char* NamedDataProc::name() const {
  return "DataProc";
}

const char* NamedDeprecated::name() const {
  return "Deprecated";
}

const char* NamedLoadImmediate::name() const {
  return "LoadImmediate";
}

const char* NamedStoreCoprocessor::name() const {
  return "StoreCoprocessor";
}

const char* NamedRoadblock::name() const {
  return "Roadblock";
}

const char* NamedLoadDoubleR::name() const {
  return "LoadDoubleR";
}

const char* NamedStoreExclusive::name() const {
  return "StoreExclusive";
}

const char* NamedStoreImmediate::name() const {
  return "StoreImmediate";
}

const char* NamedMoveFromCoprocessor::name() const {
  return "MoveFromCoprocessor";
}

const char* NamedLoadRegister::name() const {
  return "LoadRegister";
}

const char* NamedLoadDoubleI::name() const {
  return "LoadDoubleI";
}

const char* NamedBinary3RegisterShiftedTest::name() const {
  return "Binary3RegisterShiftedTest";
}

const char* NamedUnpredictable::name() const {
  return "Unpredictable";
}

const char* NamedForbidden::name() const {
  return "Forbidden";
}

const char* NamedVectorLoad::name() const {
  return "VectorLoad";
}

const char* NamedMoveToStatusRegister::name() const {
  return "MoveToStatusRegister";
}

const char* NamedSatAddSub::name() const {
  return "SatAddSub";
}
...
static inline const ClassDecoder &decode_ARMv7(
    const Instruction insn, const NamedArm32DecoderState *state);
...
const ClassDecoder &NamedArm32DecoderState::decode(const Instruction insn) const {
