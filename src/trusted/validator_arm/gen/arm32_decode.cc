     ...
     const Instruction insn) const
{
  ...
  if ((insn.Bits() & 0xF0000000) != 0xF0000000 /* cond(31:28)=~1111 */ &&
      ...
      (insn.Bits() & 0x00000010) == 0x00000000 /* op(4)=0 */) {
    return decode_load_store_word_and_unsigned_byte(insn);
  }

  if ((insn.Bits() & 0xF0000000) != 0xF0000000 /* cond(31:28)=~1111 */ &&
      (insn.Bits() & 0x0E000000) == 0x06000000 /* op1(27:25)=011 */ &&
      (insn.Bits() & 0x00000010) == 0x00000010 /* op(4)=1 */) {
     ...
     const Instruction insn) const
{
  ...
  if ((insn.Bits() & 0x02500000) == 0x00400000 /* op(25:20)=0xx1x0 */ &&
      (insn.Bits() & 0x00200000) == 0x00000000 /* $pattern(31:0)=xxxxxxxxxx0xxxxxxxxxxxxxxxxxxxxx */) {
    return Forbidden_instance_;
  }

  if ((insn.Bits() & 0x02500000) == 0x00500000 /* op(25:20)=0xx1x1 */ &&
      (insn.Bits() & 0x00008000) == 0x00000000 /* R(15)=0 */ &&
      (insn.Bits() & 0x00200000) == 0x00000000 /* $pattern(31:0)=xxxxxxxxxx0xxxxxxxxxxxxxxxxxxxxx */) {
    return Forbidden_instance_;
  }

  if ((insn.Bits() & 0x02500000) == 0x00500000 /* op(25:20)=0xx1x1 */ &&
      (insn.Bits() & 0x00008000) == 0x00008000 /* R(15)=1 */) {
    return Forbidden_instance_;
  }
     ...
     const Instruction insn) const
{
  ...
  if ((insn.Bits() & 0x00000E00) != 0x00000A00 /* coproc(11:8)=~101x */ &&
      (insn.Bits() & 0x03E00000) == 0x00400000 /* op1(25:20)=00010x */) {
    return Forbidden_instance_;
  }

  if ((insn.Bits() & 0x00000E00) != 0x00000A00 /* coproc(11:8)=~101x */ &&
      (insn.Bits() & 0x02100000) == 0x00000000 /* op1(25:20)=0xxxx0 */ &&
      (insn.Bits() & 0x03B00000) != 0x00000000 /* op1_repeated(25:20)=~000x00 */) {
    return Forbidden_instance_;
  }

  if ((insn.Bits() & 0x00000E00) != 0x00000A00 /* coproc(11:8)=~101x */ &&
      (insn.Bits() & 0x02100000) == 0x00100000 /* op1(25:20)=0xxxx1 */ &&
      (insn.Bits() & 0x03B00000) != 0x00100000 /* op1_repeated(25:20)=~000x01 */) {
    return Forbidden_instance_;
  }

  if ((insn.Bits() & 0x00000E00) != 0x00000A00 /* coproc(11:8)=~101x */ &&
      (insn.Bits() & 0x03000000) == 0x02000000 /* op1(25:20)=10xxxx */) {
    return Forbidden_instance_;
  }
  ...
  if ((insn.Bits() & 0x00000E00) == 0x00000A00 /* coproc(11:8)=101x */ &&
      (insn.Bits() & 0x02000000) == 0x00000000 /* op1(25:20)=0xxxxx */ &&
...
const ClassDecoder& Arm32DecoderState::decode_data_processing_and_miscellaneous_instructions(
     const Instruction insn) const
{
  if ((insn.Bits() & 0x02000000) == 0x00000000 /* op(25)=0 */ &&
  ...
  if ((insn.Bits() & 0x02000000) == 0x02000000 /* op(25)=1 */ &&
     ...
     const Instruction insn) const
{
  ...
  if ((insn.Bits() & 0x01A00000) == 0x01A00000 /* op(24:20)=11x1x */ &&
      (insn.Bits() & 0x000F0000) == 0x00000000 /* $pattern(31:0)=xxxxxxxxxxxx0000xxxxxxxxxxxxxxxx */) {
    return Defs12To15_instance_;
  }
     ...
     const Instruction insn) const
{
  ...
  if ((insn.Bits() & 0x01900000) == 0x00900000 /* opcode(24:20)=01xx1 */) {
    return LoadVectorRegisterList_instance_;
  }
     ...
     const Instruction insn) const
{
  ...
  if ((insn.Bits() & 0x00B00000) == 0x00900000 /* opc1(23:20)=1x01 */) {
    return VfpOp_instance_;
  }
  ...
  if ((insn.Bits() & 0x00300000) == 0x00200000 /* opc1(23:20)=xx10 */) {
    return VfpOp_instance_;
  }

  if ((insn.Bits() & 0x00A00000) == 0x00000000 /* opc1(23:20)=0x0x */) {
    return VfpOp_instance_;
  }
     ...
     const Instruction insn) const
{
  ...
  if ((insn.Bits() & 0x00600000) == 0x00200000 /* op1(22:21)=01 */ &&
      (insn.Bits() & 0x00000020) == 0x00000000 /* op(5)=0 */) {
    return Defs16To19CondsDontCareRdRaRmRnNotPc_instance_;
  }

  if ((insn.Bits() & 0x00600000) == 0x00200000 /* op1(22:21)=01 */ &&
      (insn.Bits() & 0x00000020) == 0x00000020 /* op(5)=1 */ &&
      (insn.Bits() & 0x0000F000) == 0x00000000 /* $pattern(31:0)=xxxxxxxxxxxxxxxx0000xxxxxxxxxxxx */) {
...
const ClassDecoder& Arm32DecoderState::decode_load_store_word_and_unsigned_byte(
     const Instruction insn) const
{
  if ((insn.Bits() & 0x02000000) == 0x00000000 /* A(25)=0 */ &&
      (insn.Bits() & 0x00500000) == 0x00000000 /* op1(24:20)=xx0x0 */ &&
  ...
  if ((insn.Bits() & 0x02000000) == 0x00000000 /* A(25)=0 */ &&
      (insn.Bits() & 0x00500000) == 0x00100000 /* op1(24:20)=xx0x1 */ &&
      (insn.Bits() & 0x000F0000) != 0x000F0000 /* Rn(19:16)=~1111 */ &&
      (insn.Bits() & 0x01700000) != 0x00300000 /* op1_repeated(24:20)=~0x011 */) {
    return LoadBasedImmedMemory_instance_;
  }
  ...
  if ((insn.Bits() & 0x02000000) == 0x00000000 /* A(25)=0 */ &&
      (insn.Bits() & 0x00500000) == 0x00400000 /* op1(24:20)=xx1x0 */ &&
      (insn.Bits() & 0x01700000) != 0x00600000 /* op1_repeated(24:20)=~0x110 */) {
    return StoreBasedImmedMemory_instance_;
  }
  ...
  if ((insn.Bits() & 0x02000000) == 0x02000000 /* A(25)=1 */ &&
      (insn.Bits() & 0x00500000) == 0x00000000 /* op1(24:20)=xx0x0 */ &&
      (insn.Bits() & 0x00000010) == 0x00000000 /* B(4)=0 */ &&
      (insn.Bits() & 0x01700000) != 0x00200000 /* op1_repeated(24:20)=~0x010 */) {
    return StoreBasedOffsetMemory_instance_;
  }
     ...
     const Instruction insn) const
{
  ...
  if ((insn.Bits() & 0x07F00000) == 0x01000000 /* op1(26:20)=0010000 */ &&
      ...
      (insn.Bits() & 0x000EFD0F) == 0x00000000 /* $pattern(31:0)=xxxxxxxxxxxx000x000000x0xxxx0000 */) {
    return Forbidden_instance_;
  }
  ...
  if ((insn.Bits() & 0x07F00000) == 0x01000000 /* op1(26:20)=0010000 */ &&
      ...
      (insn.Bits() & 0x0000FE00) == 0x00000000 /* $pattern(31:0)=xxxxxxxxxxxxxxxx0000000xxxxxxxxx */) {
    return Forbidden_instance_;
  }

  if ((insn.Bits() & 0x07F00000) == 0x05300000 /* op1(26:20)=1010011 */) {
  ...
  if ((insn.Bits() & 0x07F00000) == 0x05700000 /* op1(26:20)=1010111 */ &&
      ...
      (insn.Bits() & 0x000FFF0F) == 0x000FF00F /* $pattern(31:0)=xxxxxxxxxxxx111111110000xxxx1111 */) {
    return Forbidden_instance_;
  }

  if ((insn.Bits() & 0x07F00000) == 0x05700000 /* op1(26:20)=1010111 */ &&
      (insn.Bits() & 0x000000F0) == 0x00000060 /* op2(7:4)=0110 */ &&
      (insn.Bits() & 0x000FFF00) == 0x000FF000 /* $pattern(31:0)=xxxxxxxxxxxx111111110000xxxxxxxx */) {
    return InstructionBarrier_instance_;
  }

  if ((insn.Bits() & 0x07F00000) == 0x05700000 /* op1(26:20)=1010111 */ &&
      (insn.Bits() & 0x000000F0) == 0x00000070 /* op2(7:4)=0111 */) {
    return Unpredictable_instance_;
  }

  if ((insn.Bits() & 0x07F00000) == 0x05700000 /* op1(26:20)=1010111 */ &&
      (insn.Bits() & 0x000000E0) == 0x00000020 /* op2(7:4)=001x */) {
    return Unpredictable_instance_;
  }

  if ((insn.Bits() & 0x07F00000) == 0x05700000 /* op1(26:20)=1010111 */ &&
      (insn.Bits() & 0x000000E0) == 0x00000040 /* op2(7:4)=010x */ &&
      (insn.Bits() & 0x000FFF00) == 0x000FF000 /* $pattern(31:0)=xxxxxxxxxxxx111111110000xxxxxxxx */) {
    return DataBarrier_instance_;
  }

  if ((insn.Bits() & 0x07F00000) == 0x05700000 /* op1(26:20)=1010111 */ &&
      (insn.Bits() & 0x00000080) == 0x00000080 /* op2(7:4)=1xxx */) {
    return Unpredictable_instance_;
  }
  ...
  if ((insn.Bits() & 0x07700000) == 0x06100000 /* op1(26:20)=110x001 */ &&
      (insn.Bits() & 0x00000010) == 0x00000000 /* op2(7:4)=xxx0 */) {
    return Forbidden_instance_;
  }
  ...
  if ((insn.Bits() & 0x07B00000) == 0x05B00000 /* op1(26:20)=1011x11 */) {
    return Unpredictable_instance_;
  }

  if ((insn.Bits() & 0x07300000) == 0x04300000 /* op1(26:20)=100xx11 */) {
    return Unpredictable_instance_;
  }

  if ((insn.Bits() & 0x07300000) == 0x05100000 /* op1(26:20)=101xx01 */ &&
      (insn.Bits() & 0x000F0000) != 0x000F0000 /* Rn(19:16)=~1111 */ &&
      (insn.Bits() & 0x0000F000) == 0x0000F000 /* $pattern(31:0)=xxxxxxxxxxxxxxxx1111xxxxxxxxxxxx */) {
    return DontCareInst_instance_;
  }

  if ((insn.Bits() & 0x07300000) == 0x07100000 /* op1(26:20)=111xx01 */ &&
      (insn.Bits() & 0x00000010) == 0x00000000 /* op2(7:4)=xxx0 */ &&
      (insn.Bits() & 0x0000F000) == 0x0000F000 /* $pattern(31:0)=xxxxxxxxxxxxxxxx1111xxxxxxxxxxxx */) {
     ...
     const Instruction insn) const
{
  if ((insn.Bits() & 0x00000070) == 0x00000000 /* op2(6:4)=000 */ &&
      (insn.Bits() & 0x00000200) == 0x00000000 /* B(9)=0 */ &&
  ...
  if ((insn.Bits() & 0x00000070) == 0x00000000 /* op2(6:4)=000 */ &&
      (insn.Bits() & 0x00000200) == 0x00000200 /* B(9)=1 */ &&
      (insn.Bits() & 0x00200000) == 0x00000000 /* op(22:21)=x0 */ &&
  ...
  if ((insn.Bits() & 0x00000050) == 0x00000010 /* op2(6:4)=0x1 */ &&
      (insn.Bits() & 0x00600000) == 0x00200000 /* op(22:21)=01 */ &&
      (insn.Bits() & 0x000FFF00) == 0x000FFF00 /* $pattern(31:0)=xxxxxxxxxxxx111111111111xxxxxxxx */) {
...
{
  UNREFERENCED_PARAMETER(insn);
  if ((insn.Bits() & 0x00400000) == 0x00000000 /* op(22)=0 */ &&
  ...
  if ((insn.Bits() & 0x00400000) == 0x00000000 /* op(22)=0 */ &&
      (insn.Bits() & 0x000F0000) == 0x00000000 /* op1(19:16)=0000 */ &&
      (insn.Bits() & 0x000000FE) == 0x00000000 /* op2(7:0)=0000000x */ &&
      (insn.Bits() & 0x0000FF00) == 0x0000F000 /* $pattern(31:0)=xxxxxxxxxxxxxxxx11110000xxxxxxxx */) {
    return DontCareInst_instance_;
  }
  ...
  if ((insn.Bits() & 0x00400000) == 0x00400000 /* op(22)=1 */ &&
      (insn.Bits() & 0x0000F000) == 0x0000F000 /* $pattern(31:0)=xxxxxxxxxxxxxxxx1111xxxxxxxxxxxx */) {
    return Forbidden_instance_;
  }
     ...
     const Instruction insn) const
{
  ...
  if ((insn.Bits() & 0x000F0000) == 0x00050000 /* opc2(19:16)=0101 */ &&
      (insn.Bits() & 0x00000040) == 0x00000040 /* opc3(7:6)=x1 */ &&
      (insn.Bits() & 0x0000002F) == 0x00000000 /* $pattern(31:0)=xxxxxxxxxxxxxxxxxxxxxxxxxx0x0000 */) {
    return VfpOp_instance_;
  }
  ...
  if ((insn.Bits() & 0x000B0000) == 0x00000000 /* opc2(19:16)=0x00 */ &&
      (insn.Bits() & 0x00000040) == 0x00000040 /* opc3(7:6)=x1 */) {
    return VfpOp_instance_;
  }
  ...
  if ((insn.Bits() & 0x000E0000) == 0x00020000 /* opc2(19:16)=001x */ &&
      (insn.Bits() & 0x00000040) == 0x00000040 /* opc3(7:6)=x1 */ &&
      (insn.Bits() & 0x00000100) == 0x00000000 /* $pattern(31:0)=xxxxxxxxxxxxxxxxxxxxxxx0xxxxxxxx */) {
    return VfpOp_instance_;
  }
  ...
  if ((insn.Bits() & 0x000A0000) == 0x000A0000 /* opc2(19:16)=1x1x */ &&
      (insn.Bits() & 0x00000040) == 0x00000040 /* opc3(7:6)=x1 */) {
    return VfpOp_instance_;
  }

  if ((insn.Bits() & 0x00000040) == 0x00000000 /* opc3(7:6)=x0 */ &&
      (insn.Bits() & 0x000000A0) == 0x00000000 /* $pattern(31:0)=xxxxxxxxxxxxxxxxxxxxxxxx0x0xxxxx */) {
    return VfpOp_instance_;
  }
     ...
     const Instruction insn) const
{
  ...
  if ((insn.Bits() & 0x00300000) == 0x00200000 /* op1(22:20)=x10 */ &&
  ...
  if ((insn.Bits() & 0x00300000) == 0x00300000 /* op1(22:20)=x11 */ &&
      (insn.Bits() & 0x00000060) == 0x00000020 /* op2(7:5)=x01 */ &&
      (insn.Bits() & 0x000F0F00) == 0x000F0F00 /* $pattern(31:0)=xxxxxxxxxxxx1111xxxx1111xxxxxxxx */) {
    return Defs12To15CondsDontCareRdRnNotPc_instance_;
  }
...
{
  UNREFERENCED_PARAMETER(insn);
  if ((insn.Bits() & 0x00000F00) == 0x00000000 /* $pattern(31:0)=xxxxxxxxxxxxxxxxxxxx0000xxxxxxxx */) {
    return Defs12To15CondsDontCareRnRdRmNotPc_instance_;
  }
     ...
     const Instruction insn) const
{
  ...
  if ((insn.Bits() & 0x00B00000) == 0x00800000 /* op(23:20)=1x00 */ &&
      (insn.Bits() & 0x00000F00) == 0x00000F00 /* $pattern(31:0)=xxxxxxxxxxxxxxxxxxxx1111xxxxxxxx */) {
    return StoreBasedMemoryRtBits0To3_instance_;
  }

  if ((insn.Bits() & 0x00B00000) == 0x00900000 /* op(23:20)=1x01 */ &&
      (insn.Bits() & 0x00000F0F) == 0x00000F0F /* $pattern(31:0)=xxxxxxxxxxxxxxxxxxxx1111xxxx1111 */) {
    return LoadBasedMemory_instance_;
  }
...
{
  UNREFERENCED_PARAMETER(insn);
  if ((insn.Bits() & 0x00000100) == 0x00000000 /* C(8)=0 */ &&
  ...
  if ((insn.Bits() & 0x00100000) == 0x00000000 /* L(20)=0 */ &&
      (insn.Bits() & 0x00000100) == 0x00000000 /* C(8)=0 */ &&
  ...
  if ((insn.Bits() & 0x00100000) == 0x00000000 /* L(20)=0 */ &&
      (insn.Bits() & 0x00000100) == 0x00000100 /* C(8)=1 */ &&
  ...
  if ((insn.Bits() & 0x00100000) == 0x00100000 /* L(20)=1 */ &&
      (insn.Bits() & 0x00000100) == 0x00000000 /* C(8)=0 */ &&
      (insn.Bits() & 0x00E00000) == 0x00E00000 /* A(23:21)=111 */ &&
      (insn.Bits() & 0x000F00EF) == 0x00010000 /* $pattern(31:0)=xxxxxxxxxxxx0001xxxxxxxx000x0000 */) {
     ...
     const Instruction insn) const
{
  ...
  if ((insn.Bits() & 0x0E500000) == 0x08100000 /* op1(27:20)=100xx0x1 */ &&
      (insn.Bits() & 0x0000FFFF) == 0x00000A00 /* $pattern(31:0)=xxxxxxxxxxxxxxxx0000101000000000 */) {
    return Forbidden_instance_;
  }

  if ((insn.Bits() & 0x0E500000) == 0x08400000 /* op1(27:20)=100xx1x0 */ &&
      (insn.Bits() & 0x000FFFE0) == 0x000D0500 /* $pattern(31:0)=xxxxxxxxxxxx110100000101000xxxxx */) {
    return Forbidden_instance_;
  }

  if ((insn.Bits() & 0x0E100000) == 0x0C000000 /* op1(27:20)=110xxxx0 */ &&
      (insn.Bits() & 0x0FB00000) != 0x0C000000 /* op1_repeated(27:20)=~11000x00 */) {
    return Forbidden_instance_;
  }

  if ((insn.Bits() & 0x0E100000) == 0x0C100000 /* op1(27:20)=110xxxx1 */ &&
      (insn.Bits() & 0x0FB00000) != 0x0C100000 /* op1_repeated(27:20)=~11000x01 */) {
    return Forbidden_instance_;
  }
  ...
  if ((insn.Bits() & 0x08000000) == 0x00000000 /* op1(27:20)=0xxxxxxx */) {
    return decode_memory_hints_advanced_simd_instructions_and_miscellaneous_instructions(insn);
  }
