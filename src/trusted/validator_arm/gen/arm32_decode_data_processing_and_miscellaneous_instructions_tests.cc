...
//    = ForbiddenCondDecoder {constraints: }
class UnsafeCondDecoderTesterCase15
    : public UnsafeCondDecoderTester {
 public:
  UnsafeCondDecoderTesterCase15(const NamedClassDecoder& decoder)
    : UnsafeCondDecoderTester(decoder) {}
  virtual bool PassesParsePreconditions(
      nacl_arm_dec::Instruction inst,
      const NamedClassDecoder& decoder);
...
bool UnsafeCondDecoderTesterCase15
::PassesParsePreconditions(
     nacl_arm_dec::Instruction inst,
     const NamedClassDecoder& decoder) {
...
//    = ForbiddenCondDecoder {constraints: }
class UnsafeCondDecoderTesterCase16
    : public UnsafeCondDecoderTester {
 public:
  UnsafeCondDecoderTesterCase16(const NamedClassDecoder& decoder)
    : UnsafeCondDecoderTester(decoder) {}
  virtual bool PassesParsePreconditions(
      nacl_arm_dec::Instruction inst,
      const NamedClassDecoder& decoder);
...
bool UnsafeCondDecoderTesterCase16
::PassesParsePreconditions(
     nacl_arm_dec::Instruction inst,
     const NamedClassDecoder& decoder) {
...
//    = Unary1RegisterImmediateOp {constraints: ,
//     safety: [Rd(15:12)=1111 => UNPREDICTABLE]}
class Unary1RegisterImmediateOpTesterCase18
    : public Unary1RegisterImmediateOpTester {
 public:
  Unary1RegisterImmediateOpTesterCase18(const NamedClassDecoder& decoder)
    : Unary1RegisterImmediateOpTester(decoder) {}
  virtual bool PassesParsePreconditions(
      nacl_arm_dec::Instruction inst,
      const NamedClassDecoder& decoder);
...
bool Unary1RegisterImmediateOpTesterCase18
::PassesParsePreconditions(
     nacl_arm_dec::Instruction inst,
     const NamedClassDecoder& decoder) {
...
//    = ForbiddenCondDecoder {constraints: ,
//     rule: extra_load_store_instructions_unpriviledged}
class ForbiddenCondDecoderTester_Case15
    : public UnsafeCondDecoderTesterCase15 {
 public:
  ForbiddenCondDecoderTester_Case15()
    : UnsafeCondDecoderTesterCase15(
...
//    = ForbiddenCondDecoder {constraints: ,
//     rule: extra_load_store_instructions_unpriviledged}
class ForbiddenCondDecoderTester_Case16
    : public UnsafeCondDecoderTesterCase16 {
 public:
  ForbiddenCondDecoderTester_Case16()
    : UnsafeCondDecoderTesterCase16(
      state_.ForbiddenCondDecoder_extra_load_store_instructions_unpriviledged_instance_)
  {}
};
...
//     rule: Mov_Rule_99_A1_P200,
//     safety: [Rd(15:12)=1111 => UNPREDICTABLE]}
class Unary1RegisterImmediateOpTester_Case18
    : public Unary1RegisterImmediateOpTesterCase18 {
 public:
  Unary1RegisterImmediateOpTester_Case18()
    : Unary1RegisterImmediateOpTesterCase18(
...
//     rule: extra_load_store_instructions_unpriviledged}
TEST_F(Arm32DecoderStateTests,
       ForbiddenCondDecoderTester_Case15_TestCase15) {
  ForbiddenCondDecoderTester_Case15 baseline_tester;
...
//     rule: extra_load_store_instructions_unpriviledged}
TEST_F(Arm32DecoderStateTests,
       ForbiddenCondDecoderTester_Case16_TestCase16) {
  ForbiddenCondDecoderTester_Case16 baseline_tester;
  NamedForbidden_extra_load_store_instructions_unpriviledged actual;
  ActualVsBaselineTester a_vs_b_tester(actual, baseline_tester);
...
//     safety: [Rd(15:12)=1111 => UNPREDICTABLE]}
TEST_F(Arm32DecoderStateTests,
       Unary1RegisterImmediateOpTester_Case18_TestCase18) {
  Unary1RegisterImmediateOpTester_Case18 baseline_tester;
