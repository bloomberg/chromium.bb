...
// TODO(kschimpf): Replace uses of these in ProblemSink with the
// notion of a nacl_arm_dec::Violation.
typedef enum {
  ...
  // Other diagnostic message (specified in armv7.table).
  kProblemOtherDiagnosticMessage,
