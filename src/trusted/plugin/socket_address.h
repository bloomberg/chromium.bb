...
#ifndef NATIVE_CLIENT_SRC_TRUSTED_PLUGIN_SOCKET_ADDRESS_H_
#define NATIVE_CLIENT_SRC_TRUSTED_PLUGIN_SOCKET_ADDRESS_H_
...
#endif  // NATIVE_CLIENT_SRC_TRUSTED_PLUGIN_SOCKET_ADDRESS_H_
