...
static const NaClOp g_Operands[734] = {
  ...
  /* 240 */ { RegAL, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%al" },
  /* 241 */ { RegDX, NACL_OPFLAG(OpUse), "%dx" },
  /* 242 */ { RegREAX, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$rAXv" },
  /* 243 */ { RegDX, NACL_OPFLAG(OpUse), "%dx" },
  /* 244 */ { RegDX, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%dx" },
  /* 245 */ { RegAL, NACL_OPFLAG(OpUse), "%al" },
  /* 246 */ { RegDX, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%dx" },
  ...
  /* 267 */ { E_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Mw/Rv" },
  ...
  /* 283 */ { M_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Ms" },
  ...
  /* 294 */ { Xmm_E_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Wps" },
  /* 295 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse), "$Vps" },
  /* 296 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Vps" },
  /* 297 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$VRq" },
  /* 298 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Vps" },
  /* 299 */ { Mo_Operand, NACL_OPFLAG(OpUse), "$Mq" },
  /* 300 */ { Mo_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Mq" },
  /* 301 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse), "$Vps" },
  /* 302 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Vps" },
  /* 303 */ { Xmm_Eo_Operand, NACL_OPFLAG(OpUse), "$Wq" },
  /* 304 */ { Eo_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Rd/q" },
  /* 305 */ { C_Operand, NACL_OPFLAG(OpUse), "$Cd/q" },
  /* 306 */ { Eo_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Rd/q" },
  /* 307 */ { D_Operand, NACL_OPFLAG(OpUse), "$Dd/q" },
  /* 308 */ { C_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Cd/q" },
  /* 309 */ { Eo_Operand, NACL_OPFLAG(OpUse), "$Rd/q" },
  /* 310 */ { D_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Dd/q" },
  /* 311 */ { Eo_Operand, NACL_OPFLAG(OpUse), "$Rd/q" },
  /* 312 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Vps" },
  /* 313 */ { Mmx_E_Operand, NACL_OPFLAG(OpUse), "$Qq" },
  /* 314 */ { Mdq_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Mdq" },
  /* 315 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse), "$Vps" },
  /* 316 */ { Mmx_G_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Pq" },
  ...
  /* 340 */ { G_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Gv" },
  /* 341 */ { E_Operand, NACL_OPFLAG(OpUse), "$Ev" },
  /* 342 */ { Gv_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Gd" },
  /* 343 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$VRps" },
  /* 344 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Vps" },
  /* 345 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wps" },
  /* 346 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Vpd" },
  /* 347 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wps" },
  /* 348 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Vps" },
  /* 349 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wdq" },
  /* 350 */ { Mmx_G_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Pq" },
  /* 351 */ { Mmx_E_Operand, NACL_OPFLAG(OpUse), "$Qq" },
  /* 352 */ { Mmx_G_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Pq" },
  /* 353 */ { Mmx_E_Operand, NACL_OPFLAG(OpUse), "$Qd" },
  /* 354 */ { Mmx_G_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Pq" },
  /* 355 */ { E_Operand, NACL_OPFLAG(OpUse), "$Ed/q/q" },
  /* 356 */ { Mmx_G_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest) | NACL_OPFLAG(OperandZeroExtends_v), "$Pq" },
  /* 357 */ { E_Operand, NACL_OPFLAG(OpUse), "$Ed/q/d" },
  /* 358 */ { Mmx_G_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Pq" },
  /* 359 */ { Mmx_E_Operand, NACL_OPFLAG(OpUse), "$Qq" },
  /* 360 */ { Mmx_G_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Pq" },
  /* 361 */ { Mmx_E_Operand, NACL_OPFLAG(OpUse), "$Qq" },
  /* 362 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 363 */ { Mmx_E_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$PRq" },
  /* 364 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 365 */ { E_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Ed/q/q" },
  /* 366 */ { Mmx_G_Operand, NACL_OPFLAG(OpUse), "$Pd/q/q" },
  /* 367 */ { E_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest) | NACL_OPFLAG(OperandZeroExtends_v), "$Ed/q/d" },
  /* 368 */ { Mmx_G_Operand, NACL_OPFLAG(OpUse), "$Pd/q/d" },
  /* 369 */ { Mmx_E_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Qq" },
  ...
  /* 374 */ { RegFS, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%fs" },
  ...
  /* 379 */ { E_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Ev" },
  ...
  /* 388 */ { RegGS, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%gs" },
  /* 389 */ { E_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Ev" },
  ...
  /* 396 */ { E_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Eb" },
  ...
  /* 399 */ { E_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Ev" },
  ...
  /* 403 */ { G_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest) | NACL_OPFLAG(OperandZeroExtends_v), "$Gv" },
  /* 404 */ { Eb_Operand, NACL_OPFLAG(OpUse), "$Eb" },
  /* 405 */ { G_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest) | NACL_OPFLAG(OperandZeroExtends_v), "$Gv" },
  /* 406 */ { Ew_Operand, NACL_OPFLAG(OpUse), "$Ew" },
  /* 407 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Vps" },
  /* 408 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wps" },
  /* 409 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 410 */ { M_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Md/q" },
  /* 411 */ { G_Operand, NACL_OPFLAG(OpUse), "$Gd/q" },
  /* 412 */ { Mmx_G_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Pq" },
  /* 413 */ { E_Operand, NACL_OPFLAG(OpUse), "$Rd/q/Mw" },
  /* 414 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 415 */ { Gv_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Gd" },
  ...
  /* 420 */ { Mdq_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Mdq" },
  ...
  /* 424 */ { G_OpcodeBase, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$r8v" },
  ...
  /* 521 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest) | NACL_OPFLAG(OperandZeroExtends_v), "$Vdq" },
  /* 522 */ { E_Operand, NACL_OPFLAG(OpUse), "$Ed/q/d" },
  /* 523 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Vdq" },
  /* 524 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wdq" },
  /* 525 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 526 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$VRdq" },
  /* 527 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 528 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest) | NACL_OPFLAG(AllowGOperandWithOpcodeInModRm), "$Vdq" },
  /* 529 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 530 */ { I2_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 531 */ { E_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Ed/q/q" },
  /* 532 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse), "$Vd/q/q" },
  /* 533 */ { E_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest) | NACL_OPFLAG(OperandZeroExtends_v), "$Ed/q/d" },
  /* 534 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse), "$Vd/q/d" },
  /* 535 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Vpd" },
  ...
  /* 541 */ { Gv_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Gd" },
  /* 542 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$VRdq" },
  /* 543 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 544 */ { Xmm_Eo_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Wq" },
  /* 545 */ { Xmm_Go_Operand, NACL_OPFLAG(OpUse), "$Vq" },
  /* 546 */ { Xmm_Go_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Vq" },
  /* 547 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wdq" },
  /* 548 */ { Mdq_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Mdq" },
  ...
  /* 553 */ { G_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Gv" },
  /* 554 */ { M_Operand, NACL_OPFLAG(OpUse), "$Mv" },
  /* 555 */ { M_Operand, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "$Mv" },
  ...
  /* 639 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st0" },
  /* 640 */ { RegST3, NACL_OPFLAG(OpUse), "%st3" },
  /* 641 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st0" },
  /* 642 */ { RegST4, NACL_OPFLAG(OpUse), "%st4" },
  /* 643 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st0" },
  /* 644 */ { RegST5, NACL_OPFLAG(OpUse), "%st5" },
  /* 645 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st0" },
  /* 646 */ { RegST6, NACL_OPFLAG(OpUse), "%st6" },
  /* 647 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st0" },
  ...
  /* 671 */ { RegST0, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st0" },
  /* 672 */ { RegST3, NACL_OPFLAG(OpUse), "%st3" },
  /* 673 */ { RegST0, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st0" },
  /* 674 */ { RegST4, NACL_OPFLAG(OpUse), "%st4" },
  /* 675 */ { RegST0, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st0" },
  /* 676 */ { RegST5, NACL_OPFLAG(OpUse), "%st5" },
  /* 677 */ { RegST0, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st0" },
  /* 678 */ { RegST6, NACL_OPFLAG(OpUse), "%st6" },
  /* 679 */ { RegST0, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st0" },
  ...
  /* 684 */ { RegST1, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st1" },
  /* 685 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st0" },
  /* 686 */ { RegST2, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st2" },
  /* 687 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st0" },
  /* 688 */ { RegST3, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st3" },
  /* 689 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st0" },
  /* 690 */ { RegST4, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st4" },
  /* 691 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st0" },
  /* 692 */ { RegST5, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st5" },
  /* 693 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st0" },
  /* 694 */ { RegST6, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st6" },
  /* 695 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st0" },
  /* 696 */ { RegST7, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st7" },
  /* 697 */ { RegST1, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st1" },
  /* 698 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 699 */ { RegST2, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st2" },
  /* 700 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 701 */ { RegST3, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st3" },
  /* 702 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 703 */ { RegST4, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st4" },
  /* 704 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 705 */ { RegST5, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st5" },
  /* 706 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 707 */ { RegST6, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st6" },
  /* 708 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 709 */ { RegST7, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st7" },
  ...
  /* 719 */ { RegST1, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st1" },
  /* 720 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 721 */ { RegST2, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st2" },
  /* 722 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 723 */ { RegST3, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st3" },
  /* 724 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 725 */ { RegST4, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st4" },
  /* 726 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 727 */ { RegST5, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st5" },
  /* 728 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 729 */ { RegST6, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st6" },
  /* 730 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 731 */ { RegST7, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%st7" },
  /* 732 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 733 */ { RegAX, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpDest), "%ax" },
};
...
static const NaClPrefixOpcodeArrayOffset g_LookupTable[2543] = {
  ...
  /*   230 */ 335, 336, 337, 338, NACL_OPCODE_NULL_OFFSET, 339, 340, 341, 342, 343, 
