...
static const NaClOp g_Operands[720] = {
  ...
  /* 140 */ { RegES_EDI, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpImplicit), "{$Yb}" },
  /* 141 */ { RegDS_ESI, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpImplicit), "{$Xb}" },
  /* 142 */ { RegES_EDI, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpImplicit), "{$Yvd}" },
  /* 143 */ { RegDS_ESI, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpImplicit), "{$Xvd}" },
  /* 144 */ { RegES_EDI, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpImplicit), "{$Yvw}" },
  /* 145 */ { RegDS_ESI, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpImplicit), "{$Xvw}" },
  /* 146 */ { RegES_EDI, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpImplicit), "{$Yb}" },
  /* 147 */ { RegDS_ESI, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpImplicit), "{$Xb}" },
  /* 148 */ { RegES_EDI, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpImplicit), "{$Yvd}" },
  /* 149 */ { RegDS_ESI, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpImplicit), "{$Xvd}" },
  /* 150 */ { RegES_EDI, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpImplicit), "{$Yvw}" },
  /* 151 */ { RegDS_ESI, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpImplicit), "{$Xvw}" },
  /* 152 */ { RegES_EDI, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpImplicit), "{$Yb}" },
  /* 153 */ { RegAL, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpImplicit), "{%al}" },
  /* 154 */ { RegES_EDI, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpImplicit), "{$Yvd}" },
  /* 155 */ { RegEAX, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpImplicit), "{$rAXvd}" },
  /* 156 */ { RegES_EDI, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpImplicit), "{$Yvw}" },
  /* 157 */ { RegAX, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpImplicit), "{$rAXvw}" },
  /* 158 */ { RegAL, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpImplicit), "{%al}" },
  /* 159 */ { RegDS_ESI, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpImplicit), "{$Xb}" },
  /* 160 */ { RegEAX, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpImplicit), "{$rAXvd}" },
  /* 161 */ { RegDS_ESI, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpImplicit), "{$Xvd}" },
  /* 162 */ { RegAX, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpImplicit), "{$rAXvw}" },
  /* 163 */ { RegDS_ESI, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpImplicit), "{$Xvw}" },
  /* 164 */ { RegAL, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpImplicit), "{%al}" },
  /* 165 */ { RegES_EDI, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpImplicit), "{$Yb}" },
  /* 166 */ { RegEAX, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpImplicit), "{$rAXvd}" },
  /* 167 */ { RegES_EDI, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpImplicit), "{$Yvd}" },
  /* 168 */ { RegAX, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpImplicit), "{$rAXvw}" },
  /* 169 */ { RegES_EDI, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpImplicit), "{$Yvw}" },
  ...
  /* 421 */ { Mo_Operand, NACL_OPFLAG(OpSet), "$Mq" },
  /* 422 */ { Mmx_G_Operand, NACL_OPFLAG(OpUse), "$Pq" },
  /* 423 */ { RegDS_EDI, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpImplicit), "{$Zvd}" },
  /* 424 */ { Mmx_G_Operand, NACL_OPFLAG(OpUse), "$Pq" },
  /* 425 */ { Mmx_E_Operand, NACL_OPFLAG(OpUse), "$PRq" },
  /* 426 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vsd" },
  /* 427 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wsd" },
  /* 428 */ { Xmm_E_Operand, NACL_OPFLAG(OpSet), "$Wsd" },
  /* 429 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse), "$Vsd" },
  /* 430 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vpd" },
  /* 431 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wsd" },
  /* 432 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vsd" },
  /* 433 */ { E_Operand, NACL_OPFLAG(OpUse), "$Ed/q" },
  /* 434 */ { Mo_Operand, NACL_OPFLAG(OpSet), "$Mq" },
  /* 435 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse), "$Vsd" },
  /* 436 */ { G_Operand, NACL_OPFLAG(OpSet), "$Gd/q" },
  /* 437 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wsd" },
  /* 438 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "$Vsd" },
  /* 439 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wsd" },
  /* 440 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vss" },
  /* 441 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wsd" },
  /* 442 */ { Xmm_Go_Operand, NACL_OPFLAG(OpSet), "$Vq" },
  /* 443 */ { Xmm_Eo_Operand, NACL_OPFLAG(OpUse), "$Wq" },
  /* 444 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 445 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "$Vdq" },
  /* 446 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$VRq" },
  /* 447 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 448 */ { I2_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 449 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "$Vdq" },
  /* 450 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$VRdq" },
  /* 451 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "$Vsd" },
  /* 452 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wsd" },
  /* 453 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 454 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "$Vpd" },
  /* 455 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wpd" },
  /* 456 */ { Mmx_G_Operand, NACL_OPFLAG(OpSet), "$Pq" },
  /* 457 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$VRq" },
  /* 458 */ { Xmm_Go_Operand, NACL_OPFLAG(OpSet), "$Vq" },
  /* 459 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wpd" },
  /* 460 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vdq" },
  /* 461 */ { Mdq_Operand, NACL_OPFLAG(OpUse), "$Mdq" },
  /* 462 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vss" },
  /* 463 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wss" },
  /* 464 */ { Xmm_E_Operand, NACL_OPFLAG(OpSet), "$Wss" },
  /* 465 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse), "$Vss" },
  /* 466 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vss" },
  /* 467 */ { E_Operand, NACL_OPFLAG(OpUse), "$Ed/q" },
  /* 468 */ { Mv_Operand, NACL_OPFLAG(OpSet), "$Md" },
  /* 469 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse), "$Vss" },
  /* 470 */ { G_Operand, NACL_OPFLAG(OpSet), "$Gd/q" },
  /* 471 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wss" },
  /* 472 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "$Vss" },
  /* 473 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wss" },
  /* 474 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vsd" },
  /* 475 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wss" },
  /* 476 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vdq" },
  /* 477 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wps" },
  /* 478 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vdq" },
  /* 479 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wdq" },
  /* 480 */ { Xmm_E_Operand, NACL_OPFLAG(OpSet), "$Wdq" },
  /* 481 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse), "$Vdq" },
  /* 482 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "$Vss" },
  /* 483 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wss" },
  /* 484 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 485 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vdq" },
  /* 486 */ { Mmx_E_Operand, NACL_OPFLAG(OpUse), "$PRq" },
  /* 487 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vpd" },
  /* 488 */ { Xmm_Eo_Operand, NACL_OPFLAG(OpUse), "$Wq" },
  /* 489 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vpd" },
  /* 490 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wpd" },
  /* 491 */ { Xmm_E_Operand, NACL_OPFLAG(OpSet), "$Wpd" },
  /* 492 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse), "$Vpd" },
  /* 493 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vsd" },
  /* 494 */ { Mo_Operand, NACL_OPFLAG(OpUse), "$Mq" },
  /* 495 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "$Vpd" },
  /* 496 */ { Xmm_Eo_Operand, NACL_OPFLAG(OpUse), "$Wq" },
  /* 497 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vpd" },
  /* 498 */ { Mmx_E_Operand, NACL_OPFLAG(OpUse), "$Qq" },
  /* 499 */ { Mdq_Operand, NACL_OPFLAG(OpSet), "$Mdq" },
  /* 500 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse), "$Vpd" },
  /* 501 */ { Mmx_G_Operand, NACL_OPFLAG(OpSet), "$Pq" },
  /* 502 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wpd" },
  /* 503 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse), "$Vsd" },
  /* 504 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wsd" },
  /* 505 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse), "$Vpd" },
  /* 506 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wsd" },
  /* 507 */ { Gv_Operand, NACL_OPFLAG(OpSet), "$Gd" },
  /* 508 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$VRpd" },
  /* 509 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vps" },
  /* 510 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wpd" },
  /* 511 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "$Vdq" },
  /* 512 */ { Xmm_Eo_Operand, NACL_OPFLAG(OpUse), "$Wq" },
  /* 513 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "$Vdq" },
  /* 514 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wdq" },
  /* 515 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vdq" },
  /* 516 */ { E_Operand, NACL_OPFLAG(OpUse), "$Ed/q/d" },
  /* 517 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vdq" },
  /* 518 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wdq" },
  /* 519 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 520 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "$VRdq" },
  /* 521 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 522 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet) | NACL_OPFLAG(AllowGOperandWithOpcodeInModRm), "$Vdq" },
  /* 523 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 524 */ { I2_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 525 */ { E_Operand, NACL_OPFLAG(OpSet), "$Ed/q/d" },
  /* 526 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse), "$Vd/q/d" },
  /* 527 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "$Vpd" },
  /* 528 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wpd" },
  /* 529 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 530 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vdq" },
  /* 531 */ { E_Operand, NACL_OPFLAG(OpUse), "$Rd/q/Mw" },
  /* 532 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 533 */ { Gv_Operand, NACL_OPFLAG(OpSet), "$Gd" },
  /* 534 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$VRdq" },
  /* 535 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 536 */ { Xmm_Eo_Operand, NACL_OPFLAG(OpSet), "$Wq" },
  /* 537 */ { Xmm_Go_Operand, NACL_OPFLAG(OpUse), "$Vq" },
  /* 538 */ { Xmm_Go_Operand, NACL_OPFLAG(OpSet), "$Vq" },
  /* 539 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wdq" },
  /* 540 */ { Mdq_Operand, NACL_OPFLAG(OpSet), "$Mdq" },
  /* 541 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse), "$Vdq" },
  /* 542 */ { RegDS_EDI, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpImplicit), "{$Zvd}" },
  /* 543 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse), "$Vdq" },
  /* 544 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$VRdq" },
  /* 545 */ { G_Operand, NACL_OPFLAG(OpSet), "$Gv" },
  /* 546 */ { M_Operand, NACL_OPFLAG(OpUse), "$Mv" },
  /* 547 */ { M_Operand, NACL_OPFLAG(OpSet), "$Mv" },
  /* 548 */ { G_Operand, NACL_OPFLAG(OpUse), "$Gv" },
  /* 549 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vdq" },
  /* 550 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wdq" },
  /* 551 */ { RegXMM0, NACL_OPFLAG(OpUse), "%xmm0" },
  /* 552 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse), "$Vdq" },
  /* 553 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wdq" },
  /* 554 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vdq" },
  /* 555 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Udq/Mq" },
  /* 556 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vdq" },
  /* 557 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Udq/Md" },
  /* 558 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vdq" },
  /* 559 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Udq/Mw" },
  /* 560 */ { Gv_Operand, NACL_OPFLAG(OpUse), "$Gd" },
  /* 561 */ { Mdq_Operand, NACL_OPFLAG(OpUse), "$Mdq" },
  /* 562 */ { Gv_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "$Gd" },
  /* 563 */ { E_Operand, NACL_OPFLAG(OpUse), "$Eb" },
  /* 564 */ { Gv_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "$Gd" },
  /* 565 */ { E_Operand, NACL_OPFLAG(OpUse), "$Ev" },
  /* 566 */ { Mmx_G_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "$Pq" },
  /* 567 */ { Mmx_E_Operand, NACL_OPFLAG(OpUse), "$Qq" },
  /* 568 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 569 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vss" },
  /* 570 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wss" },
  /* 571 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 572 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vsd" },
  /* 573 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wsd" },
  /* 574 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 575 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "$Vdq" },
  /* 576 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wdq" },
  /* 577 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 578 */ { Ev_Operand, NACL_OPFLAG(OpSet), "$Rd/Mb" },
  /* 579 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse), "$Vdq" },
  /* 580 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 581 */ { Ev_Operand, NACL_OPFLAG(OpSet), "$Rd/Mw" },
  /* 582 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse), "$Vdq" },
  /* 583 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 584 */ { E_Operand, NACL_OPFLAG(OpSet), "$Ed/q/d" },
  /* 585 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse), "$Vdq" },
  /* 586 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 587 */ { Ev_Operand, NACL_OPFLAG(OpSet), "$Ed" },
  /* 588 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse), "$Vdq" },
  /* 589 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 590 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vdq" },
  /* 591 */ { E_Operand, NACL_OPFLAG(OpUse), "$Rd/q/Mb" },
  /* 592 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 593 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vdq" },
  /* 594 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Udq/Md" },
  /* 595 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 596 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vdq" },
  /* 597 */ { E_Operand, NACL_OPFLAG(OpUse), "$Ed/q/d" },
  /* 598 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 599 */ { RegXMM0, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpImplicit), "{%xmm0}" },
  /* 600 */ { RegREAX, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpImplicit), "{$rAXv}" },
  /* 601 */ { RegREDX, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpImplicit), "{$rDXv}" },
  /* 602 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse), "$Vdq" },
  /* 603 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wdq" },
  /* 604 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 605 */ { RegRECX, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpImplicit), "{$rCXv}" },
  /* 606 */ { RegREAX, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpImplicit), "{$rAXv}" },
  /* 607 */ { RegREDX, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpImplicit), "{$rDXv}" },
  /* 608 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse), "$Vdq" },
  /* 609 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wdq" },
  /* 610 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 611 */ { RegXMM0, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpImplicit), "{%xmm0}" },
  /* 612 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse), "$Vdq" },
  /* 613 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wdq" },
  /* 614 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 615 */ { RegRECX, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpImplicit), "{$rCXv}" },
  /* 616 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse), "$Vdq" },
  /* 617 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wdq" },
  /* 618 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 619 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st0" },
  /* 620 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 621 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st0" },
  /* 622 */ { RegST1, NACL_OPFLAG(OpUse), "%st1" },
  /* 623 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st0" },
  /* 624 */ { RegST2, NACL_OPFLAG(OpUse), "%st2" },
  /* 625 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st0" },
  /* 626 */ { RegST3, NACL_OPFLAG(OpUse), "%st3" },
  /* 627 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st0" },
  /* 628 */ { RegST4, NACL_OPFLAG(OpUse), "%st4" },
  /* 629 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st0" },
  /* 630 */ { RegST5, NACL_OPFLAG(OpUse), "%st5" },
  /* 631 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st0" },
  /* 632 */ { RegST6, NACL_OPFLAG(OpUse), "%st6" },
  /* 633 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st0" },
  /* 634 */ { RegST7, NACL_OPFLAG(OpUse), "%st7" },
  /* 635 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 636 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 637 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 638 */ { RegST1, NACL_OPFLAG(OpUse), "%st1" },
  /* 639 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 640 */ { RegST2, NACL_OPFLAG(OpUse), "%st2" },
  /* 641 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 642 */ { RegST3, NACL_OPFLAG(OpUse), "%st3" },
  /* 643 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 644 */ { RegST4, NACL_OPFLAG(OpUse), "%st4" },
  /* 645 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 646 */ { RegST5, NACL_OPFLAG(OpUse), "%st5" },
  /* 647 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 648 */ { RegST6, NACL_OPFLAG(OpUse), "%st6" },
  /* 649 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 650 */ { RegST7, NACL_OPFLAG(OpUse), "%st7" },
  /* 651 */ { RegST0, NACL_OPFLAG(OpSet), "%st0" },
  /* 652 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 653 */ { RegST0, NACL_OPFLAG(OpSet), "%st0" },
  /* 654 */ { RegST1, NACL_OPFLAG(OpUse), "%st1" },
  /* 655 */ { RegST0, NACL_OPFLAG(OpSet), "%st0" },
  /* 656 */ { RegST2, NACL_OPFLAG(OpUse), "%st2" },
  /* 657 */ { RegST0, NACL_OPFLAG(OpSet), "%st0" },
  /* 658 */ { RegST3, NACL_OPFLAG(OpUse), "%st3" },
  /* 659 */ { RegST0, NACL_OPFLAG(OpSet), "%st0" },
  /* 660 */ { RegST4, NACL_OPFLAG(OpUse), "%st4" },
  /* 661 */ { RegST0, NACL_OPFLAG(OpSet), "%st0" },
  /* 662 */ { RegST5, NACL_OPFLAG(OpUse), "%st5" },
  /* 663 */ { RegST0, NACL_OPFLAG(OpSet), "%st0" },
  /* 664 */ { RegST6, NACL_OPFLAG(OpUse), "%st6" },
  /* 665 */ { RegST0, NACL_OPFLAG(OpSet), "%st0" },
  /* 666 */ { RegST7, NACL_OPFLAG(OpUse), "%st7" },
  /* 667 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st0" },
  /* 668 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st0" },
  /* 669 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st0" },
  /* 670 */ { RegST1, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st1" },
  /* 671 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st0" },
  /* 672 */ { RegST2, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st2" },
  /* 673 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st0" },
  /* 674 */ { RegST3, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st3" },
  /* 675 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st0" },
  /* 676 */ { RegST4, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st4" },
  /* 677 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st0" },
  /* 678 */ { RegST5, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st5" },
  /* 679 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st0" },
  /* 680 */ { RegST6, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st6" },
  /* 681 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st0" },
  /* 682 */ { RegST7, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st7" },
  /* 683 */ { RegST1, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st1" },
  /* 684 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 685 */ { RegST2, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st2" },
  /* 686 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 687 */ { RegST3, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st3" },
  /* 688 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 689 */ { RegST4, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st4" },
  /* 690 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 691 */ { RegST5, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st5" },
  /* 692 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 693 */ { RegST6, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st6" },
  /* 694 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 695 */ { RegST7, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st7" },
  /* 696 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 697 */ { RegST0, NACL_EMPTY_OPFLAGS, "%st0" },
  /* 698 */ { RegST1, NACL_EMPTY_OPFLAGS, "%st1" },
  /* 699 */ { RegST2, NACL_EMPTY_OPFLAGS, "%st2" },
  /* 700 */ { RegST3, NACL_EMPTY_OPFLAGS, "%st3" },
  /* 701 */ { RegST4, NACL_EMPTY_OPFLAGS, "%st4" },
  /* 702 */ { RegST5, NACL_EMPTY_OPFLAGS, "%st5" },
  /* 703 */ { RegST6, NACL_EMPTY_OPFLAGS, "%st6" },
  /* 704 */ { RegST7, NACL_EMPTY_OPFLAGS, "%st7" },
  /* 705 */ { RegST1, NACL_OPFLAG(OpSet), "%st1" },
  /* 706 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 707 */ { RegST2, NACL_OPFLAG(OpSet), "%st2" },
  /* 708 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 709 */ { RegST3, NACL_OPFLAG(OpSet), "%st3" },
  /* 710 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 711 */ { RegST4, NACL_OPFLAG(OpSet), "%st4" },
  /* 712 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 713 */ { RegST5, NACL_OPFLAG(OpSet), "%st5" },
  /* 714 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 715 */ { RegST6, NACL_OPFLAG(OpSet), "%st6" },
  /* 716 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 717 */ { RegST7, NACL_OPFLAG(OpSet), "%st7" },
  /* 718 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 719 */ { RegAX, NACL_OPFLAG(OpSet), "%ax" },
};

static const NaClInst g_Opcodes[1362] = {
  /* 0 */
  { NACLi_INVALID,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_MMX,
    NACL_IFLAG(ModRmModIsnt0x3) | NACL_IFLAG(OpcodeUsesModRm),
    InstMovntq, 0x00, 2, 421, NACL_OPCODE_NULL_OFFSET  },
  /* 697 */
  { NACLi_MMX,
    NACL_IFLAG(OpcodeUsesModRm),
  ...
  { NACLi_MMX,
    ...
    InstMaskmovq, 0x00, 3, 423, NACL_OPCODE_NULL_OFFSET  },
  /* 712 */
  { NACLi_MMX,
    NACL_IFLAG(OpcodeUsesModRm),
  ...
  { NACLi_SSE2,
    ...
    InstMovsd, 0x00, 2, 426, NACL_OPCODE_NULL_OFFSET  },
  /* 720 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRepne),
  ...
  { NACLi_SSE3,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRepne),
    InstMovddup, 0x00, 2, 430, NACL_OPCODE_NULL_OFFSET  },
  /* 722 */
  { NACLi_INVALID,
  ...
  { NACLi_SSE2,
    ...
    InstCvtsi2sd, 0x00, 2, 432, NACL_OPCODE_NULL_OFFSET  },
  /* 724 */
  { NACLi_SSE4A,
    NACL_IFLAG(ModRmModIsnt0x3) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRepne),
    InstMovntsd, 0x00, 2, 434, NACL_OPCODE_NULL_OFFSET  },
  /* 725 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRepne) | NACL_IFLAG(SizeIgnoresData16) | NACL_IFLAG(OperandSize_v),
    InstCvttsd2si, 0x00, 2, 436, NACL_OPCODE_NULL_OFFSET  },
  /* 726 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRepne) | NACL_IFLAG(SizeIgnoresData16) | NACL_IFLAG(OperandSize_v),
    InstCvtsd2si, 0x00, 2, 436, NACL_OPCODE_NULL_OFFSET  },
  /* 727 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRepne),
    InstSqrtsd, 0x00, 2, 426, NACL_OPCODE_NULL_OFFSET  },
  /* 728 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRepne),
    InstAddsd, 0x00, 2, 438, NACL_OPCODE_NULL_OFFSET  },
  /* 729 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRepne),
    InstMulsd, 0x00, 2, 438, NACL_OPCODE_NULL_OFFSET  },
  /* 730 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRepne),
    InstCvtsd2ss, 0x00, 2, 440, NACL_OPCODE_NULL_OFFSET  },
  /* 731 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRepne),
    InstSubsd, 0x00, 2, 438, NACL_OPCODE_NULL_OFFSET  },
  /* 732 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRepne),
    InstMinsd, 0x00, 2, 438, NACL_OPCODE_NULL_OFFSET  },
  /* 733 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRepne),
    InstDivsd, 0x00, 2, 438, NACL_OPCODE_NULL_OFFSET  },
  /* 734 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRepne),
    InstMaxsd, 0x00, 2, 438, NACL_OPCODE_NULL_OFFSET  },
  /* 735 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsRepne),
    InstPshuflw, 0x00, 3, 442, NACL_OPCODE_NULL_OFFSET  },
  /* 736 */
  { NACLi_SSE4A,
    ...
    InstInsertq, 0x00, 4, 445, NACL_OPCODE_NULL_OFFSET  },
  /* 737 */
  { NACLi_SSE4A,
    NACL_IFLAG(ModRmModIs0x3) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRepne),
    InstInsertq, 0x00, 2, 449, NACL_OPCODE_NULL_OFFSET  },
  /* 738 */
  { NACLi_SSE3,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRepne),
  ...
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsRepne),
    InstCmpsd_xmm, 0x00, 3, 451, NACL_OPCODE_NULL_OFFSET  },
  /* 741 */
  { NACLi_SSE3,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRepne),
    InstAddsubps, 0x00, 2, 454, NACL_OPCODE_NULL_OFFSET  },
  /* 742 */
  { NACLi_SSE2,
    NACL_IFLAG(ModRmModIs0x3) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRepne),
    InstMovdq2q, 0x00, 2, 456, NACL_OPCODE_NULL_OFFSET  },
  /* 743 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRepne),
    InstCvtpd2dq, 0x00, 2, 458, NACL_OPCODE_NULL_OFFSET  },
  /* 744 */
  { NACLi_SSE3,
    NACL_IFLAG(ModRmModIsnt0x3) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRepne),
    InstLddqu, 0x00, 2, 460, NACL_OPCODE_NULL_OFFSET  },
  /* 745 */
  { NACLi_SSE,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRep),
    InstMovss, 0x00, 2, 462, NACL_OPCODE_NULL_OFFSET  },
  /* 746 */
  { NACLi_SSE,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRep),
  ...
  { NACLi_SSE,
    ...
    InstCvtsi2ss, 0x00, 2, 466, NACL_OPCODE_NULL_OFFSET  },
  /* 751 */
  { NACLi_SSE4A,
    NACL_IFLAG(ModRmModIsnt0x3) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRep),
    InstMovntss, 0x00, 2, 468, NACL_OPCODE_NULL_OFFSET  },
  /* 752 */
  { NACLi_SSE,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRep) | NACL_IFLAG(SizeIgnoresData16) | NACL_IFLAG(OperandSize_v),
    InstCvttss2si, 0x00, 2, 470, NACL_OPCODE_NULL_OFFSET  },
  /* 753 */
  { NACLi_SSE,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRep) | NACL_IFLAG(SizeIgnoresData16) | NACL_IFLAG(OperandSize_v),
    InstCvtss2si, 0x00, 2, 470, NACL_OPCODE_NULL_OFFSET  },
  /* 754 */
  { NACLi_SSE,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRep),
  ...
  { NACLi_SSE,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRep),
    InstRsqrtss, 0x00, 2, 462, NACL_OPCODE_NULL_OFFSET  },
  /* 756 */
  { NACLi_SSE,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRep),
    InstRcpss, 0x00, 2, 462, NACL_OPCODE_NULL_OFFSET  },
  /* 757 */
  { NACLi_SSE,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRep),
    InstAddss, 0x00, 2, 472, NACL_OPCODE_NULL_OFFSET  },
  /* 758 */
  { NACLi_SSE,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRep),
    InstMulss, 0x00, 2, 472, NACL_OPCODE_NULL_OFFSET  },
  /* 759 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRep),
    InstCvtss2sd, 0x00, 2, 474, NACL_OPCODE_NULL_OFFSET  },
  /* 760 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRep),
    InstCvttps2dq, 0x00, 2, 476, NACL_OPCODE_NULL_OFFSET  },
  /* 761 */
  { NACLi_SSE,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRep),
    InstSubss, 0x00, 2, 472, NACL_OPCODE_NULL_OFFSET  },
  /* 762 */
  { NACLi_SSE,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRep),
    InstMinss, 0x00, 2, 472, NACL_OPCODE_NULL_OFFSET  },
  /* 763 */
  { NACLi_SSE,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRep),
    InstDivss, 0x00, 2, 472, NACL_OPCODE_NULL_OFFSET  },
  /* 764 */
  { NACLi_SSE,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRep),
    InstMaxss, 0x00, 2, 472, NACL_OPCODE_NULL_OFFSET  },
  /* 765 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRep),
    InstMovdqu, 0x00, 2, 478, NACL_OPCODE_NULL_OFFSET  },
  /* 766 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsRep),
    InstPshufhw, 0x00, 3, 442, NACL_OPCODE_NULL_OFFSET  },
  /* 767 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRep),
    InstMovq, 0x00, 2, 442, NACL_OPCODE_NULL_OFFSET  },
  /* 768 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRep),
  ...
  { NACLi_SSE,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsRep),
    InstCmpss, 0x00, 3, 482, NACL_OPCODE_NULL_OFFSET  },
  /* 772 */
  { NACLi_SSE2,
    NACL_IFLAG(ModRmModIs0x3) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRep),
    InstMovq2dq, 0x00, 2, 485, NACL_OPCODE_NULL_OFFSET  },
  /* 773 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRep),
    InstCvtdq2pd, 0x00, 2, 487, NACL_OPCODE_NULL_OFFSET  },
  /* 774 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstMovupd, 0x00, 2, 489, NACL_OPCODE_NULL_OFFSET  },
  /* 775 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
  ...
  { NACLi_SSE2,
    ...
    InstMovlpd, 0x00, 2, 493, NACL_OPCODE_NULL_OFFSET  },
  /* 777 */
  { NACLi_SSE2,
    NACL_IFLAG(ModRmModIsnt0x3) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstMovlpd, 0x00, 2, 434, NACL_OPCODE_NULL_OFFSET  },
  /* 778 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstUnpcklpd, 0x00, 2, 495, NACL_OPCODE_NULL_OFFSET  },
  /* 779 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstUnpckhpd, 0x00, 2, 495, NACL_OPCODE_NULL_OFFSET  },
  /* 780 */
  { NACLi_SSE2,
    NACL_IFLAG(ModRmModIsnt0x3) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstMovhpd, 0x00, 2, 493, NACL_OPCODE_NULL_OFFSET  },
  /* 781 */
  { NACLi_SSE2,
    NACL_IFLAG(ModRmModIsnt0x3) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstMovhpd, 0x00, 2, 434, NACL_OPCODE_NULL_OFFSET  },
  /* 782 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstMovapd, 0x00, 2, 489, NACL_OPCODE_NULL_OFFSET  },
  /* 783 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
  ...
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstCvtpi2pd, 0x00, 2, 497, NACL_OPCODE_NULL_OFFSET  },
  /* 785 */
  { NACLi_SSE2,
    NACL_IFLAG(ModRmModIsnt0x3) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstMovntpd, 0x00, 2, 499, NACL_OPCODE_NULL_OFFSET  },
  /* 786 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstCvttpd2pi, 0x00, 2, 501, NACL_OPCODE_NULL_OFFSET  },
  /* 787 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstCvtpd2pi, 0x00, 2, 501, NACL_OPCODE_NULL_OFFSET  },
  /* 788 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstUcomisd, 0x00, 2, 503, NACL_OPCODE_NULL_OFFSET  },
  /* 789 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstComisd, 0x00, 2, 505, NACL_OPCODE_NULL_OFFSET  },
  /* 790 */
  { NACLi_SSE2,
    NACL_IFLAG(ModRmModIs0x3) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstMovmskpd, 0x00, 2, 507, NACL_OPCODE_NULL_OFFSET  },
  /* 791 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstSqrtpd, 0x00, 2, 509, NACL_OPCODE_NULL_OFFSET  },
  /* 792 */
  { NACLi_INVALID,
  ...
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstAndpd, 0x00, 2, 454, NACL_OPCODE_NULL_OFFSET  },
  /* 794 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstAndnpd, 0x00, 2, 454, NACL_OPCODE_NULL_OFFSET  },
  /* 795 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstOrpd, 0x00, 2, 454, NACL_OPCODE_NULL_OFFSET  },
  /* 796 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstXorpd, 0x00, 2, 454, NACL_OPCODE_NULL_OFFSET  },
  /* 797 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstAddpd, 0x00, 2, 454, NACL_OPCODE_NULL_OFFSET  },
  /* 798 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstMulpd, 0x00, 2, 454, NACL_OPCODE_NULL_OFFSET  },
  /* 799 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstCvtpd2ps, 0x00, 2, 509, NACL_OPCODE_NULL_OFFSET  },
  /* 800 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstCvtps2dq, 0x00, 2, 476, NACL_OPCODE_NULL_OFFSET  },
  /* 801 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstSubpd, 0x00, 2, 454, NACL_OPCODE_NULL_OFFSET  },
  /* 802 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstMinpd, 0x00, 2, 454, NACL_OPCODE_NULL_OFFSET  },
  /* 803 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstDivpd, 0x00, 2, 454, NACL_OPCODE_NULL_OFFSET  },
  /* 804 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstMaxpd, 0x00, 2, 454, NACL_OPCODE_NULL_OFFSET  },
  /* 805 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPunpcklbw, 0x00, 2, 511, NACL_OPCODE_NULL_OFFSET  },
  /* 806 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPunpcklwd, 0x00, 2, 511, NACL_OPCODE_NULL_OFFSET  },
  /* 807 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPunpckldq, 0x00, 2, 511, NACL_OPCODE_NULL_OFFSET  },
  /* 808 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPacksswb, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 809 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPcmpgtb, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 810 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPcmpgtw, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 811 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPcmpgtd, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 812 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPackuswb, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 813 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPunpckhbw, 0x00, 2, 511, NACL_OPCODE_NULL_OFFSET  },
  /* 814 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPunpckhwd, 0x00, 2, 511, NACL_OPCODE_NULL_OFFSET  },
  /* 815 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPunpckhdq, 0x00, 2, 511, NACL_OPCODE_NULL_OFFSET  },
  /* 816 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPackssdw, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 817 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPunpcklqdq, 0x00, 2, 511, NACL_OPCODE_NULL_OFFSET  },
  /* 818 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPunpckhqdq, 0x00, 2, 511, NACL_OPCODE_NULL_OFFSET  },
  /* 819 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16) | NACL_IFLAG(OperandSize_v),
    InstMovd, 0x00, 2, 515, NACL_OPCODE_NULL_OFFSET  },
  /* 820 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstMovdqa, 0x00, 2, 478, NACL_OPCODE_NULL_OFFSET  },
  /* 821 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPshufd, 0x00, 3, 517, NACL_OPCODE_NULL_OFFSET  },
  /* 822 */
  { NACLi_INVALID,
  ...
  { NACLi_SSE2,
    ...
    InstPsllw, 0x06, 2, 520, 822  },
  /* 824 */
  { NACLi_INVALID,
    NACL_IFLAG(OpcodeInModRm) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16) | NACL_IFLAG(NaClIllegal),
    InstInvalid, 0x05, 0, 0, 823  },
  /* 825 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeInModRm) | NACL_IFLAG(ModRmModIs0x3) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPsraw, 0x04, 2, 520, 824  },
  /* 826 */
  { NACLi_INVALID,
    NACL_IFLAG(OpcodeInModRm) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16) | NACL_IFLAG(NaClIllegal),
    InstInvalid, 0x03, 0, 0, 825  },
  /* 827 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeInModRm) | NACL_IFLAG(ModRmModIs0x3) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPsrlw, 0x02, 2, 520, 826  },
  /* 828 */
  { NACLi_INVALID,
    NACL_IFLAG(OpcodeInModRm) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16) | NACL_IFLAG(NaClIllegal),
    InstInvalid, 0x01, 0, 0, 827  },
  /* 829 */
  { NACLi_INVALID,
    NACL_IFLAG(OpcodeInModRm) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16) | NACL_IFLAG(NaClIllegal),
    InstInvalid, 0x00, 0, 0, 828  },
  /* 830 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeInModRm) | NACL_IFLAG(ModRmModIs0x3) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPslld, 0x06, 2, 520, 822  },
  /* 831 */
  { NACLi_INVALID,
    NACL_IFLAG(OpcodeInModRm) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16) | NACL_IFLAG(NaClIllegal),
    InstInvalid, 0x05, 0, 0, 830  },
  /* 832 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeInModRm) | NACL_IFLAG(ModRmModIs0x3) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPsrad, 0x04, 2, 520, 831  },
  /* 833 */
  { NACLi_INVALID,
    NACL_IFLAG(OpcodeInModRm) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16) | NACL_IFLAG(NaClIllegal),
    InstInvalid, 0x03, 0, 0, 832  },
  /* 834 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeInModRm) | NACL_IFLAG(ModRmModIs0x3) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPsrld, 0x02, 2, 520, 833  },
  /* 835 */
  { NACLi_INVALID,
    NACL_IFLAG(OpcodeInModRm) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16) | NACL_IFLAG(NaClIllegal),
    InstInvalid, 0x01, 0, 0, 834  },
  /* 836 */
  { NACLi_INVALID,
    NACL_IFLAG(OpcodeInModRm) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16) | NACL_IFLAG(NaClIllegal),
    InstInvalid, 0x00, 0, 0, 835  },
  /* 837 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeInModRm) | NACL_IFLAG(ModRmModIs0x3) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPslldq, 0x07, 2, 520, NACL_OPCODE_NULL_OFFSET  },
  /* 838 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeInModRm) | NACL_IFLAG(ModRmModIs0x3) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPsllq, 0x06, 2, 520, 837  },
  /* 839 */
  { NACLi_INVALID,
    NACL_IFLAG(OpcodeInModRm) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16) | NACL_IFLAG(NaClIllegal),
  ...
  { NACLi_INVALID,
    NACL_IFLAG(OpcodeInModRm) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16) | NACL_IFLAG(NaClIllegal),
    InstInvalid, 0x04, 0, 0, 839  },
  /* 841 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeInModRm) | NACL_IFLAG(ModRmModIs0x3) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPsrldq, 0x03, 2, 520, 840  },
  /* 842 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeInModRm) | NACL_IFLAG(ModRmModIs0x3) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPsrlq, 0x02, 2, 520, 841  },
  /* 843 */
  { NACLi_INVALID,
    NACL_IFLAG(OpcodeInModRm) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16) | NACL_IFLAG(NaClIllegal),
  ...
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPcmpeqb, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 846 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPcmpeqw, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 847 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPcmpeqd, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 848 */
  { NACLi_INVALID,
  ...
  { NACLi_SSE4A,
    ...
    InstExtrq, 0x00, 3, 522, 848  },
  /* 850 */
  { NACLi_SSE4A,
    NACL_IFLAG(ModRmModIs0x3) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstExtrq, 0x00, 2, 449, NACL_OPCODE_NULL_OFFSET  },
  /* 851 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstHaddpd, 0x00, 2, 454, NACL_OPCODE_NULL_OFFSET  },
  /* 852 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstHsubpd, 0x00, 2, 454, NACL_OPCODE_NULL_OFFSET  },
  /* 853 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16) | NACL_IFLAG(OperandSize_v),
    InstMovd, 0x00, 2, 525, NACL_OPCODE_NULL_OFFSET  },
  /* 854 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
  ...
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstCmppd, 0x00, 3, 527, NACL_OPCODE_NULL_OFFSET  },
  /* 856 */
  { NACLi_SSE,
    ...
    InstPinsrw, 0x00, 3, 530, NACL_OPCODE_NULL_OFFSET  },
  /* 857 */
  { NACLi_SSE41,
    ...
    InstPextrw, 0x00, 3, 533, NACL_OPCODE_NULL_OFFSET  },
  /* 858 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstShufpd, 0x00, 3, 527, NACL_OPCODE_NULL_OFFSET  },
  /* 859 */
  { NACLi_SSE3,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstAddsubpd, 0x00, 2, 454, NACL_OPCODE_NULL_OFFSET  },
  /* 860 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPsrlw, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 861 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPsrld, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 862 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPsrlq, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 863 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPaddq, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 864 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPmullw, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 865 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstMovq, 0x00, 2, 536, NACL_OPCODE_NULL_OFFSET  },
  /* 866 */
  { NACLi_SSE2,
    NACL_IFLAG(ModRmModIs0x3) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPmovmskb, 0x00, 2, 533, NACL_OPCODE_NULL_OFFSET  },
  /* 867 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPsubusb, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 868 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPsubusw, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 869 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPminub, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 870 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPand, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 871 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPaddusb, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 872 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPaddusw, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 873 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPmaxub, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 874 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPandn, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 875 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPavgb, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 876 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPsraw, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 877 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPsrad, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 878 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPavgw, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 879 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPmulhuw, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 880 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPmulhw, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 881 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstCvttpd2dq, 0x00, 2, 538, NACL_OPCODE_NULL_OFFSET  },
  /* 882 */
  { NACLi_SSE2,
    NACL_IFLAG(ModRmModIsnt0x3) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstMovntdq, 0x00, 2, 540, NACL_OPCODE_NULL_OFFSET  },
  /* 883 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPsubsb, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 884 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPsubsw, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 885 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPminsw, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 886 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPor, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 887 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPaddsb, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 888 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPaddsw, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 889 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPmaxsw, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 890 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPxor, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 891 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPsllw, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 892 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPslld, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 893 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPsllq, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 894 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPmuludq, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 895 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPmaddwd, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 896 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPsadbw, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 897 */
  { NACLi_SSE2,
    ...
    InstMaskmovdqu, 0x00, 3, 542, NACL_OPCODE_NULL_OFFSET  },
  /* 898 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPsubb, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 899 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPsubw, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 900 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPsubd, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 901 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPsubq, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 902 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPaddb, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 903 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPaddw, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 904 */
  { NACLi_SSE2,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPaddd, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 905 */
  { NACLi_E3DNOW,
    NACL_IFLAG(OpcodeUsesModRm),
  ...
  { NACLi_MOVBE,
    NACL_IFLAG(ModRmModIsnt0x3) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(OperandSize_w) | NACL_IFLAG(OperandSize_v),
    InstMovbe, 0x00, 2, 545, NACL_OPCODE_NULL_OFFSET  },
  /* 945 */
  { NACLi_MOVBE,
    NACL_IFLAG(ModRmModIsnt0x3) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(OperandSize_w) | NACL_IFLAG(OperandSize_v),
  ...
  { NACLi_SSSE3,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPshufb, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 947 */
  { NACLi_SSSE3,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPhaddw, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 948 */
  { NACLi_SSSE3,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPhaddd, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 949 */
  { NACLi_SSSE3,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPhaddsw, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 950 */
  { NACLi_SSSE3,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPmaddubsw, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 951 */
  { NACLi_SSSE3,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPhsubw, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 952 */
  { NACLi_SSSE3,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPhsubd, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 953 */
  { NACLi_SSSE3,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPhsubsw, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 954 */
  { NACLi_SSSE3,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPsignb, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 955 */
  { NACLi_SSSE3,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPsignw, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 956 */
  { NACLi_SSSE3,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPsignd, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 957 */
  { NACLi_SSSE3,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPmulhrsw, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 958 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPblendvb, 0x00, 3, 549, NACL_OPCODE_NULL_OFFSET  },
  /* 959 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstBlendvps, 0x00, 3, 549, NACL_OPCODE_NULL_OFFSET  },
  /* 960 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstBlendvpd, 0x00, 3, 549, NACL_OPCODE_NULL_OFFSET  },
  /* 961 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPtest, 0x00, 2, 552, NACL_OPCODE_NULL_OFFSET  },
  /* 962 */
  { NACLi_SSSE3,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPabsb, 0x00, 2, 478, NACL_OPCODE_NULL_OFFSET  },
  /* 963 */
  { NACLi_SSSE3,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPabsw, 0x00, 2, 478, NACL_OPCODE_NULL_OFFSET  },
  /* 964 */
  { NACLi_SSSE3,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPabsd, 0x00, 2, 478, NACL_OPCODE_NULL_OFFSET  },
  /* 965 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPmovsxbw, 0x00, 2, 554, NACL_OPCODE_NULL_OFFSET  },
  /* 966 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPmovsxbd, 0x00, 2, 556, NACL_OPCODE_NULL_OFFSET  },
  /* 967 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPmovsxbq, 0x00, 2, 558, NACL_OPCODE_NULL_OFFSET  },
  /* 968 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPmovsxwd, 0x00, 2, 554, NACL_OPCODE_NULL_OFFSET  },
  /* 969 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPmovsxwq, 0x00, 2, 556, NACL_OPCODE_NULL_OFFSET  },
  /* 970 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPmovsxdq, 0x00, 2, 554, NACL_OPCODE_NULL_OFFSET  },
  /* 971 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPmuldq, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 972 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPcmpeqq, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 973 */
  { NACLi_SSE41,
    NACL_IFLAG(ModRmModIsnt0x3) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstMovntdqa, 0x00, 2, 460, NACL_OPCODE_NULL_OFFSET  },
  /* 974 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPackusdw, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 975 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPmovzxbw, 0x00, 2, 554, NACL_OPCODE_NULL_OFFSET  },
  /* 976 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPmovzxbd, 0x00, 2, 556, NACL_OPCODE_NULL_OFFSET  },
  /* 977 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPmovzxbq, 0x00, 2, 558, NACL_OPCODE_NULL_OFFSET  },
  /* 978 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPmovzxwd, 0x00, 2, 554, NACL_OPCODE_NULL_OFFSET  },
  /* 979 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPmovzxwq, 0x00, 2, 556, NACL_OPCODE_NULL_OFFSET  },
  /* 980 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPmovzxdq, 0x00, 2, 554, NACL_OPCODE_NULL_OFFSET  },
  /* 981 */
  { NACLi_SSE42,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPcmpgtq, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 982 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPminsb, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 983 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPminsd, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 984 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPminuw, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 985 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPminud, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 986 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPmaxsb, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 987 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPmaxsd, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 988 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPmaxuw, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 989 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPmaxud, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 990 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPmulld, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 991 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPhminposuw, 0x00, 2, 513, NACL_OPCODE_NULL_OFFSET  },
  /* 992 */
  { NACLi_VMX,
    ...
    InstInvept, 0x00, 2, 560, NACL_OPCODE_NULL_OFFSET  },
  /* 993 */
  { NACLi_VMX,
    NACL_IFLAG(ModRmModIsnt0x3) | NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16) | NACL_IFLAG(NaClIllegal),
    InstInvvpid, 0x00, 2, 560, NACL_OPCODE_NULL_OFFSET  },
  /* 994 */
  { NACLi_SSE42,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeAllowsRepne) | NACL_IFLAG(OperandSize_b),
    InstCrc32, 0x00, 2, 562, NACL_OPCODE_NULL_OFFSET  },
  /* 995 */
  { NACLi_SSE42,
  ...
  { NACLi_SSSE3,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b),
    InstPalignr, 0x00, 3, 566, NACL_OPCODE_NULL_OFFSET  },
  /* 997 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstRoundps, 0x00, 3, 517, NACL_OPCODE_NULL_OFFSET  },
  /* 998 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstRoundpd, 0x00, 3, 517, NACL_OPCODE_NULL_OFFSET  },
  /* 999 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstRoundss, 0x00, 3, 569, NACL_OPCODE_NULL_OFFSET  },
  /* 1000 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstRoundsd, 0x00, 3, 572, NACL_OPCODE_NULL_OFFSET  },
  /* 1001 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstBlendps, 0x00, 3, 575, NACL_OPCODE_NULL_OFFSET  },
  /* 1002 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstBlendpd, 0x00, 3, 575, NACL_OPCODE_NULL_OFFSET  },
  /* 1003 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPblendw, 0x00, 3, 575, NACL_OPCODE_NULL_OFFSET  },
  /* 1004 */
  { NACLi_SSSE3,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
  ...
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPextrb, 0x00, 3, 578, NACL_OPCODE_NULL_OFFSET  },
  /* 1006 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPextrw, 0x00, 3, 581, NACL_OPCODE_NULL_OFFSET  },
  /* 1007 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16) | NACL_IFLAG(OperandSize_v),
    InstPextrd, 0x00, 3, 584, NACL_OPCODE_NULL_OFFSET  },
  /* 1008 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstExtractps, 0x00, 3, 587, NACL_OPCODE_NULL_OFFSET  },
  /* 1009 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16) | NACL_IFLAG(OperandSize_v),
    InstPinsrb, 0x00, 3, 590, NACL_OPCODE_NULL_OFFSET  },
  /* 1010 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstInsertps, 0x00, 3, 593, NACL_OPCODE_NULL_OFFSET  },
  /* 1011 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16) | NACL_IFLAG(OperandSize_v),
    InstPinsrd, 0x00, 3, 596, NACL_OPCODE_NULL_OFFSET  },
  /* 1012 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstDpps, 0x00, 3, 575, NACL_OPCODE_NULL_OFFSET  },
  /* 1013 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstDppd, 0x00, 3, 575, NACL_OPCODE_NULL_OFFSET  },
  /* 1014 */
  { NACLi_SSE41,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstMpsadbw, 0x00, 3, 575, NACL_OPCODE_NULL_OFFSET  },
  /* 1015 */
  { NACLi_SSE42,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16) | NACL_IFLAG(OperandSize_v),
    InstPcmpestrm, 0x00, 6, 599, NACL_OPCODE_NULL_OFFSET  },
  /* 1016 */
  { NACLi_SSE42,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16) | NACL_IFLAG(OperandSize_v),
    InstPcmpestri, 0x00, 6, 605, NACL_OPCODE_NULL_OFFSET  },
  /* 1017 */
  { NACLi_SSE42,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16),
    InstPcmpistrm, 0x00, 4, 611, NACL_OPCODE_NULL_OFFSET  },
  /* 1018 */
  { NACLi_SSE42,
    NACL_IFLAG(OpcodeUsesModRm) | NACL_IFLAG(OpcodeHasImmed_b) | NACL_IFLAG(OpcodeAllowsData16) | NACL_IFLAG(SizeIgnoresData16) | NACL_IFLAG(OperandSize_v),
    InstPcmpistri, 0x00, 4, 615, NACL_OPCODE_NULL_OFFSET  },
  /* 1019 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFadd, 0x00, 2, 619, NACL_OPCODE_NULL_OFFSET  },
  /* 1020 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFmul, 0x00, 2, 619, NACL_OPCODE_NULL_OFFSET  },
  /* 1028 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFcom, 0x00, 2, 635, NACL_OPCODE_NULL_OFFSET  },
  /* 1036 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFcomp, 0x00, 2, 635, NACL_OPCODE_NULL_OFFSET  },
  /* 1044 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFsub, 0x00, 2, 619, NACL_OPCODE_NULL_OFFSET  },
  /* 1052 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFsubr, 0x00, 2, 619, NACL_OPCODE_NULL_OFFSET  },
  /* 1060 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFdiv, 0x00, 2, 619, NACL_OPCODE_NULL_OFFSET  },
  /* 1068 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFdivr, 0x00, 2, 619, NACL_OPCODE_NULL_OFFSET  },
  /* 1076 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFld, 0x00, 2, 651, NACL_OPCODE_NULL_OFFSET  },
  /* 1084 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFxch, 0x00, 2, 667, NACL_OPCODE_NULL_OFFSET  },
  /* 1092 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFyl2x, 0x00, 2, 621, NACL_OPCODE_NULL_OFFSET  },
  /* 1113 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFptan, 0x00, 2, 653, NACL_OPCODE_NULL_OFFSET  },
  /* 1114 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFpatan, 0x00, 2, 621, NACL_OPCODE_NULL_OFFSET  },
  /* 1115 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFxtract, 0x00, 2, 653, NACL_OPCODE_NULL_OFFSET  },
  /* 1116 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFprem1, 0x00, 2, 621, NACL_OPCODE_NULL_OFFSET  },
  /* 1117 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFprem, 0x00, 2, 621, NACL_OPCODE_NULL_OFFSET  },
  /* 1120 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFyl2xp1, 0x00, 2, 621, NACL_OPCODE_NULL_OFFSET  },
  /* 1121 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFscale, 0x00, 2, 621, NACL_OPCODE_NULL_OFFSET  },
  /* 1125 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFcmovb, 0x00, 2, 619, NACL_OPCODE_NULL_OFFSET  },
  /* 1128 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFcmove, 0x00, 2, 619, NACL_OPCODE_NULL_OFFSET  },
  /* 1136 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFcmovbe, 0x00, 2, 619, NACL_OPCODE_NULL_OFFSET  },
  /* 1144 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFcmovu, 0x00, 2, 619, NACL_OPCODE_NULL_OFFSET  },
  /* 1152 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFucompp, 0x00, 2, 637, NACL_OPCODE_NULL_OFFSET  },
  /* 1160 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFcmovnb, 0x00, 2, 619, NACL_OPCODE_NULL_OFFSET  },
  /* 1161 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFcmovne, 0x00, 2, 619, NACL_OPCODE_NULL_OFFSET  },
  /* 1169 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFcmovnbe, 0x00, 2, 619, NACL_OPCODE_NULL_OFFSET  },
  /* 1177 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFcmovnu, 0x00, 2, 619, NACL_OPCODE_NULL_OFFSET  },
  /* 1185 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFucomi, 0x00, 2, 635, NACL_OPCODE_NULL_OFFSET  },
  /* 1195 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFcomi, 0x00, 2, 635, NACL_OPCODE_NULL_OFFSET  },
  /* 1203 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFadd, 0x00, 2, 683, NACL_OPCODE_NULL_OFFSET  },
  /* 1211 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFmul, 0x00, 2, 683, NACL_OPCODE_NULL_OFFSET  },
  /* 1218 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFsubr, 0x00, 2, 683, NACL_OPCODE_NULL_OFFSET  },
  /* 1225 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFsub, 0x00, 2, 683, NACL_OPCODE_NULL_OFFSET  },
  /* 1232 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFdivr, 0x00, 2, 683, NACL_OPCODE_NULL_OFFSET  },
  /* 1239 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFdiv, 0x00, 2, 683, NACL_OPCODE_NULL_OFFSET  },
  /* 1246 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFfree, 0x00, 1, 697, NACL_OPCODE_NULL_OFFSET  },
  /* 1253 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFfree, 0x00, 1, 698, NACL_OPCODE_NULL_OFFSET  },
  /* 1254 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFst, 0x00, 2, 651, NACL_OPCODE_NULL_OFFSET  },
  /* 1261 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFst, 0x00, 2, 705, NACL_OPCODE_NULL_OFFSET  },
  /* 1262 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFstp, 0x00, 2, 651, NACL_OPCODE_NULL_OFFSET  },
  /* 1269 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFstp, 0x00, 2, 705, NACL_OPCODE_NULL_OFFSET  },
  /* 1270 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFucom, 0x00, 2, 635, NACL_OPCODE_NULL_OFFSET  },
  /* 1277 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFucomp, 0x00, 2, 635, NACL_OPCODE_NULL_OFFSET  },
  /* 1285 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFaddp, 0x00, 2, 619, NACL_OPCODE_NULL_OFFSET  },
  /* 1293 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFaddp, 0x00, 2, 683, NACL_OPCODE_NULL_OFFSET  },
  /* 1294 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFmulp, 0x00, 2, 619, NACL_OPCODE_NULL_OFFSET  },
  /* 1301 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFmulp, 0x00, 2, 683, NACL_OPCODE_NULL_OFFSET  },
  /* 1302 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFcompp, 0x00, 2, 637, NACL_OPCODE_NULL_OFFSET  },
  /* 1309 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFsubrp, 0x00, 2, 619, NACL_OPCODE_NULL_OFFSET  },
  /* 1310 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFsubrp, 0x00, 2, 683, NACL_OPCODE_NULL_OFFSET  },
  /* 1311 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFsubp, 0x00, 2, 619, NACL_OPCODE_NULL_OFFSET  },
  /* 1318 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFsubp, 0x00, 2, 683, NACL_OPCODE_NULL_OFFSET  },
  /* 1319 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFdivrp, 0x00, 2, 619, NACL_OPCODE_NULL_OFFSET  },
  /* 1326 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFdivrp, 0x00, 2, 683, NACL_OPCODE_NULL_OFFSET  },
  /* 1327 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFdivp, 0x00, 2, 619, NACL_OPCODE_NULL_OFFSET  },
  /* 1334 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFdivp, 0x00, 2, 683, NACL_OPCODE_NULL_OFFSET  },
  /* 1335 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFnstsw, 0x00, 1, 719, NACL_OPCODE_NULL_OFFSET  },
  /* 1343 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFucomip, 0x00, 2, 635, NACL_OPCODE_NULL_OFFSET  },
  /* 1344 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
  ...
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
    InstFcomip, 0x00, 2, 635, NACL_OPCODE_NULL_OFFSET  },
  /* 1352 */
  { NACLi_X87,
    NACL_EMPTY_IFLAGS,
...
static const NaClPrefixOpcodeArrayOffset g_LookupTable[2543] = {
  ...
  /*   450 */ 662, 663, 664, 665, 666, 667, 668, 669, 670, 671, 
  /*   460 */ 672, 673, 674, 675, 16, 676, 677, 678, 679, 680, 
  /*   470 */ 16, 681, 682, 683, 684, 685, 686, 687, 688, 689, 
  /*   480 */ 690, 691, 692, 693, 694, 695, 16, 696, 697, 698, 
  /*   490 */ 699, 700, 701, 702, 703, 704, 16, 705, 706, 707, 
  /*   500 */ 708, 709, 710, 711, 712, 713, 714, 715, 716, 717, 
  /*   510 */ 718, 16, NACL_OPCODE_NULL_OFFSET, 719, 720, 721, 722, 722, 722, 722, 
  /*   520 */ 722, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 
  /*   530 */ NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 722, 722, 723, 
  /*   540 */ 724, 725, 726, 722, 722, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 
  ...
  /*   570 */ NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 722, 727, 722, 
  /*   580 */ 722, 722, 722, 722, 722, 728, 729, 730, 722, 731, 
  /*   590 */ 732, 733, 734, 722, 722, 722, 722, 722, 722, 722, 
  /*   600 */ 722, 722, 722, 722, 722, 722, 722, 722, 722, 735, 
  /*   610 */ 722, 722, 722, 722, 722, 722, 722, 736, 737, 722, 
  /*   620 */ 722, 738, 739, 722, 722, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 
  ...
  /*   670 */ NACL_OPCODE_NULL_OFFSET, 722, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 
  /*   680 */ NACL_OPCODE_NULL_OFFSET, 722, 722, 722, 722, 722, 722, 722, 722, NACL_OPCODE_NULL_OFFSET, 
  /*   690 */ NACL_OPCODE_NULL_OFFSET, 740, 722, 722, 722, 722, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 
  /*   700 */ NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 741, 722, 722, 722, 722, 
  /*   710 */ 722, 742, 722, 722, 722, 722, 722, 722, 722, 722, 
  /*   720 */ 722, 722, 722, 722, 722, 722, 722, 743, 722, 722, 
  /*   730 */ 722, 722, 722, 722, 722, 722, 722, 744, 722, 722, 
  /*   740 */ 722, 722, 722, 722, 722, 722, 722, 722, 722, 722, 
  /*   750 */ 722, 722, 722, NACL_OPCODE_NULL_OFFSET, 745, 746, 747, 748, 748, 748, 
  /*   760 */ 749, 748, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 
  /*   770 */ NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 748, 748, 
  /*   780 */ 750, 751, 752, 753, 748, 748, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 
  ...
  /*   810 */ NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 748, 754, 
  /*   820 */ 755, 756, 748, 748, 748, 748, 757, 758, 759, 760, 
  /*   830 */ 761, 762, 763, 764, 748, 748, 748, 748, 748, 748, 
  /*   840 */ 748, 748, 748, 748, 748, 748, 748, 748, 748, 765, 
  /*   850 */ 766, 748, 748, 748, 748, 748, 748, 748, 748, 748, 
  /*   860 */ 748, 748, 748, 748, 767, 768, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 
  ...
  /*   920 */ NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 769, 748, 748, 748, 748, 770, 748, 748, 
  /*   930 */ NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 771, 748, 748, 748, 748, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 
  /*   940 */ NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 748, 748, 748, 748, 
  /*   950 */ 748, 748, 772, 748, 748, 748, 748, 748, 748, 748, 
  /*   960 */ 748, 748, 748, 748, 748, 748, 748, 748, 773, 748, 
  /*   970 */ 748, 748, 748, 748, 748, 748, 748, 748, 748, 748, 
  /*   980 */ 748, 748, 748, 748, 748, 748, 748, 748, 748, 748, 
  /*   990 */ 748, 748, 748, 748, NACL_OPCODE_NULL_OFFSET, 774, 775, 776, 777, 778, 
  /*  1000 */ 779, 780, 781, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 
  /*  1010 */ NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 782, 
  /*  1020 */ 783, 784, 785, 786, 787, 788, 789, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 
  ...
  /*  1050 */ NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 790, 
  /*  1060 */ 791, 792, 792, 793, 794, 795, 796, 797, 798, 799, 
  /*  1070 */ 800, 801, 802, 803, 804, 805, 806, 807, 808, 809, 
  /*  1080 */ 810, 811, 812, 813, 814, 815, 816, 817, 818, 819, 
  /*  1090 */ 820, 821, 829, 836, 844, 845, 846, 847, 792, 849, 
  /*  1100 */ 850, 792, 792, 851, 852, 853, 854, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 
  ...
  /*  1150 */ NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 792, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 
  ...
  /*  1170 */ NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 855, 792, 856, 857, 858, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 
  /*  1180 */ NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 859, 860, 861, 
  /*  1190 */ 862, 863, 864, 865, 866, 867, 868, 869, 870, 871, 
  /*  1200 */ 872, 873, 874, 875, 876, 877, 878, 879, 880, 881, 
  /*  1210 */ 882, 883, 884, 885, 886, 887, 888, 889, 890, 792, 
  /*  1220 */ 891, 892, 893, 894, 895, 896, 897, 898, 899, 900, 
  /*  1230 */ 901, 902, 903, 904, 792, NACL_OPCODE_NULL_OFFSET, 905, 906, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 
  ...
  /*  1250 */ NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 907, 908, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 
  ...
  /*  1360 */ NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 909, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 910, NACL_OPCODE_NULL_OFFSET, 911, NACL_OPCODE_NULL_OFFSET, 
  /*  1370 */ NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 912, NACL_OPCODE_NULL_OFFSET, 913, 914, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 915, NACL_OPCODE_NULL_OFFSET, 
  /*  1380 */ NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 916, NACL_OPCODE_NULL_OFFSET, 917, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 918, NACL_OPCODE_NULL_OFFSET, 
  /*  1390 */ 919, 920, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 921, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 922, NACL_OPCODE_NULL_OFFSET, 
  /*  1400 */ 923, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 924, NACL_OPCODE_NULL_OFFSET, 925, 926, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 
  /*  1410 */ NACL_OPCODE_NULL_OFFSET, 927, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 928, NACL_OPCODE_NULL_OFFSET, 929, 930, 931, 
  /*  1420 */ 932, 933, 934, 935, 936, 937, 938, 939, 940, 16, 
  /*  1430 */ 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 
  /*  1440 */ 16, 16, 16, 16, 16, 941, 942, 943, 16, 16, 
  ...
  /*  1650 */ 16, 16, 16, 16, 16, 16, 16, 944, 945, 16, 
  /*  1660 */ 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 
  /*  1670 */ 16, 16, 16, 946, 947, 948, 949, 950, 951, 952, 
  /*  1680 */ 953, 954, 955, 956, 957, 792, 792, 792, 792, 958, 
  /*  1690 */ 792, 792, 792, 959, 960, 792, 961, 792, 792, 792, 
  /*  1700 */ 792, 962, 963, 964, 792, 965, 966, 967, 968, 969, 
  /*  1710 */ 970, 792, 792, 971, 972, 973, 974, 792, 792, 792, 
  /*  1720 */ 792, 975, 976, 977, 978, 979, 980, 792, 981, 982, 
  /*  1730 */ 983, 984, 985, 986, 987, 988, 989, 990, 991, 792, 
  /*  1740 */ 792, 792, 792, 792, 792, 792, 792, 792, 792, 792, 
  /*  1750 */ 792, 792, 792, 792, 792, 792, 792, 792, 792, 792, 
  /*  1760 */ 792, 792, 792, 792, 792, 792, 792, 792, 792, 792, 
  /*  1770 */ 792, 792, 792, 792, 792, 792, 792, 792, 792, 792, 
  /*  1780 */ 792, 792, 792, 792, 792, 792, 792, 792, 792, 792, 
  /*  1790 */ 792, 792, 792, 792, 792, 792, 792, 792, 792, 792, 
  /*  1800 */ 792, 992, 993, 792, 792, 792, 792, 792, 792, 792, 
  /*  1810 */ 792, 792, 792, 792, 792, 792, 792, 792, 792, 792, 
  /*  1820 */ 792, 792, 792, 792, 792, 792, 792, 792, 792, 792, 
  /*  1830 */ 792, 792, 792, 792, 792, 792, 792, 792, 792, 792, 
  /*  1840 */ 792, 792, 792, 792, 792, 792, 792, 792, 792, 792, 
  /*  1850 */ 792, 792, 792, 792, 792, 792, 792, 792, 792, 792, 
  /*  1860 */ 792, 792, 792, 792, 792, 792, 792, 792, 792, 792, 
  /*  1870 */ 792, 792, 792, 792, 792, 792, 792, 792, 792, 792, 
  /*  1880 */ 792, 792, 792, 792, 792, 792, 792, 792, 792, 792, 
  /*  1890 */ 792, 792, 792, 792, 792, 792, 792, 792, 792, 792, 
  /*  1900 */ 792, 792, 792, 792, 792, 792, 792, 792, 792, 792, 
  /*  1910 */ 792, 792, 792, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 792, 792, 792, 792, 792, 
  /*  1920 */ 792, 792, 792, 792, 792, 792, 792, 792, 792, NACL_OPCODE_NULL_OFFSET, 
  /*  1930 */ 994, 995, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 996, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 997, 998, 999, 
  /*  1940 */ 1000, 1001, 1002, 1003, 1004, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 1005, 
  /*  1950 */ 1006, 1007, 1008, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 
  /*  1960 */ NACL_OPCODE_NULL_OFFSET, 1009, 1010, 1011, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 
  ...
  /*  1990 */ NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 1012, 1013, 1014, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 
  ...
  /*  2020 */ NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 1015, 1016, 1017, 1018, NACL_OPCODE_NULL_OFFSET, 
  /*  2030 */ NACL_OPCODE_NULL_OFFSET, 1019, 1020, 1021, 1022, 1023, 1024, 1025, 1026, 1027, 
  /*  2040 */ 1028, 1029, 1030, 1031, 1032, 1033, 1034, 1035, 1036, 1037, 
  /*  2050 */ 1038, 1039, 1040, 1041, 1042, 1043, 1044, 1045, 1046, 1047, 
  /*  2060 */ 1048, 1049, 1050, 1051, 1052, 1053, 1054, 1055, 1056, 1057, 
  /*  2070 */ 1058, 1059, 1060, 1061, 1062, 1063, 1064, 1065, 1066, 1067, 
  /*  2080 */ 1068, 1069, 1070, 1071, 1072, 1073, 1074, 1075, 1076, 1077, 
  /*  2090 */ 1078, 1079, 1080, 1081, 1082, NACL_OPCODE_NULL_OFFSET, 1083, 1084, 1085, 1086, 
  /*  2100 */ 1087, 1088, 1089, 1090, 1091, 1092, 1093, 1094, 1095, 1096, 
  /*  2110 */ 1097, 1098, 1099, 16, 16, 16, 16, 16, 16, 16, 
  /*  2120 */ 16, 16, 16, 16, 16, 16, 16, 16, 1100, 1101, 
  /*  2130 */ 16, 16, 1102, 1103, 16, 16, 1104, 1105, 1106, 1107, 
  /*  2140 */ 1108, 1109, 1110, 16, 1111, 1112, 1113, 1114, 1115, 1116, 
  /*  2150 */ 1117, 1118, 1119, 1120, 1121, 1122, 1123, 1124, 1125, 1126, 
  /*  2160 */ NACL_OPCODE_NULL_OFFSET, 1127, 1128, 1129, 1130, 1131, 1132, 1133, 1134, 1135, 
  /*  2170 */ 1136, 1137, 1138, 1139, 1140, 1141, 1142, 1143, 1144, 1145, 
  /*  2180 */ 1146, 1147, 1148, 1149, 1150, 1151, 1152, 1153, 1154, 1155, 
  /*  2190 */ 1156, 1157, 1158, 16, 16, 16, 16, 16, 16, 16, 
  /*  2200 */ 16, 16, 1159, 16, 16, 16, 16, 16, 16, 16, 
  /*  2210 */ 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 
  /*  2220 */ 16, 16, 16, 16, 16, NACL_OPCODE_NULL_OFFSET, 1160, 1161, 1162, 1163, 
  /*  2230 */ 1164, 1165, 1166, 1167, 1168, 1169, 1170, 1171, 1172, 1173, 
  /*  2240 */ 1174, 1175, 1176, 1177, 1178, 1179, 1180, 1181, 1182, 1183, 
  /*  2250 */ 1184, 1185, 1186, 1187, 1188, 1189, 1190, 1191, 16, 16, 
  /*  2260 */ 1192, 1193, 16, 16, 16, 16, 1194, 1195, 1196, 1197, 
  /*  2270 */ 1198, 1199, 1200, 1201, 1202, 1203, 1204, 1205, 1206, 1207, 
  /*  2280 */ 1208, 1209, NACL_OPCODE_NULL_OFFSET, NACL_OPCODE_NULL_OFFSET, 1019, 1210, 1211, 1212, 1213, 1214, 
  /*  2290 */ 1215, 1216, 1027, 1217, 1218, 1219, 1220, 1221, 1222, 1223, 
  /*  2300 */ 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 
  /*  2310 */ 16, 16, 16, 16, 16, 16, 1059, 1224, 1225, 1226, 
  /*  2320 */ 1227, 1228, 1229, 1230, 1051, 1231, 1232, 1233, 1234, 1235, 
  /*  2330 */ 1236, 1237, 1075, 1238, 1239, 1240, 1241, 1242, 1243, 1244, 
  /*  2340 */ 1067, 1245, 1246, 1247, 1248, 1249, 1250, 1251, NACL_OPCODE_NULL_OFFSET, 1252, 
  /*  2350 */ 1253, 1254, 1255, 1256, 1257, 1258, 1259, 16, 16, 16, 
  /*  2360 */ 16, 16, 16, 16, 16, 1260, 1261, 1262, 1263, 1264, 
  /*  2370 */ 1265, 1266, 1267, 1268, 1269, 1270, 1271, 1272, 1273, 1274, 
  /*  2380 */ 1275, 1276, 1277, 1278, 1279, 1280, 1281, 1282, 1283, 1284, 
  /*  2390 */ 1285, 1286, 1287, 1288, 1289, 1290, 1291, 16, 16, 16, 
  /*  2400 */ 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 
  /*  2410 */ 16, 16, 16, NACL_OPCODE_NULL_OFFSET, 1292, 1293, 1294, 1295, 1296, 1297, 
  /*  2420 */ 1298, 1299, 1300, 1301, 1302, 1303, 1304, 1305, 1306, 1307, 
  /*  2430 */ 16, 16, 16, 16, 16, 16, 16, 16, 16, 1308, 
  /*  2440 */ 16, 16, 16, 16, 16, 16, 1309, 1310, 1311, 1312, 
  /*  2450 */ 1313, 1314, 1315, 1316, 1317, 1318, 1319, 1320, 1321, 1322, 
  /*  2460 */ 1323, 1324, 1325, 1326, 1327, 1328, 1329, 1330, 1331, 1332, 
  /*  2470 */ 1333, 1334, 1335, 1336, 1337, 1338, 1339, 1340, NACL_OPCODE_NULL_OFFSET, 1341, 
  /*  2480 */ 1341, 1341, 1341, 1341, 1341, 1341, 1341, 1341, 1341, 1341, 
  /*  2490 */ 1341, 1341, 1341, 1341, 1341, 1341, 1341, 1341, 1341, 1341, 
  /*  2500 */ 1341, 1341, 1341, 1341, 1341, 1341, 1341, 1341, 1341, 1341, 
  /*  2510 */ 1341, 1342, 16, 16, 16, 16, 16, 16, 16, 1343, 
  /*  2520 */ 1344, 1345, 1346, 1347, 1348, 1349, 1350, 1351, 1352, 1353, 
  /*  2530 */ 1354, 1355, 1356, 1357, 1358, 16, 16, 16, 16, 16, 
  /*  2540 */ 16, 16, 16, };
