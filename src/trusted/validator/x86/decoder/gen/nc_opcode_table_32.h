...
static const NaClOp g_Operands[723] = {
  ...
  /* 135 */ { RegAL, NACL_OPFLAG(OpSet), "%al" },
  /* 136 */ { O_Operand, NACL_OPFLAG(OpUse), "$Ob" },
  /* 137 */ { RegREAX, NACL_OPFLAG(OpSet), "$rAXv" },
  /* 138 */ { O_Operand, NACL_OPFLAG(OpUse), "$Ov" },
  /* 139 */ { O_Operand, NACL_OPFLAG(OpSet), "$Ob" },
  /* 140 */ { RegAL, NACL_OPFLAG(OpUse), "%al" },
  /* 141 */ { O_Operand, NACL_OPFLAG(OpSet), "$Ov" },
  ...
  /* 173 */ { G_OpcodeBase, NACL_OPFLAG(OpSet), "$r8b" },
  /* 174 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 175 */ { G_OpcodeBase, NACL_OPFLAG(OpSet), "$r8v" },
  ...
  /* 182 */ { E_Operand, NACL_OPFLAG(OpSet), "$Eb" },
  /* 183 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 184 */ { E_Operand, NACL_OPFLAG(OpSet), "$Ev" },
  ...
  /* 192 */ { E_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "$Eb" },
  /* 193 */ { Const_1, NACL_OPFLAG(OpUse), "1" },
  /* 194 */ { E_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "$Ev" },
  /* 195 */ { Const_1, NACL_OPFLAG(OpUse), "1" },
  /* 196 */ { E_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "$Eb" },
  /* 197 */ { RegCL, NACL_OPFLAG(OpUse), "%cl" },
  /* 198 */ { E_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "$Ev" },
  ...
  /* 243 */ { RegAL, NACL_OPFLAG(OpSet), "%al" },
  /* 244 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 245 */ { RegREAX, NACL_OPFLAG(OpSet), "$rAXv" },
  /* 246 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 247 */ { I_Operand, NACL_OPFLAG(OpSet), "$Ib" },
  /* 248 */ { RegAL, NACL_OPFLAG(OpUse), "%al" },
  /* 249 */ { I_Operand, NACL_OPFLAG(OpSet), "$Ib" },
  ...
  /* 253 */ { J_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OperandNear) | NACL_OPFLAG(OperandRelative), "$Jzd" },
  /* 254 */ { RegEIP, NACL_OPFLAG(OpSet) | NACL_OPFLAG(OpImplicit), "{%eip}" },
  /* 255 */ { J_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OperandNear) | NACL_OPFLAG(OperandRelative), "$Jzd" },
  ...
  /* 258 */ { RegAL, NACL_OPFLAG(OpSet), "%al" },
  /* 259 */ { RegDX, NACL_OPFLAG(OpUse), "%dx" },
  /* 260 */ { RegREAX, NACL_OPFLAG(OpSet), "$rAXv" },
  /* 261 */ { RegDX, NACL_OPFLAG(OpUse), "%dx" },
  /* 262 */ { RegDX, NACL_OPFLAG(OpSet), "%dx" },
  /* 263 */ { RegAL, NACL_OPFLAG(OpUse), "%al" },
  /* 264 */ { RegDX, NACL_OPFLAG(OpSet), "%dx" },
  ...
  /* 296 */ { M_Operand, NACL_OPFLAG(OpSet), "$Ms" },
  ...
  /* 303 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vps" },
  /* 304 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wps" },
  /* 305 */ { Xmm_E_Operand, NACL_OPFLAG(OpSet), "$Wps" },
  /* 306 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse), "$Vps" },
  /* 307 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vps" },
  /* 308 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$VRq" },
  /* 309 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vps" },
  /* 310 */ { Mo_Operand, NACL_OPFLAG(OpUse), "$Mq" },
  /* 311 */ { Mo_Operand, NACL_OPFLAG(OpSet), "$Mq" },
  /* 312 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse), "$Vps" },
  /* 313 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "$Vps" },
  /* 314 */ { Xmm_Eo_Operand, NACL_OPFLAG(OpUse), "$Wq" },
  /* 315 */ { Ev_Operand, NACL_OPFLAG(OpSet), "$Rd/q" },
  /* 316 */ { C_Operand, NACL_OPFLAG(OpUse), "$Cd/q" },
  /* 317 */ { Ev_Operand, NACL_OPFLAG(OpSet), "$Rd/q" },
  /* 318 */ { D_Operand, NACL_OPFLAG(OpUse), "$Dd/q" },
  /* 319 */ { C_Operand, NACL_OPFLAG(OpSet), "$Cd/q" },
  /* 320 */ { Ev_Operand, NACL_OPFLAG(OpUse), "$Rd/q" },
  /* 321 */ { D_Operand, NACL_OPFLAG(OpSet), "$Dd/q" },
  /* 322 */ { Ev_Operand, NACL_OPFLAG(OpUse), "$Rd/q" },
  /* 323 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vps" },
  /* 324 */ { Mmx_E_Operand, NACL_OPFLAG(OpUse), "$Qq" },
  /* 325 */ { Mdq_Operand, NACL_OPFLAG(OpSet), "$Mdq" },
  /* 326 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse), "$Vps" },
  /* 327 */ { Mmx_G_Operand, NACL_OPFLAG(OpSet), "$Pq" },
  ...
  /* 351 */ { Gv_Operand, NACL_OPFLAG(OpSet), "$Gd" },
  /* 352 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$VRps" },
  /* 353 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "$Vps" },
  /* 354 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wps" },
  /* 355 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vpd" },
  /* 356 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wps" },
  /* 357 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vps" },
  /* 358 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wdq" },
  /* 359 */ { Mmx_G_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "$Pq" },
  /* 360 */ { Mmx_E_Operand, NACL_OPFLAG(OpUse), "$Qq" },
  /* 361 */ { Mmx_G_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "$Pq" },
  /* 362 */ { Mmx_E_Operand, NACL_OPFLAG(OpUse), "$Qd" },
  /* 363 */ { Mmx_G_Operand, NACL_OPFLAG(OpSet), "$Pq" },
  /* 364 */ { E_Operand, NACL_OPFLAG(OpUse), "$Ed/q/d" },
  /* 365 */ { Mmx_G_Operand, NACL_OPFLAG(OpSet), "$Pq" },
  /* 366 */ { Mmx_E_Operand, NACL_OPFLAG(OpUse), "$Qq" },
  /* 367 */ { Mmx_G_Operand, NACL_OPFLAG(OpSet), "$Pq" },
  /* 368 */ { Mmx_E_Operand, NACL_OPFLAG(OpUse), "$Qq" },
  /* 369 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 370 */ { Mmx_E_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "$PRq" },
  /* 371 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 372 */ { E_Operand, NACL_OPFLAG(OpSet), "$Ed/q/d" },
  /* 373 */ { Mmx_G_Operand, NACL_OPFLAG(OpUse), "$Pd/q/d" },
  /* 374 */ { Mmx_E_Operand, NACL_OPFLAG(OpSet), "$Qq" },
  ...
  /* 379 */ { RegFS, NACL_OPFLAG(OpSet), "%fs" },
  ...
  /* 393 */ { RegGS, NACL_OPFLAG(OpSet), "%gs" },
  ...
  /* 401 */ { E_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "$Eb" },
  ...
  /* 404 */ { E_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "$Ev" },
  /* 405 */ { G_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "$Gv" },
  /* 406 */ { G_Operand, NACL_OPFLAG(OpSet), "$Gv" },
  /* 407 */ { Eb_Operand, NACL_OPFLAG(OpUse), "$Eb" },
  /* 408 */ { G_Operand, NACL_OPFLAG(OpSet), "$Gv" },
  /* 409 */ { Ew_Operand, NACL_OPFLAG(OpUse), "$Ew" },
  /* 410 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "$Vps" },
  /* 411 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wps" },
  /* 412 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 413 */ { M_Operand, NACL_OPFLAG(OpSet), "$Md/q" },
  /* 414 */ { G_Operand, NACL_OPFLAG(OpUse), "$Gd/q" },
  /* 415 */ { Mmx_G_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "$Pq" },
  /* 416 */ { E_Operand, NACL_OPFLAG(OpUse), "$Rd/q/Mw" },
  /* 417 */ { I_Operand, NACL_OPFLAG(OpUse), "$Ib" },
  /* 418 */ { Gv_Operand, NACL_OPFLAG(OpSet), "$Gd" },
  ...
  /* 424 */ { Mo_Operand, NACL_OPFLAG(OpSet), "$Mq" },
  ...
  /* 510 */ { Gv_Operand, NACL_OPFLAG(OpSet), "$Gd" },
  /* 511 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$VRpd" },
  /* 512 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vps" },
  /* 513 */ { Xmm_E_Operand, NACL_OPFLAG(OpUse), "$Wpd" },
  /* 514 */ { Xmm_G_Operand, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "$Vdq" },
  ...
  /* 518 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vdq" },
  ...
  /* 548 */ { G_Operand, NACL_OPFLAG(OpSet), "$Gv" },
  /* 549 */ { M_Operand, NACL_OPFLAG(OpUse), "$Mv" },
  /* 550 */ { M_Operand, NACL_OPFLAG(OpSet), "$Mv" },
  /* 551 */ { G_Operand, NACL_OPFLAG(OpUse), "$Gv" },
  /* 552 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vdq" },
  ...
  /* 599 */ { Xmm_G_Operand, NACL_OPFLAG(OpSet), "$Vdq" },
  ...
  /* 622 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st0" },
  /* 623 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 624 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st0" },
  /* 625 */ { RegST1, NACL_OPFLAG(OpUse), "%st1" },
  /* 626 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st0" },
  /* 627 */ { RegST2, NACL_OPFLAG(OpUse), "%st2" },
  /* 628 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st0" },
  /* 629 */ { RegST3, NACL_OPFLAG(OpUse), "%st3" },
  /* 630 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st0" },
  /* 631 */ { RegST4, NACL_OPFLAG(OpUse), "%st4" },
  /* 632 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st0" },
  ...
  /* 654 */ { RegST0, NACL_OPFLAG(OpSet), "%st0" },
  /* 655 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 656 */ { RegST0, NACL_OPFLAG(OpSet), "%st0" },
  /* 657 */ { RegST1, NACL_OPFLAG(OpUse), "%st1" },
  /* 658 */ { RegST0, NACL_OPFLAG(OpSet), "%st0" },
  /* 659 */ { RegST2, NACL_OPFLAG(OpUse), "%st2" },
  /* 660 */ { RegST0, NACL_OPFLAG(OpSet), "%st0" },
  /* 661 */ { RegST3, NACL_OPFLAG(OpUse), "%st3" },
  /* 662 */ { RegST0, NACL_OPFLAG(OpSet), "%st0" },
  /* 663 */ { RegST4, NACL_OPFLAG(OpUse), "%st4" },
  /* 664 */ { RegST0, NACL_OPFLAG(OpSet), "%st0" },
  ...
  /* 672 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st0" },
  /* 673 */ { RegST1, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st1" },
  /* 674 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st0" },
  /* 675 */ { RegST2, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st2" },
  /* 676 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st0" },
  /* 677 */ { RegST3, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st3" },
  /* 678 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st0" },
  /* 679 */ { RegST4, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st4" },
  /* 680 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st0" },
  /* 681 */ { RegST5, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st5" },
  /* 682 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st0" },
  /* 683 */ { RegST6, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st6" },
  /* 684 */ { RegST0, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st0" },
  /* 685 */ { RegST7, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st7" },
  /* 686 */ { RegST1, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st1" },
  /* 687 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 688 */ { RegST2, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st2" },
  /* 689 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 690 */ { RegST3, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st3" },
  /* 691 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 692 */ { RegST4, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st4" },
  /* 693 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 694 */ { RegST5, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st5" },
  /* 695 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 696 */ { RegST6, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st6" },
  /* 697 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 698 */ { RegST7, NACL_OPFLAG(OpUse) | NACL_OPFLAG(OpSet), "%st7" },
  ...
  /* 708 */ { RegST1, NACL_OPFLAG(OpSet), "%st1" },
  /* 709 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 710 */ { RegST2, NACL_OPFLAG(OpSet), "%st2" },
  /* 711 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 712 */ { RegST3, NACL_OPFLAG(OpSet), "%st3" },
  /* 713 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 714 */ { RegST4, NACL_OPFLAG(OpSet), "%st4" },
  /* 715 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 716 */ { RegST5, NACL_OPFLAG(OpSet), "%st5" },
  /* 717 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 718 */ { RegST6, NACL_OPFLAG(OpSet), "%st6" },
  /* 719 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 720 */ { RegST7, NACL_OPFLAG(OpSet), "%st7" },
  /* 721 */ { RegST0, NACL_OPFLAG(OpUse), "%st0" },
  /* 722 */ { RegAX, NACL_OPFLAG(OpSet), "%ax" },
};
