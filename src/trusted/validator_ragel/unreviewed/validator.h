...
enum validation_callback_info {
  ...
  DISPLACEMENT_8BIT             = 0x00000011,
  DISPLACEMENT_32BIT            = 0x00000014,
  /* Relative size (relative fields always come at the end if instriction).  */
  RELATIVE_8BIT                 = 0x00000021,
  RELATIVE_16BIT                = 0x00000022,
  RELATIVE_32BIT                = 0x00000024,
  /* Not a normal immediate: only two bits can be changed.  */
  IMMEDIATE_2BIT                = 0x00000040,
  /* Instruction is modifiable by nacl_dyncode_modify.  */
  MODIFIABLE_INSTRUCTION        = 0x00000080,
  ...
  IMMEDIATE_IS_OPCODE           = 0x20000000,
