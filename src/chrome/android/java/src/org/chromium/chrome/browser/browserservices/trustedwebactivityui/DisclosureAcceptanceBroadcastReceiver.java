...
public class DisclosureAcceptanceBroadcastReceiver extends BroadcastReceiver {
    ...
    public DisclosureAcceptanceBroadcastReceiver(NotificationManagerProxy notificationManager,
    ...
    public static PendingIntentProvider createPendingIntent(Context context, String tag, int id,
            String packageName) {
