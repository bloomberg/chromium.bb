...
#ifndef CHROME_BROWSER_CHROMEOS_PROCESS_SNAPSHOT_SERVER_H_
#define CHROME_BROWSER_CHROMEOS_PROCESS_SNAPSHOT_SERVER_H_
...
#endif  // CHROME_BROWSER_CHROMEOS_PROCESS_SNAPSHOT_SERVER_H_
