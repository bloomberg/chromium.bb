...
#ifndef CHROME_BROWSER_CHROMEOS_SYSTEM_LOGS_NETWORK_HEALTH_SOURCE_H_
#define CHROME_BROWSER_CHROMEOS_SYSTEM_LOGS_NETWORK_HEALTH_SOURCE_H_
...
#endif  // CHROME_BROWSER_CHROMEOS_SYSTEM_LOGS_NETWORK_HEALTH_SOURCE_H_
