...
#ifndef NET_QUIC_CORE_FRAMES_QUIC_STREAM_ID_BLOCKED_FRAME_H_
#define NET_QUIC_CORE_FRAMES_QUIC_STREAM_ID_BLOCKED_FRAME_H_
...
#endif  // NET_QUIC_CORE_FRAMES_QUIC_STREAM_ID_BLOCKED_FRAME_H_
