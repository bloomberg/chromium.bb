...
#ifndef NET_QUIC_TEST_TOOLS_SIMPLE_SESSION_NOTIFIER_H_
#define NET_QUIC_TEST_TOOLS_SIMPLE_SESSION_NOTIFIER_H_
...
#endif  // NET_QUIC_TEST_TOOLS_SIMPLE_SESSION_NOTIFIER_H_
