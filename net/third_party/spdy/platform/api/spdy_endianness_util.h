...
#ifndef NET_THIRD_PARTY_SPDY_PLATFORM_API_SPDY_ENDIANNESS_UTIL_H_
#define NET_THIRD_PARTY_SPDY_PLATFORM_API_SPDY_ENDIANNESS_UTIL_H_

#include <stdint.h>

#include "net/third_party/spdy/platform/impl/spdy_endianness_util_impl.h"
...
#endif  // NET_THIRD_PARTY_SPDY_PLATFORM_API_SPDY_ENDIANNESS_UTIL_H_
