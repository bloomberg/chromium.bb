...
#ifndef NET_THIRD_PARTY_HTTP2_TOOLS_RANDOM_DECODER_TEST_H_
#define NET_THIRD_PARTY_HTTP2_TOOLS_RANDOM_DECODER_TEST_H_
...
#endif  // NET_THIRD_PARTY_HTTP2_TOOLS_RANDOM_DECODER_TEST_H_
