...
#ifndef IOS_CHROME_BROWSER_UI_QR_SCANNER_PREVIEW_OVERLAY_VIEW_H_
#define IOS_CHROME_BROWSER_UI_QR_SCANNER_PREVIEW_OVERLAY_VIEW_H_
...
#endif  // IOS_CHROME_BROWSER_UI_QR_SCANNER_PREVIEW_OVERLAY_VIEW_H_
