...
#ifndef IOS_CHROME_BROWSER_UI_OMNIBOX_LOCATION_BAR_VIEW_H_
#define IOS_CHROME_BROWSER_UI_OMNIBOX_LOCATION_BAR_VIEW_H_
...
#endif  // IOS_CHROME_BROWSER_UI_OMNIBOX_LOCATION_BAR_VIEW_H_
