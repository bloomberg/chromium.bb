...
#ifndef IOS_CHROME_BROWSER_UI_SETTINGS_AUTOFILL_EDIT_ACCESSORY_VIEW_H_
#define IOS_CHROME_BROWSER_UI_SETTINGS_AUTOFILL_EDIT_ACCESSORY_VIEW_H_
...
#endif  // IOS_CHROME_BROWSER_UI_SETTINGS_AUTOFILL_EDIT_ACCESSORY_VIEW_H_
