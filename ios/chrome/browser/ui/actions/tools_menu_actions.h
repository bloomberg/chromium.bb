...
#ifndef IOS_CHROME_BROWSER_UI_ACTIONS_TOOLS_MENU_ACTIONS_H_
#define IOS_CHROME_BROWSER_UI_ACTIONS_TOOLS_MENU_ACTIONS_H_
...
#endif  // IOS_CHROME_BROWSER_UI_ACTIONS_TOOLS_MENU_ACTIONS_H_
