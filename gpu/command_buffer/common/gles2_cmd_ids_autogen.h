...
#define GLES2_COMMAND_LIST(OP)                                       \
  ...
  OP(SwapBuffers)                                          /* 500 */ \
  OP(GetMaxValueInBufferCHROMIUM)                          /* 501 */ \
  OP(EnableFeatureCHROMIUM)                                /* 502 */ \
  OP(MapBufferRange)                                       /* 503 */ \
  OP(UnmapBuffer)                                          /* 504 */ \
  OP(FlushMappedBufferRange)                               /* 505 */ \
  OP(ResizeCHROMIUM)                                       /* 506 */ \
  OP(GetRequestableExtensionsCHROMIUM)                     /* 507 */ \
  OP(RequestExtensionCHROMIUM)                             /* 508 */ \
  OP(GetProgramInfoCHROMIUM)                               /* 509 */ \
  OP(GetUniformBlocksCHROMIUM)                             /* 510 */ \
  OP(GetTransformFeedbackVaryingsCHROMIUM)                 /* 511 */ \
  OP(GetUniformsES3CHROMIUM)                               /* 512 */ \
  OP(DescheduleUntilFinishedCHROMIUM)                      /* 513 */ \
  OP(GetTranslatedShaderSourceANGLE)                       /* 514 */ \
  OP(PostSubBufferCHROMIUM)                                /* 515 */ \
  OP(CopyTextureCHROMIUM)                                  /* 516 */ \
  OP(CopySubTextureCHROMIUM)                               /* 517 */ \
  OP(CompressedCopyTextureCHROMIUM)                        /* 518 */ \
  OP(DrawArraysInstancedANGLE)                             /* 519 */ \
  OP(DrawElementsInstancedANGLE)                           /* 520 */ \
  OP(VertexAttribDivisorANGLE)                             /* 521 */ \
  OP(ProduceTextureDirectCHROMIUMImmediate)                /* 522 */ \
  OP(CreateAndConsumeTextureINTERNALImmediate)             /* 523 */ \
  OP(BindUniformLocationCHROMIUMBucket)                    /* 524 */ \
  OP(BindTexImage2DCHROMIUM)                               /* 525 */ \
  OP(BindTexImage2DWithInternalformatCHROMIUM)             /* 526 */ \
  OP(ReleaseTexImage2DCHROMIUM)                            /* 527 */ \
  OP(TraceBeginCHROMIUM)                                   /* 528 */ \
  OP(TraceEndCHROMIUM)                                     /* 529 */ \
  OP(DiscardFramebufferEXTImmediate)                       /* 530 */ \
  OP(LoseContextCHROMIUM)                                  /* 531 */ \
  OP(InsertFenceSyncCHROMIUM)                              /* 532 */ \
  OP(WaitSyncTokenCHROMIUM)                                /* 533 */ \
