...
def GetFirmwareVersions(buildroot):
  ...
  Returns:
    A FirmwareVersions object. It's elements will either be set to the
    strings output by the firmware updater shellball, or None if there is
    no firmware updater.
  """
  ...
  return FirmwareVersions(main=(main.group('version') if main else None),
                          ec=(ec.group('version') if ec else None))
