...
public class VideoCaptureCamera2 extends VideoCapture {
    ...
    private class StopCaptureTask implements Runnable {
        private final ConditionVariable mDoneConditionVariable;
    ...
    public boolean stopCaptureAndBlockUntilStopped() {
        ...
        ConditionVariable doneConditionVariable = new ConditionVariable();
        mCameraThreadHandler.post(new StopCaptureTask(doneConditionVariable));
        doneConditionVariable.block();
