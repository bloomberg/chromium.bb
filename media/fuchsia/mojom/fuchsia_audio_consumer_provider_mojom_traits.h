...
#ifndef MEDIA_FUCHSIA_MOJOM_FUCHSIA_AUDIO_CONSUMER_PROVIDER_MOJOM_TRAITS_H_
#define MEDIA_FUCHSIA_MOJOM_FUCHSIA_AUDIO_CONSUMER_PROVIDER_MOJOM_TRAITS_H_
...
#endif  // MEDIA_FUCHSIA_MOJOM_FUCHSIA_AUDIO_CONSUMER_PROVIDER_MOJOM_TRAITS_H_
