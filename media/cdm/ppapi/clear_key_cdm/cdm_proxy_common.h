...
#ifndef MEDIA_CDM_PPAPI_CLEAR_KEY_CDM_CDM_PROXY_COMMON_H_
#define MEDIA_CDM_PPAPI_CLEAR_KEY_CDM_CDM_PROXY_COMMON_H_
...
#endif  // MEDIA_CDM_PPAPI_CLEAR_KEY_CDM_CDM_PROXY_COMMON_H_
