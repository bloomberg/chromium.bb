luci.console_view(
    ...
    entries = [
        ...
        luci.console_view_entry(
            builder = 'ci/Chromium Linux Goma RBE ToT',
            category = 'rbe|tot|linux|rel',
        ),
        luci.console_view_entry(
            builder = 'ci/Chromium Linux Goma RBE ToT (ATS)',
            category = 'rbe|tot|linux|rel',
            short_name = 'ats',
        ),
        luci.console_view_entry(
            builder = 'ci/Chromium Mac Goma RBE ToT',
            category = 'rbe|tot|mac|rel',
        ),
        luci.console_view_entry(
            builder = 'ci/Chromium Win Goma RBE ToT',
            category = 'rbe|tot|win|rel',
        ),
        luci.console_view_entry(
            builder = 'ci/Chromium Android ARM 32-bit Goma RBE ToT',
            category = 'rbe|tot|android arm|rel',
        ),
        luci.console_view_entry(
            builder = 'ci/Chromium Android ARM 32-bit Goma RBE ToT (ATS)',
            category = 'rbe|tot|android arm|rel',
            short_name = 'ats',
        ),
        luci.console_view_entry(
        ...
        luci.console_view_entry(
            builder = 'ci/Chromium Mac Goma RBE Staging (clobber)',
            category = 'rbe|staging|mac|rel',
            short_name = 'clb',
        ),
        luci.console_view_entry(
            builder = 'ci/Chromium Mac Goma RBE Staging',
            category = 'rbe|staging|mac|rel',
        ),
        luci.console_view_entry(
            builder = 'ci/Chromium Mac Goma RBE Staging (dbg)',
            category = 'rbe|staging|mac|debug',
        ),
        luci.console_view_entry(
            builder = 'ci/Chromium Win Goma RBE Staging',
            category = 'rbe|staging|win|rel',
        ),
        luci.console_view_entry(
            builder = 'ci/Chromium Win Goma RBE Staging (clobber)',
            category = 'rbe|staging|win|rel',
            short_name = 'clb',
        ),
        luci.console_view_entry(
            builder = 'ci/Chromium Android ARM 32-bit Goma RBE Staging',
