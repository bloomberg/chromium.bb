...
#ifndef CONTENT_TEST_ACCESSIBILITY_TEST_UTILS_WIN_H_
#define CONTENT_TEST_ACCESSIBILITY_TEST_UTILS_WIN_H_
...
#endif  // CONTENT_TEST_ACCESSIBILITY_TEST_UTILS_WIN_H_
