...
const DataResource kDataResources[] = {
    ...
    {"mediaplayerPauseHover",
     IDR2_MEDIAPLAYER_PAUSE_BUTTON_HOVER,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerPauseDown",
     IDR2_MEDIAPLAYER_PAUSE_BUTTON_DOWN,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerPlay", IDR2_MEDIAPLAYER_PLAY_BUTTON, ui::SCALE_FACTOR_100P},
    {"mediaplayerPlayHover",
     IDR2_MEDIAPLAYER_PLAY_BUTTON_HOVER,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerPlayDown",
     IDR2_MEDIAPLAYER_PLAY_BUTTON_DOWN,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerPlayDisabled",
     IDR2_MEDIAPLAYER_PLAY_BUTTON_DISABLED,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerSoundLevel3",
     IDR2_MEDIAPLAYER_SOUND_LEVEL3_BUTTON,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerSoundLevel3Hover",
     IDR2_MEDIAPLAYER_SOUND_LEVEL3_BUTTON_HOVER,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerSoundLevel3Down",
     IDR2_MEDIAPLAYER_SOUND_LEVEL3_BUTTON_DOWN,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerSoundLevel2",
     IDR2_MEDIAPLAYER_SOUND_LEVEL2_BUTTON,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerSoundLevel2Hover",
     IDR2_MEDIAPLAYER_SOUND_LEVEL2_BUTTON_HOVER,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerSoundLevel2Down",
     IDR2_MEDIAPLAYER_SOUND_LEVEL2_BUTTON_DOWN,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerSoundLevel1",
     IDR2_MEDIAPLAYER_SOUND_LEVEL1_BUTTON,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerSoundLevel1Hover",
     IDR2_MEDIAPLAYER_SOUND_LEVEL1_BUTTON_HOVER,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerSoundLevel1Down",
     IDR2_MEDIAPLAYER_SOUND_LEVEL1_BUTTON_DOWN,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerSoundLevel0",
     IDR2_MEDIAPLAYER_SOUND_LEVEL0_BUTTON,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerSoundLevel0Hover",
     IDR2_MEDIAPLAYER_SOUND_LEVEL0_BUTTON_HOVER,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerSoundLevel0Down",
     IDR2_MEDIAPLAYER_SOUND_LEVEL0_BUTTON_DOWN,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerSoundDisabled",
     IDR2_MEDIAPLAYER_SOUND_DISABLED,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerSliderThumb",
     IDR2_MEDIAPLAYER_SLIDER_THUMB,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerSliderThumbHover",
     IDR2_MEDIAPLAYER_SLIDER_THUMB_HOVER,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerSliderThumbDown",
     IDR2_MEDIAPLAYER_SLIDER_THUMB_DOWN,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerVolumeSliderThumb",
     IDR2_MEDIAPLAYER_VOLUME_SLIDER_THUMB,
     ui::SCALE_FACTOR_100P},
    ...
    {"mediaplayerClosedCaption",
     IDR2_MEDIAPLAYER_CLOSEDCAPTION_BUTTON,
     ui::SCALE_FACTOR_100P},
    ...
    {"mediaplayerFullscreen",
     IDR2_MEDIAPLAYER_FULLSCREEN_BUTTON,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerFullscreenHover",
     IDR2_MEDIAPLAYER_FULLSCREEN_BUTTON_HOVER,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerFullscreenDown",
     IDR2_MEDIAPLAYER_FULLSCREEN_BUTTON_DOWN,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerCastOff",
     IDR2_MEDIAPLAYER_CAST_BUTTON_OFF,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerCastOn",
     IDR2_MEDIAPLAYER_CAST_BUTTON_ON,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerFullscreenDisabled",
     IDR2_MEDIAPLAYER_FULLSCREEN_BUTTON_DISABLED,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerOverlayCastOff",
     IDR2_MEDIAPLAYER_OVERLAY_CAST_BUTTON_OFF,
     ui::SCALE_FACTOR_100P},
    {"mediaplayerOverlayPlay",
     IDR2_MEDIAPLAYER_OVERLAY_PLAY_BUTTON,
     ui::SCALE_FACTOR_100P},
    ...
    {"generatePasswordHover",
     IDR2_PASSWORD_GENERATION_ICON_HOVER,
     ui::SCALE_FACTOR_100P},
