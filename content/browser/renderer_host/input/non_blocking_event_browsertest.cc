...
// Disabled on MacOS because it doesn't support touch input.
#if defined(OS_MACOSX)
#define MAYBE_TouchStart_during_fling DISABLED_TouchStart_during_fling
#else
#define MAYBE_TouchStart_during_fling TouchStart_during_fling
#endif
IN_PROC_BROWSER_TEST_F(NonBlockingEventBrowserTest,
                       MAYBE_TouchStart_during_fling) {
