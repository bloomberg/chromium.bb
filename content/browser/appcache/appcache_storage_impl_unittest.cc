 ...
 public:
  ...
  void Continue_Reinitialize(ReinitTestCase test_case) {
    ...
    if (test_case == CORRUPT_CACHE_ON_INSTALL ||
      ...
      AppCacheHost* host1 = service_->GetHost(kMockProcessId, 1);
      ...
      service_->RegisterHostForFrame(blink::mojom::AppCacheHostRequest(),
                                     ...
                                     kMockProcessId, GetBadMessageCallback());
      AppCacheHost* host2 = service_->GetHost(kMockProcessId, 2);
  ...
  void Verify_Reinitialized(ReinitTestCase test_case) {
    ...
    service_->EraseHost(kMockProcessId, 1);
    service_->EraseHost(kMockProcessId, 2);
