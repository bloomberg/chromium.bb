...
CONTENT_EXPORT extern const char kDisableBrowserSideNavigation[];
...
CONTENT_EXPORT extern const char kIsService[];
...
CONTENT_EXPORT extern const char kUtilityProcessSandboxType[];
