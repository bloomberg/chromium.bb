  ...
  'targets': [
    ...
    },
    {
      ...
      'sources': [
        ...
        '../third_party/WebKit/WebCore/rendering/RenderLegend.cpp',
        '../third_party/WebKit/WebCore/rendering/RenderLegend.h',
      ...
      'sources/': [
        ...
        ['exclude', '/platform/image-decoders/(?!skia/)'],
      ],
      'sources!': [
