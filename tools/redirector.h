 ...
 */
 ...
 redirect_t redirects[] = {
   ...
   {L"/nacl/bin/ar.exe", L"/libexec/nacl64-ar.exe", L""},
   {L"/nacl/bin/as.exe", L"/libexec/nacl64-as.exe", L"--32"},
   {L"/nacl/bin/c++.exe", L"/libexec/nacl64-c++.exe", L"-m32"},
   {L"/nacl/bin/gcc.exe", L"/libexec/nacl64-gcc.exe", L"-m32"},
   {L"/nacl/bin/g++.exe", L"/libexec/nacl64-g++.exe", L"-m32"},
   {L"/nacl/bin/gfortran.exe", L"/libexec/nacl64-gfortran.exe", L"-m32"},
   {L"/nacl/bin/ld.exe", L"/libexec/nacl64-ld.exe", L"-melf_nacl"},
   {L"/nacl/bin/nm.exe", L"/libexec/nacl64-nm.exe", L""},
   {L"/nacl/bin/objcopy.exe", L"/libexec/nacl64-objcopy.exe", L""},
   {L"/nacl/bin/objdump.exe", L"/libexec/nacl64-objdump.exe", L""},
   {L"/nacl/bin/ranlib.exe", L"/libexec/nacl64-ranlib.exe", L""},
   {L"/nacl/bin/strip.exe", L"/libexec/nacl64-strip.exe", L""},
 };
 #endif