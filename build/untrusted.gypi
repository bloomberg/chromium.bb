    ...
    ['target_arch=="ia32" or target_arch=="x64"', {
      ...
      'target_defaults': {
        ...
        'variables': {
          ...
          'enable_arm': 0,
          'enable_mips': 0,
          'nacl_glibc_tc_root': '<(SHARED_INTERMEDIATE_DIR)/sdk/toolchain/<(OS)_x86_nacl_x86/nacl_x86_glibc',
          'nacl_newlib_tc_root': '<(SHARED_INTERMEDIATE_DIR)/sdk/toolchain/<(OS)_x86_nacl_x86/nacl_x86_newlib',
