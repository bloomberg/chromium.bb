...
# __init__.py). This wrapper makes "import gyp_nacl" work with
# those old versions and makes it possible to execute gyp_nacl.py
# directly on Windows where the extension is useful.

import os

path = os.path.dirname(os.path.abspath(__file__))
execfile(os.path.join(path, 'gyp_nacl'))
