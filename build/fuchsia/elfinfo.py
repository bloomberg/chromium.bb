...
#
# This is a verbatim copy of mcgrathr's script from:
# https://fuchsia.googlesource.com/packages/+/master/gn/elfinfo.py
# In particular it does not match the Chromium style-guide for Python code,
# since we are only landing it temporarily.
#
# TODO(crbug.com/773444): Remove this script once llvm-objcopy is available.
