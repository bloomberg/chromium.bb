  ...
  'targets': [
    {
      ...
      'conditions': [
        ...
        ['target_arch!="arm" and target_arch!="mipsel"', {
          ...
          'copies': [
            {
              'destination': '<(SHARED_INTERMEDIATE_DIR)/sdk/toolchain/<(OS)_x86_nacl_x86/nacl_x86_newlib/x86_64-nacl/lib32',
              'files': [
            ...
            {
              'destination': '<(SHARED_INTERMEDIATE_DIR)/sdk/toolchain/<(OS)_x86_nacl_x86/nacl_x86_newlib/x86_64-nacl/lib',
              'files': [
            ...
            {
              'destination': '<(SHARED_INTERMEDIATE_DIR)/sdk/toolchain/<(OS)_x86_nacl_x86/nacl_x86_glibc/x86_64-nacl/lib32',
              'files': [
            ...
            {
              'destination': '<(SHARED_INTERMEDIATE_DIR)/sdk/toolchain/<(OS)_x86_nacl_x86/nacl_x86_glibc/x86_64-nacl/lib',
              'files': [
