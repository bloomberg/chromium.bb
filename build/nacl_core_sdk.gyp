      ...
      'conditions': [
        ...
        ['target_arch!="arm"', {
          ...
          'copies': [
            ...
            {
              'destination': '<(SHARED_INTERMEDIATE_DIR)/sdk/toolchain/<(OS)_x86_newlib/x86_64-nacl/lib64',
              'files': [
            ...
            {
              'destination': '<(SHARED_INTERMEDIATE_DIR)/sdk/toolchain/<(OS)_x86_glibc/x86_64-nacl/lib64',
              'files': [
