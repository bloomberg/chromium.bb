...
#ifndef SERVICES_UI_WS2_EVENT_INJECTOR_H_
#define SERVICES_UI_WS2_EVENT_INJECTOR_H_
...
class COMPONENT_EXPORT(WINDOW_SERVICE) EventInjector
 ...
 private:
  ...
  // Determins the target WindowTreeHost and provides an mapping on |event|
...
#endif  // SERVICES_UI_WS2_EVENT_INJECTOR_H_
