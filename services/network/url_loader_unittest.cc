...
InitiatorOriginLockCompatibility VerifyRequestInitiatorSiteLock(
    int process_id,
  ...
  return URLLoader::VerifyRequestInitiatorOriginLockForTesting(*factory_params,
                                                               request);
}

TEST_F(URLLoaderTest, VerifyRequestInitiatorSiteLock) {
  ...
  EXPECT_EQ(InitiatorOriginLockCompatibility::kBrowserProcess,
            VerifyRequestInitiatorSiteLock(mojom::kBrowserProcessId,
                                           base::nullopt, base::nullopt));
  EXPECT_EQ(InitiatorOriginLockCompatibility::kNoLock,
  ...
  EXPECT_EQ(InitiatorOriginLockCompatibility::kCompatibleLock,
  ...
  EXPECT_EQ(InitiatorOriginLockCompatibility::kCompatibleLock,
            VerifyRequestInitiatorSiteLock(kRendererProcessId, opaque_origin,
                                           opaque_origin2));
  EXPECT_EQ(InitiatorOriginLockCompatibility::kIncorrectLock,
            VerifyRequestInitiatorSiteLock(kRendererProcessId, opaque_origin,
                                           bar_foo_example_com));
