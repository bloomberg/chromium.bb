...
#
# This file was generated from the source file ku_Arab_IQ.xml
...
package DateTime::Locale::ku_Arab_IQ;

use strict;
use warnings;
use utf8;

use base 'DateTime::Locale::ku_Arab';
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'ku_Arab_IQ' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Kurdish Arabic Iraq.

=head1 DATA

This locale inherits from the L<DateTime::Locale::ku_Arab> locale.
