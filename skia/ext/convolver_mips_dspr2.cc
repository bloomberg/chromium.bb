...
void ConvolveVertically_mips_dspr2(const ConvolutionFilter1D::Fixed* filter_val,
                                   ...
                                   bool has_alpha) {
  if (has_alpha) {
    ConvolveVertically_mips_dspr2<true>(filter_val,
                                        filter_length,
                                        source_data_rows,
                                        pixel_width,
                                        out_row);
  } else {
    ConvolveVertically_mips_dspr2<false>(filter_val,
                                         filter_length,
                                         source_data_rows,
                                         pixel_width,
                                         out_row);
...
void ConvolveHorizontally_mips_dspr2(const unsigned char* src_data,
                                     ...
                                     bool has_alpha) {
  if (has_alpha) {
    ConvolveHorizontally_mips_dspr2<true>(src_data,
                                          filter,
                                          out_row);
  } else {
    ConvolveHorizontally_mips_dspr2<false>(src_data,
                                           filter,
                                           out_row);
  }
}
