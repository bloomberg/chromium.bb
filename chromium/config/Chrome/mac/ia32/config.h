...
#define FFMPEG_CONFIGURATION "--disable-everything --enable-fft --enable-rdft --disable-network --disable-bzlib --disable-zlib --disable-swscale --enable-shared --optflags='-fno-omit-frame-pointer -O2' --enable-decoder='theora,vorbis,vp8' --enable-decoder='pcm_u8,pcm_s16le,pcm_s24le,pcm_f32le' --enable-demuxer='ogg,matroska,wav' --enable-parser='vp3,vorbis,vp8' --enable-pic --arch=i686 --enable-yasm --extra-cflags=-m32 --extra-ldflags=-m32 --cc=clang --cxx=clang++ --disable-vda --enable-memalign-hack --enable-decoder='aac,h264,mp3' --enable-demuxer='mp3,mov' --enable-parser='aac,h264,mpegaudio'"
