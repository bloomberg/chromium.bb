...
#define FFMPEG_CONFIGURATION "--disable-everything --enable-fft --enable-rdft --disable-network --disable-bzlib --disable-zlib --disable-swscale --disable-amd3dnow --disable-amd3dnowext --enable-shared --optflags=-O2 --enable-decoder='theora,vorbis,vp8' --enable-decoder='pcm_u8,pcm_s16le,pcm_f32le' --enable-demuxer='ogg,matroska,wav' --enable-parser=vp8 --enable-filter=buffer --enable-memalign-hack --cc=mingw32-gcc --extra-cflags='-mtune=atom' --extra-cflags=-U__STRICT_ANSI__ --extra-cflags=-I/usr/local/include --extra-ldflags=-L/usr/local/lib --extra-ldflags='-Wl,--enable-auto-import' --extra-ldflags='-Wl,--no-seh'"
