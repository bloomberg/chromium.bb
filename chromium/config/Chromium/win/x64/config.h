...
/* #define FFMPEG_CONFIGURATION "--disable-everything --disable-all --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-static --enable-avcodec --enable-avformat --enable-avutil --enable-fft --enable-rdft --enable-static --enable-libopus --disable-debug --disable-bzlib --disable-error-resilience --disable-iconv --disable-lzo --disable-network --disable-schannel --disable-sdl2 --disable-symver --disable-xlib --disable-zlib --disable-securetransport --disable-faan --disable-alsa --disable-autodetect --enable-decoder='vorbis,libopus,flac' --enable-decoder='pcm_u8,pcm_s16le,pcm_s24le,pcm_s32le,pcm_f32le,mp3' --enable-decoder='pcm_s16be,pcm_s24be,pcm_mulaw,pcm_alaw' --enable-demuxer='ogg,matroska,wav,flac,mp3,mov' --enable-parser='opus,vorbis,flac,mpegaudio' --extra-cflags=-I/d/code/chrome/src/third_party/opus/src/include --disable-linux-perf --x86asmexe=yasm --optflags='\"-O2\"' --enable-decoder='theora,vp8' --enable-parser='vp3,vp8' --toolchain=msvc --extra-cflags=-I/d/code/chrome/src/third_party/ffmpeg/chromium/include/win --target-os=win64 --enable-cross-compile --cc=clang-cl --ld=lld-link --nm=llvm-nm --ar=llvm-ar --extra-cflags=-O2 --extra-cflags=-imsvc/d/code/chrome/src/third_party/depot_tools/win_toolchain/vs_files/1180cb75833ea365097e279efb2d5d7a42dee4b0/win_sdk/bin/../../win_sdk/Include/10.0.15063.0/um --extra-cflags=-imsvc/d/code/chrome/src/third_party/depot_tools/win_toolchain/vs_files/1180cb75833ea365097e279efb2d5d7a42dee4b0/win_sdk/bin/../../win_sdk/Include/10.0.15063.0/shared --extra-cflags=-imsvc/d/code/chrome/src/third_party/depot_tools/win_toolchain/vs_files/1180cb75833ea365097e279efb2d5d7a42dee4b0/win_sdk/bin/../../win_sdk/Include/10.0.15063.0/winrt --extra-cflags=-imsvc/d/code/chrome/src/third_party/depot_tools/win_toolchain/vs_files/1180cb75833ea365097e279efb2d5d7a42dee4b0/win_sdk/bin/../../win_sdk/Include/10.0.15063.0/ucrt --extra-cflags=-imsvc/d/code/chrome/src/third_party/depot_tools/win_toolchain/vs_files/1180cb75833ea365097e279efb2d5d7a42dee4b0/win_sdk/bin/../../VC/Tools/MSVC/14.11.25503/include --extra-cflags=-imsvc/d/code/chrome/src/third_party/depot_tools/win_toolchain/vs_files/1180cb75833ea365097e279efb2d5d7a42dee4b0/win_sdk/bin/../../VC/Tools/MSVC/14.11.25503/atlmfc/include --extra-ldflags='-libpath:/d/code/chrome/src/third_party/depot_tools/win_toolchain/vs_files/1180cb75833ea365097e279efb2d5d7a42dee4b0/VC/Tools/MSVC/14.11.25503/atlmfc/lib/x64' --extra-ldflags='-libpath:/d/code/chrome/src/third_party/depot_tools/win_toolchain/vs_files/1180cb75833ea365097e279efb2d5d7a42dee4b0/win_sdk/Lib/10.0.15063.0/ucrt/x64' --extra-ldflags='-libpath:/d/code/chrome/src/third_party/depot_tools/win_toolchain/vs_files/1180cb75833ea365097e279efb2d5d7a42dee4b0/win_sdk/Lib/10.0.15063.0/um/x64' --extra-ldflags='-libpath:/d/code/chrome/src/third_party/depot_tools/win_toolchain/vs_files/1180cb75833ea365097e279efb2d5d7a42dee4b0/VC/Tools/MSVC/14.11.25503/lib/x64'" -- elide long configuration string from binary */
...
#define HAVE_CABS 0
#define HAVE_CEXP 0
/* #define HAVE_INLINE_ASM 1 -- inline asm selection is done by the chrome build */
