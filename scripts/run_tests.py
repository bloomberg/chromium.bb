...
PYTHON3_TESTS = {
    ...
    'api/controller/android_unittest',
    ...
    'api/controller/packages_unittest',
    ...
    'cbuildbot/archive_lib_unittest',
    'cbuildbot/builders/generic_builders_unittest',
    'cbuildbot/builders/init_unittest',
    'cbuildbot/builders/workspace_builders_unittest',
    'cbuildbot/goma_util_unittest',
    'cbuildbot/prebuilts_unittest',
    'cbuildbot/relevant_changes_unittest',
    'cbuildbot/stages/config_stages_unittest',
    'cbuildbot/stages/handle_changes_stages_unittest',
    'cbuildbot/stages/scheduler_stages_unittest',
    'cbuildbot/swarming_lib_unittest',
    'cbuildbot/topology_unittest',
    'cli/command_unittest',
    ...
    'lib/clactions_metrics_unittest',
    'lib/clactions_unittest',
    ...
    'scripts/cros_choose_profile_unittest',
    ...
    'scripts/merge_logs_unittest',
    'scripts/pushimage_unittest',
    'scripts/repo_sync_manifest_unittest',
    'scripts/run_tests_unittest',
