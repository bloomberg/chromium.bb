...
PYTHON2_ONLY_TESTS = {
    ...
    'cbuildbot/build_status_unittest',
    'cbuildbot/builders/simple_builders_unittest',
    'cbuildbot/cbuildbot_run_unittest',
    ...
    'cbuildbot/patch_series_unittest',
    'cbuildbot/repository_unittest',
    'cbuildbot/stages/afdo_stages_unittest',
    'cbuildbot/stages/artifact_stages_unittest',
    'cbuildbot/stages/branch_archive_stages_unittest',
    'cbuildbot/stages/build_stages_unittest',
    'cbuildbot/stages/chrome_stages_unittest',
    'cbuildbot/stages/completion_stages_unittest',
    'cbuildbot/stages/generic_stages_unittest',
    'cbuildbot/stages/infra_stages_unittest',
    ...
    'cbuildbot/stages/test_stages_unittest',
    'cbuildbot/stages/vm_test_stages_unittest',
    'cbuildbot/stages/workspace_stages_unittest',
    'cbuildbot/trybot_patch_pool_unittest',
    'cbuildbot/validation_pool_unittest',
    'cli/cros/cros_chrome_sdk_unittest',
    'cli/cros/cros_lint_unittest',
    'cli/deploy_unittest',
    'cli/flash_unittest',
    ...
    'lib/cgroups_unittest',
    'lib/cidb_unittest',
    'lib/config_lib_unittest',
    'lib/cros_test_unittest',
    'lib/dev_server_wrapper_unittest',
    'lib/failure_message_lib_unittest',
    'lib/kernel_cmdline_unittest',
    'lib/locking_unittest',
    'lib/luci/prpc/client_unittest',
    'lib/metadata_lib_unittest',
    'lib/metrics_unittest',
    'lib/operation_unittest',
    'lib/parallel_unittest',
    'lib/paygen/signer_payloads_client_unittest',
    'lib/remote_access_unittest',
    'lib/repo_manifest_unittest',
    'lib/results_lib_unittest',
    ...
    'scripts/upload_prebuilts_unittest',
