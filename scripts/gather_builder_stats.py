...
# TODO(mtennant): Move this to cbuildbot_metadata.
class BuildData(object):
  """Class to hold the metadata.json of one build.
...
class StatsManager(object):
  ...
  def Gather(self, start_date, sort_by_build_number=True):
    ...
    self.builds = BuildData.ReadMetadataURLs(urls, gs_ctx=self.gs_ctx)
  ...
  def MarkGathered(self):
    ...
    BuildData.MarkBuildsGathered(self.builds, self.sheets_version,
                                 self.carbon_version, gs_ctx=self.gs_ctx)
